...
[Payout](https://docs.stripe.com/api/payouts/list#payout_object) object, with
...
[FinancialAccount’s](https://docs.stripe.com/api/payouts/list#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/payouts/list#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/payouts/list#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/payouts/list#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/payouts/list#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/payouts/list#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/payouts/list#received_debits)
