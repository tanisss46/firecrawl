...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fsetup_attempts%2Flist)
...
event](https://docs.stripe.com/api/setup_attempts/list#retrieve_event) or a
[list of events](https://docs.stripe.com/api/setup_attempts/list#list_events)
...
API](https://docs.stripe.com/api/setup_attempts/list#retrieve_event) for 30
days.
...
with the [create
file](https://docs.stripe.com/api/setup_attempts/list#create_file) request (for
...
query](https://docs.stripe.com/api/setup_attempts/list#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/setup_attempts/list#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/setup_attempts/list#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/setup_attempts/list#payment_intent_object-setup_future_usage)
...
conjunction with
[Prices](https://docs.stripe.com/api/setup_attempts/list#prices) to configure
...
[Products](https://docs.stripe.com/api/setup_attempts/list#products) help you
...
[subscriptions](https://docs.stripe.com/api/setup_attempts/list#subscriptions),
[invoices](https://docs.stripe.com/api/setup_attempts/list#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/setup_attempts/list#quotes), and more.
Coupons do not work with conventional one-off
[charges](https://docs.stripe.com/api/setup_attempts/list#create_charge) or
[payment intents](https://docs.stripe.com/api/payment_intents).
...
[coupon](https://docs.stripe.com/api/setup_attempts/list#coupons). It can be
...
[coupon](https://docs.stripe.com/api/setup_attempts/list#coupons) or [promotion
code](https://docs.stripe.com/api/setup_attempts/list#promotion_codes). It
...
items](https://docs.stripe.com/api/setup_attempts/list#invoiceitems), and
...
API](https://docs.stripe.com/api/setup_attempts/list#prices). It replaces the
...
[Payout](https://docs.stripe.com/api/setup_attempts/list#payout_object) object,
...
[FinancialAccount’s](https://docs.stripe.com/api/setup_attempts/list#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/setup_attempts/list#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/setup_attempts/list#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/setup_attempts/list#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/setup_attempts/list#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/setup_attempts/list#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/setup_attempts/list#received_debits)
