...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fv2%2Fcore%2Fevent_destinations%2Fretrieve)
...
event](https://docs.stripe.com/api/v2/core/event_destinations/retrieve#retrieve_event)
or a [list of
events](https://docs.stripe.com/api/v2/core/event_destinations/retrieve#list_events)
...
API](https://docs.stripe.com/api/v2/core/event_destinations/retrieve#retrieve_event)
for 30 days.
...
# [Create an event destination](https://docs.stripe.com/api/v2/core/event_destinations/create) v2
...
Possible enum values`amazon_eventbridge`
Amazon EventBridge.
...
Possible enum values`other_accounts`
Receive events from accounts connected to the account that owns the event
destination.
...
Possible enum values`webhook_endpoint.signing_secret`
...
Show child attributes
Error Codes409idempotency_error
An idempotent retry occurred with different request parameters.

POST /v2/core/event_destinationsServer-side languageStripe
CLIcURL.NETGoJavaNode.jsPHPPythonRuby
```
curl -X POST https://api.stripe.com/v2/core/event_destinations \ -H
"Authorization: Bearer {{YOUR_API_KEY}}{{YOUR_API_KEY}}" \ -H "Stripe-Version:
2025-02-24.acacia" \ --json '{ "name": "My Event Destination", "description":
"This is my event destination, I like it a lot", "enabled_events": [
"v1.billing.meter.error_report_triggered" ], "type": "webhook_endpoint",
"webhook_endpoint": { "url": "https://example.com/my/webhook/endpoint" },
"event_payload": "thin", "include": [ "webhook_endpoint.url" ] }'
```

Response
```
{ "id": "ed_test_61RM8ltWcTW4mbsxf16RJyfa2xSQLHJJh1sxm7H0KVT6", "object":
"v2.core.event_destination", "created": "2024-10-22T16:20:09.931Z",
"description": "This is my event destination, I like it a lot",
"enabled_events": [ "v1.billing.meter.error_report_triggered" ],
"event_payload": "thin", "events_from": [ "self" ], "livemode": false,
"metadata": {}, "name": "My Event Destination", "snapshot_api_version": null,
"status": "enabled", "status_details": null, "type": "webhook_endpoint",
"updated": "2024-10-22T16:20:09.937Z", "webhook_endpoint": { "signing_secret":
null, "url": "https://example.com/my/webhook/endpoint" }}
```

# [Update an event destination](https://docs.stripe.com/api/v2/core/event_destinations/update) v2
...
Show child attributes
Error Codes404not_found
The resource wasn’t found.

409idempotency_error
An idempotent retry occurred with different request parameters.

POST /v2/core/event_destinations/:idServer-side languageStripe
CLIcURL.NETGoJavaNode.jsPHPPythonRuby
```
curl -X POST
https://api.stripe.com/v2/core/event_destinations/ed_test_61RM8ltWcTW4mbsxf16RJyfa2xSQLHJJh1sxm7H0KVT6
\ -H "Authorization: Bearer {{YOUR_API_KEY}}{{YOUR_API_KEY}}" \ -H
"Stripe-Version: 2025-02-24.acacia" \ --json '{ "description": "A better
description", "enabled_events": [ "v1.billing.meter.error_report_triggered",
"v1.billing.meter.no_meter_found" ], "include": [ "webhook_endpoint.url" ] }'
```
...
{ "id": "ed_test_61RM8ltWcTW4mbsxf16RJyfa2xSQLHJJh1sxm7H0KVT6", "object":
"v2.core.event_destination", "created": "2024-10-22T16:20:09.931Z",
"description": "A better description", "enabled_events": [
"v1.billing.meter.error_report_triggered", "v1.billing.meter.no_meter_found" ],
"event_payload": "thin", "events_from": [ "self" ], "livemode": false,
"metadata": {}, "name": "My Event Destination", "snapshot_api_version": null,
"status": "disabled", "status_details": { "disabled": { "reason": "user" } },
"type": "webhook_endpoint", "updated": "2024-10-22T16:25:48.976Z",
"webhook_endpoint": { "signing_secret": null, "url":
"https://example.com/my/webhook/endpoint" }}
```

# [Retrieve an event destination](https://docs.stripe.com/api/v2/core/event_destinations/retrieve) v2
...
GET /v2/core/event_destinations/:idServer-side languageStripe
CLIcURL.NETGoJavaNode.jsPHPPythonRuby
```
curl -G
https://api.stripe.com/v2/core/event_destinations/ed_test_61RM8ltWcTW4mbsxf16RJyfa2xSQLHJJh1sxm7H0KVT6
\ -H "Authorization: Bearer {{YOUR_API_KEY}}{{YOUR_API_KEY}}" \ -H
"Stripe-Version: 2025-02-24.acacia" \ -d include="webhook_endpoint.url"
```
...
"metadata": {}, "name": "My Event Destination", "snapshot_api_version": null,
"status": "disabled", "status_details": { "disabled": { "reason": "user" } },
"type": "webhook_endpoint", "updated": "2024-10-22T16:22:02.524Z",
"webhook_endpoint": { "signing_secret": null, "url": null }}
```

# [List all event destination](https://docs.stripe.com/api/v2/core/event_destinations/list) v2
...
GET /v2/core/event_destinationsServer-side languageStripe
CLIcURL.NETGoJavaNode.jsPHPPythonRuby
```
curl -G https://api.stripe.com/v2/core/event_destinations \ -H "Authorization:
Bearer {{YOUR_API_KEY}}{{YOUR_API_KEY}}" \ -H "Stripe-Version:
2025-02-24.acacia" \ -d include="webhook_endpoint.url"
```

Response
```
{ "data": [ { "id": "ed_test_61RM8ltWcTW4mbsxf16RJyfa2xSQLHJJh1sxm7H0KVT6",
"object": "v2.core.event_destination", "created": "2024-10-22T16:20:09.931Z",
"description": "This is my event destination, I like it a lot",
"enabled_events": [ "v1.billing.meter.error_report_triggered" ],
"event_payload": "thin", "events_from": [ "self" ], "livemode": false,
"metadata": {}, "name": "My Event Destination", "snapshot_api_version": null,
...
# [Delete an event destination](https://docs.stripe.com/api/v2/core/event_destinations/delete) v2
...
DELETE /v2/core/event_destinations/:idServer-side languageStripe
CLIcURL.NETGoJavaNode.jsPHPPythonRuby
```
curl -X DELETE
https://api.stripe.com/v2/core/event_destinations/ed_test_61RM8ltWcTW4mbsxf16RJyfa2xSQLHJJh1sxm7H0KVT6
...
# [Disable an event destination](https://docs.stripe.com/api/v2/core/event_destinations/disable) v2
...
POST /v2/core/event_destinations/:id/disableServer-side languageStripe
CLIcURL.NETGoJavaNode.jsPHPPythonRuby
```
curl -X POST
https://api.stripe.com/v2/core/event_destinations/ed_test_61RM8ltWcTW4mbsxf16RJyfa2xSQLHJJh1sxm7H0KVT6/disable
\ -H "Authorization: Bearer {{YOUR_API_KEY}}{{YOUR_API_KEY}}" \ -H
"Stripe-Version: 2025-02-24.acacia"
```
...
"metadata": {}, "name": "My Event Destination", "snapshot_api_version": null,
"status": "disabled", "status_details": { "disabled": { "reason": "user" } },
"type": "webhook_endpoint", "updated": "2024-10-22T16:21:38.634Z",
"webhook_endpoint": { "signing_secret": null, "url": null }}
```

# [Enable an event destination](https://docs.stripe.com/api/v2/core/event_destinations/enable) v2
...
POST /v2/core/event_destinations/:id/enableServer-side languageStripe
CLIcURL.NETGoJavaNode.jsPHPPythonRuby
```
curl -X POST
https://api.stripe.com/v2/core/event_destinations/ed_test_61RM8ltWcTW4mbsxf16RJyfa2xSQLHJJh1sxm7H0KVT6/enable
\ -H "Authorization: Bearer {{YOUR_API_KEY}}{{YOUR_API_KEY}}" \ -H
"Stripe-Version: 2025-02-24.acacia"
```
...
"metadata": {}, "name": "My Event Destination", "snapshot_api_version": null,
"status": "enabled", "status_details": null, "type": "webhook_endpoint",
"updated": "2024-10-22T16:21:38.634Z", "webhook_endpoint": { "signing_secret":
null, "url": null }}
```

# [Ping an event destination](https://docs.stripe.com/api/v2/core/event_destinations/ping) v2
...
POST /v2/core/event_destinations/:id/pingServer-side languageStripe
CLIcURL.NETGoJavaNode.jsPHPPythonRuby
```
curl -X POST
https://api.stripe.com/v2/core/event_destinations/evt_test_65RM8sQH2oXnebF5Rpc16RJyfa2xSQLHJJh1sxm7H0KI92/ping
\ -H "Authorization: Bearer {{YOUR_API_KEY}}{{YOUR_API_KEY}}" \ -H
"Stripe-Version: 2025-02-24.acacia"
```
...
Response
```
{ "id": "evt_test_65RM8sQH2oXnebF5Rpc16RJyfa2xSQLHJJh1sxm7H0KI92", "object":
"v2.core.event", "context": null, "created": "2024-10-22T16:26:54.063Z", "data":
null, "livemode": false, "reason": null, "related_object": { "id":
"ed_test_61RM8ltWcTW4mbsxf16RJyfa2xSQLHJJh1sxm7H0KVT6", "type":
"event_destination", "url":
...
with the [create
file](https://docs.stripe.com/api/v2/core/event_destinations/retrieve#create_file)
...
query](https://docs.stripe.com/api/v2/core/event_destinations/retrieve#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/v2/core/event_destinations/retrieve#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/v2/core/event_destinations/retrieve#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/v2/core/event_destinations/retrieve#payment_intent_object-setup_future_usage)
...
conjunction with
[Prices](https://docs.stripe.com/api/v2/core/event_destinations/retrieve#prices)
...
[Products](https://docs.stripe.com/api/v2/core/event_destinations/retrieve#products)
help you track inventory or provisioning, and prices help you track payment
terms. Different physical goods or levels of service should be represented by
products, and pricing options should be represented by prices. This approach
...
[subscriptions](https://docs.stripe.com/api/v2/core/event_destinations/retrieve#subscriptions),
[invoices](https://docs.stripe.com/api/v2/core/event_destinations/retrieve#invoices),
[checkout sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/v2/core/event_destinations/retrieve#quotes),
and more. Coupons do not work with conventional one-off
[charges](https://docs.stripe.com/api/v2/core/event_destinations/retrieve#create_charge)
or [payment intents](https://docs.stripe.com/api/payment_intents).
...
[coupon](https://docs.stripe.com/api/v2/core/event_destinations/retrieve#coupons).
...
[coupon](https://docs.stripe.com/api/v2/core/event_destinations/retrieve#coupons)
or [promotion
code](https://docs.stripe.com/api/v2/core/event_destinations/retrieve#promotion_codes).
It contains information about when the discount began, when it will end, and
...
items](https://docs.stripe.com/api/v2/core/event_destinations/retrieve#invoiceitems),
...
API](https://docs.stripe.com/api/v2/core/event_destinations/retrieve#prices). It
...
[Payout](https://docs.stripe.com/api/v2/core/event_destinations/retrieve#payout_object)
...
[FinancialAccount’s](https://docs.stripe.com/api/v2/core/event_destinations/retrieve#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/v2/core/event_destinations/retrieve#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/v2/core/event_destinations/retrieve#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/v2/core/event_destinations/retrieve#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/v2/core/event_destinations/retrieve#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/v2/core/event_destinations/retrieve#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/v2/core/event_destinations/retrieve#received_debits)
