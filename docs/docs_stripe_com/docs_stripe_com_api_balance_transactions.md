...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fbalance_transactions)
...
Raises [an error](https://docs.stripe.com/api/balance_transactions#errors)
otherwise.
...
event](https://docs.stripe.com/api/balance_transactions#retrieve_event) or a
[list of events](https://docs.stripe.com/api/balance_transactions#list_events)
...
API](https://docs.stripe.com/api/balance_transactions#retrieve_event) for 30
days.
...
with the [create
file](https://docs.stripe.com/api/balance_transactions#create_file) request (for
...
query](https://docs.stripe.com/api/balance_transactions#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/balance_transactions#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/balance_transactions#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/balance_transactions#payment_intent_object-setup_future_usage)
...
conjunction with
[Prices](https://docs.stripe.com/api/balance_transactions#prices) to configure
...
[Products](https://docs.stripe.com/api/balance_transactions#products) help you
...
[subscriptions](https://docs.stripe.com/api/balance_transactions#subscriptions),
[invoices](https://docs.stripe.com/api/balance_transactions#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/balance_transactions#quotes), and more.
Coupons do not work with conventional one-off
[charges](https://docs.stripe.com/api/balance_transactions#create_charge) or
[payment intents](https://docs.stripe.com/api/payment_intents).
...
[coupon](https://docs.stripe.com/api/balance_transactions#coupons). It can be
...
[coupon](https://docs.stripe.com/api/balance_transactions#coupons) or [promotion
code](https://docs.stripe.com/api/balance_transactions#promotion_codes). It
...
items](https://docs.stripe.com/api/balance_transactions#invoiceitems), and
...
API](https://docs.stripe.com/api/balance_transactions#prices). It replaces the
...
[Payout](https://docs.stripe.com/api/balance_transactions#payout_object) object,
...
[FinancialAccount’s](https://docs.stripe.com/api/balance_transactions#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/balance_transactions#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/balance_transactions#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/balance_transactions#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/balance_transactions#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/balance_transactions#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/balance_transactions#received_debits)
