...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fmetadata)
...
event](https://docs.stripe.com/api/metadata#retrieve_event) or a [list of
events](https://docs.stripe.com/api/metadata#list_events) from the API. We also
...
API](https://docs.stripe.com/api/metadata#retrieve_event) for 30 days.
...
with the [create file](https://docs.stripe.com/api/metadata#create_file) request
...
query](https://docs.stripe.com/api/metadata#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/metadata#payment_intents) to drive
the payment flow.
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/metadata#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/metadata#payment_intent_object-setup_future_usage)
...
conjunction with [Prices](https://docs.stripe.com/api/metadata#prices) to
...
[Products](https://docs.stripe.com/api/metadata#products) help you track
...
[subscriptions](https://docs.stripe.com/api/metadata#subscriptions),
[invoices](https://docs.stripe.com/api/metadata#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/metadata#quotes), and more. Coupons do not
work with conventional one-off
[charges](https://docs.stripe.com/api/metadata#create_charge) or [payment
...
[coupon](https://docs.stripe.com/api/metadata#coupons). It can be used to create
...
[coupon](https://docs.stripe.com/api/metadata#coupons) or [promotion
code](https://docs.stripe.com/api/metadata#promotion_codes). It contains
...
They contain [invoice items](https://docs.stripe.com/api/metadata#invoiceitems),
...
API](https://docs.stripe.com/api/metadata#prices). It replaces the Plans API and
...
of products. [Products](https://docs.stripe.com/api/metadata#products) help you
...
[Payout](https://docs.stripe.com/api/metadata#payout_object) object, with
...
[FinancialAccount’s](https://docs.stripe.com/api/metadata#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/metadata#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/metadata#financial_accounts) to a
PaymentMethod belonging to the same entity. To send funds to a different party,
use [OutboundPayments](https://docs.stripe.com/api/metadata#outbound_payments)
...
[FinancialAccount](https://docs.stripe.com/api/metadata#financial_accounts). To
send money to an account belonging to the same user, use an
[OutboundTransfer](https://docs.stripe.com/api/metadata#outbound_transfers).
...
[FinancialAccount](https://docs.stripe.com/api/metadata#financial_accounts) via
...
[FinancialAccount](https://docs.stripe.com/api/metadata#financial_accounts) (for
...
[FinancialAccount](https://docs.stripe.com/api/metadata#financial_accounts).
...
[ReceivedCredits](https://docs.stripe.com/api/metadata#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/metadata#received_debits) depending
