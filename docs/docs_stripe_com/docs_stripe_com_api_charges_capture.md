...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fcharges%2Fcapture)
...
error](https://docs.stripe.com/api/charges/capture#errors) if something goes
...
error](https://docs.stripe.com/api/charges/capture#errors) if update parameters
are invalid.
...
error](https://docs.stripe.com/api/charges/capture#errors) otherwise.
...
error](https://docs.stripe.com/api/charges/capture#errors).
...
event](https://docs.stripe.com/api/charges/capture#retrieve_event) or a [list of
events](https://docs.stripe.com/api/charges/capture#list_events) from the API.
...
API](https://docs.stripe.com/api/charges/capture#retrieve_event) for 30 days.
...
with the [create file](https://docs.stripe.com/api/charges/capture#create_file)
...
query](https://docs.stripe.com/api/charges/capture#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/charges/capture#payment_intents) to
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/charges/capture#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/charges/capture#payment_intent_object-setup_future_usage)
...
conjunction with [Prices](https://docs.stripe.com/api/charges/capture#prices) to
...
[Products](https://docs.stripe.com/api/charges/capture#products) help you track
...
[subscriptions](https://docs.stripe.com/api/charges/capture#subscriptions),
[invoices](https://docs.stripe.com/api/charges/capture#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/charges/capture#quotes), and more. Coupons
do not work with conventional one-off
[charges](https://docs.stripe.com/api/charges/capture#create_charge) or [payment
...
[coupon](https://docs.stripe.com/api/charges/capture#coupons). It can be used to
...
[coupon](https://docs.stripe.com/api/charges/capture#coupons) or [promotion
code](https://docs.stripe.com/api/charges/capture#promotion_codes). It contains
...
items](https://docs.stripe.com/api/charges/capture#invoiceitems), and proration
...
API](https://docs.stripe.com/api/charges/capture#prices). It replaces the Plans
...
of products. [Products](https://docs.stripe.com/api/charges/capture#products)
...
[Payout](https://docs.stripe.com/api/charges/capture#payout_object) object, with
...
[FinancialAccount’s](https://docs.stripe.com/api/charges/capture#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/charges/capture#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/charges/capture#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/charges/capture#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/charges/capture#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/charges/capture#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/charges/capture#received_debits)
