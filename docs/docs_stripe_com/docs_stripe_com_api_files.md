...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Ffiles)
...
event](https://docs.stripe.com/api/files#retrieve_event) or a [list of
events](https://docs.stripe.com/api/files#list_events) from the API. We also
...
API](https://docs.stripe.com/api/files#retrieve_event) for 30 days.
...
with the [create file](https://docs.stripe.com/api/files#create_file) request
...
query](https://docs.stripe.com/api/files#scheduled_queries)).
...
Possible enum values`account_requirement`
...
`identity_document`
A document to verify the identity of an account owner during account
provisioning.
...
The File object
```
{ "id": "file_1Mr4LDLkdIwHu7ixFCz0dZiH", "object": "file", "created":
1680116847, "expires_at": 1703444847, "filename": "file.png", "links": {
"object": "list", "data": [], "has_more": false, "url":
"/v1/file_links?file=file_1Mr4LDLkdIwHu7ixFCz0dZiH" }, "purpose":
"dispute_evidence", "size": 8429, "title": null, "type": "png", "url":
...
`multipart/form-data`. Include the file you want to upload in the request, and
...
A file to upload. Make sure that the specifications follow RFC 2388, which
...
POST /v1/filesServer-side languageStripe CLIcURL.NETGoJavaNode.jsPHPPythonRuby
```
curl https://files.stripe.com/v1/files \ -u
sk_test_BQokikJ...2HlWgH4olfQ2sk_test_BQokikJOvBiI2HlWgH4olfQ2: \ -F
purpose=dispute_evidence \ -F file="@/path/to/a/file.jpg"
```
...
ID, Stripe returns the corresponding file object. Learn how to [access file
contents](https://docs.stripe.com/file-upload#download-file-contents).
...
raises [an error](https://docs.stripe.com/api/files#errors).

GET /v1/files/:idServer-side languageStripe
CLIcURL.NETGoJavaNode.jsPHPPythonRuby
```
curl https://api.stripe.com/v1/files/@/path/to/a/file.png \ -u
...
Filter queries by the file purpose. If you don’t provide a purpose, the queries
return unfiltered files.
...
files, starting after the `starting_after` file. Each entry in the array is a
separate file object. If there aren’t additional available files, the resulting
array is empty.

GET /v1/filesServer-side languageStripe CLIcURL.NETGoJavaNode.jsPHPPythonRuby
```
curl -G https://api.stripe.com/v1/files \ -u
"sk_test_BQokikJ...2HlWgH4olfQ2sk_test_BQokikJOvBiI2HlWgH4olfQ2:" \ -d limit=3
```

Response
```
{ "object": "list", "url": "/v1/files", "has_more": false, "data": [ { "id":
"file_1Mr4LDLkdIwHu7ixFCz0dZiH", "object": "file", "created": 1680116847,
"expires_at": 1703444847, "filename": "file.png", "links": { "object": "list",
"data": [], "has_more": false, "url":
"/v1/file_links?file=file_1Mr4LDLkdIwHu7ixFCz0dZiH" }, "purpose":
"dispute_evidence", "size": 8429, "title": null, "type": "png", "url":
"https://files.stripe.com/v1/files/file_1Mr4LDLkdIwHu7ixFCz0dZiH/contents" } ]}
```
...
[PaymentIntents](https://docs.stripe.com/api/files#payment_intents) to drive the
payment flow.
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/files#setup_intent_object-customer), it
...
[setup_future_usage](https://docs.stripe.com/api/files#payment_intent_object-setup_future_usage)
...
conjunction with [Prices](https://docs.stripe.com/api/files#prices) to configure
...
[Products](https://docs.stripe.com/api/files#products) help you track inventory
...
[subscriptions](https://docs.stripe.com/api/files#subscriptions),
[invoices](https://docs.stripe.com/api/files#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/files#quotes), and more. Coupons do not
work with conventional one-off
[charges](https://docs.stripe.com/api/files#create_charge) or [payment
...
[coupon](https://docs.stripe.com/api/files#coupons). It can be used to create
...
[coupon](https://docs.stripe.com/api/files#coupons) or [promotion
code](https://docs.stripe.com/api/files#promotion_codes). It contains
...
They contain [invoice items](https://docs.stripe.com/api/files#invoiceitems),
...
API](https://docs.stripe.com/api/files#prices). It replaces the Plans API and is
...
of products. [Products](https://docs.stripe.com/api/files#products) help you
...
[Payout](https://docs.stripe.com/api/files#payout_object) object, with
...
[FinancialAccount’s](https://docs.stripe.com/api/files#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/files#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/files#financial_accounts) to a
PaymentMethod belonging to the same entity. To send funds to a different party,
use [OutboundPayments](https://docs.stripe.com/api/files#outbound_payments)
...
[FinancialAccount](https://docs.stripe.com/api/files#financial_accounts). To
send money to an account belonging to the same user, use an
[OutboundTransfer](https://docs.stripe.com/api/files#outbound_transfers).
...
[FinancialAccount](https://docs.stripe.com/api/files#financial_accounts) via a
...
[FinancialAccount](https://docs.stripe.com/api/files#financial_accounts) (for
...
[FinancialAccount](https://docs.stripe.com/api/files#financial_accounts). These
...
[ReceivedCredits](https://docs.stripe.com/api/files#received_credits) depending
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/files#received_debits) depending on
their network and source flow. Reversing a ReceivedDebit leads to the creation
...
- [The File object](https://docs.stripe.com/api/files/object)
- [purpose](https://docs.stripe.com/file-upload#uploading-a-file)
- [access file
contents](https://docs.stripe.com/file-upload#download-file-contents)
- [File Links](https://docs.stripe.com/api/file_links)
