# Collect tax in Hungary

## Learn how to use Stripe Tax to calculate, collect, and report tax in Hungary.

Hungary is part of the EU and applies the EU VAT rules. Read more about those
...
about your potential tax registration obligations in Hungary. Stripe also
notifies you with email and Dashboard alerts when you need to register to
collect tax. Learn more about how the [monitoring tool
works](https://docs.stripe.com/tax/monitoring).

You can read more about registration obligations in Hungary on the [European
...
schemes](https://nav.gov.hu/en/main-tiles/e_services/System_for_taxpayers_not_established_in_the_EC/The_Mini_One_Stop_Sho20150929)

After you’ve registered to collect tax in Hungary, go to
[Registrations](https://dashboard.stripe.com/tax/registrations?location=hu) to
add your registrations to Stripe in the Dashboard. This turns on tax calculation
and collection in Stripe for your transactions in Hungary.
...
Hungary applies the EU VAT rules. Learn more about [tax calculation in the
...
- [One-Stop Shop registration
schemes](https://nav.gov.hu/en/main-tiles/e_services/System_for_taxpayers_not_established_in_the_EC/The_Mini_One_Stop_Sho20150929)
- [Registrations](https://dashboard.stripe.com/tax/registrations?location=hu)
- [how to add your
registration](https://docs.stripe.com/tax/registering#track-your-registrations-in-the-tax-dashboard)
