...
Always use the **api.stripe.com** DNS name to contact our API—never an IP
address.
...
As a convenience, these IP lists are available in other formats for import into
`iptables` or similar tools:
