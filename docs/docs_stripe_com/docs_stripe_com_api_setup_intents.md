...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fsetup_intents)
...
event](https://docs.stripe.com/api/setup_intents#retrieve_event) or a [list of
events](https://docs.stripe.com/api/setup_intents#list_events) from the API. We
...
API](https://docs.stripe.com/api/setup_intents#retrieve_event) for 30 days.
...
with the [create file](https://docs.stripe.com/api/setup_intents#create_file)
...
query](https://docs.stripe.com/api/setup_intents#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/setup_intents#payment_intents) to
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/setup_intents#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/setup_intents#payment_intent_object-setup_future_usage)
...
[SetupIntent](https://docs.stripe.com/api/setup_intents#setup_intent_object)
...
conjunction with [Prices](https://docs.stripe.com/api/setup_intents#prices) to
...
[Products](https://docs.stripe.com/api/setup_intents#products) help you track
...
[subscriptions](https://docs.stripe.com/api/setup_intents#subscriptions),
[invoices](https://docs.stripe.com/api/setup_intents#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/setup_intents#quotes), and more. Coupons do
not work with conventional one-off
[charges](https://docs.stripe.com/api/setup_intents#create_charge) or [payment
...
[coupon](https://docs.stripe.com/api/setup_intents#coupons). It can be used to
...
[coupon](https://docs.stripe.com/api/setup_intents#coupons) or [promotion
code](https://docs.stripe.com/api/setup_intents#promotion_codes). It contains
...
items](https://docs.stripe.com/api/setup_intents#invoiceitems), and proration
...
API](https://docs.stripe.com/api/setup_intents#prices). It replaces the Plans
...
of products. [Products](https://docs.stripe.com/api/setup_intents#products) help
...
[Payout](https://docs.stripe.com/api/setup_intents#payout_object) object, with
...
[FinancialAccount’s](https://docs.stripe.com/api/setup_intents#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/setup_intents#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/setup_intents#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/setup_intents#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/setup_intents#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/setup_intents#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/setup_intents#received_debits)
