...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Ffiles%2Fretrieve)
...
event](https://docs.stripe.com/api/files/retrieve#retrieve_event) or a [list of
events](https://docs.stripe.com/api/files/retrieve#list_events) from the API. We
...
API](https://docs.stripe.com/api/files/retrieve#retrieve_event) for 30 days.
...
with the [create file](https://docs.stripe.com/api/files/retrieve#create_file)
...
query](https://docs.stripe.com/api/files/retrieve#scheduled_queries)).
...
raises [an error](https://docs.stripe.com/api/files/retrieve#errors).
...
[PaymentIntents](https://docs.stripe.com/api/files/retrieve#payment_intents) to
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/files/retrieve#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/files/retrieve#payment_intent_object-setup_future_usage)
...
conjunction with [Prices](https://docs.stripe.com/api/files/retrieve#prices) to
...
[Products](https://docs.stripe.com/api/files/retrieve#products) help you track
...
[subscriptions](https://docs.stripe.com/api/files/retrieve#subscriptions),
[invoices](https://docs.stripe.com/api/files/retrieve#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/files/retrieve#quotes), and more. Coupons
do not work with conventional one-off
[charges](https://docs.stripe.com/api/files/retrieve#create_charge) or [payment
...
[coupon](https://docs.stripe.com/api/files/retrieve#coupons). It can be used to
...
[coupon](https://docs.stripe.com/api/files/retrieve#coupons) or [promotion
code](https://docs.stripe.com/api/files/retrieve#promotion_codes). It contains
...
items](https://docs.stripe.com/api/files/retrieve#invoiceitems), and proration
...
API](https://docs.stripe.com/api/files/retrieve#prices). It replaces the Plans
...
of products. [Products](https://docs.stripe.com/api/files/retrieve#products)
...
[Payout](https://docs.stripe.com/api/files/retrieve#payout_object) object, with
...
[FinancialAccount’s](https://docs.stripe.com/api/files/retrieve#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/files/retrieve#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/files/retrieve#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/files/retrieve#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/files/retrieve#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/files/retrieve#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/files/retrieve#received_debits)
