...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fpayouts%2Fretrieve)
...
event](https://docs.stripe.com/api/payouts/retrieve#retrieve_event) or a [list
of events](https://docs.stripe.com/api/payouts/retrieve#list_events) from the
...
API](https://docs.stripe.com/api/payouts/retrieve#retrieve_event) for 30 days.
...
with the [create file](https://docs.stripe.com/api/payouts/retrieve#create_file)
...
query](https://docs.stripe.com/api/payouts/retrieve#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/payouts/retrieve#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/payouts/retrieve#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/payouts/retrieve#payment_intent_object-setup_future_usage)
...
balance](https://docs.stripe.com/api/payouts/retrieve#balance) must cover the
...
from. The [balance
object](https://docs.stripe.com/api/payouts/retrieve#balance_object) details
...
error](https://docs.stripe.com/api/payouts/retrieve#errors) if update parameters
are invalid.
...
error](https://docs.stripe.com/api/payouts/retrieve#errors) occurs otherwise.
...
conjunction with [Prices](https://docs.stripe.com/api/payouts/retrieve#prices)
...
[Products](https://docs.stripe.com/api/payouts/retrieve#products) help you track
...
[subscriptions](https://docs.stripe.com/api/payouts/retrieve#subscriptions),
[invoices](https://docs.stripe.com/api/payouts/retrieve#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/payouts/retrieve#quotes), and more. Coupons
do not work with conventional one-off
[charges](https://docs.stripe.com/api/payouts/retrieve#create_charge) or
[payment intents](https://docs.stripe.com/api/payment_intents).
...
[coupon](https://docs.stripe.com/api/payouts/retrieve#coupons). It can be used
...
[coupon](https://docs.stripe.com/api/payouts/retrieve#coupons) or [promotion
code](https://docs.stripe.com/api/payouts/retrieve#promotion_codes). It contains
...
items](https://docs.stripe.com/api/payouts/retrieve#invoiceitems), and proration
...
API](https://docs.stripe.com/api/payouts/retrieve#prices). It replaces the Plans
...
of products. [Products](https://docs.stripe.com/api/payouts/retrieve#products)
...
[Payout](https://docs.stripe.com/api/payouts/retrieve#payout_object) object,
...
[FinancialAccount’s](https://docs.stripe.com/api/payouts/retrieve#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/payouts/retrieve#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/payouts/retrieve#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/payouts/retrieve#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/payouts/retrieve#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/payouts/retrieve#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/payouts/retrieve#received_debits)
