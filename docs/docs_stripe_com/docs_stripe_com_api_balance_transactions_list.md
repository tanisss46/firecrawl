...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fbalance_transactions%2Flist)
...
Raises [an error](https://docs.stripe.com/api/balance_transactions/list#errors)
otherwise.
...
event](https://docs.stripe.com/api/balance_transactions/list#retrieve_event) or
a [list of
events](https://docs.stripe.com/api/balance_transactions/list#list_events) from
...
API](https://docs.stripe.com/api/balance_transactions/list#retrieve_event) for
30 days.
...
with the [create
file](https://docs.stripe.com/api/balance_transactions/list#create_file) request
...
query](https://docs.stripe.com/api/balance_transactions/list#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/balance_transactions/list#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/balance_transactions/list#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/balance_transactions/list#payment_intent_object-setup_future_usage)
...
conjunction with
[Prices](https://docs.stripe.com/api/balance_transactions/list#prices) to
...
[Products](https://docs.stripe.com/api/balance_transactions/list#products) help
...
[subscriptions](https://docs.stripe.com/api/balance_transactions/list#subscriptions),
[invoices](https://docs.stripe.com/api/balance_transactions/list#invoices),
[checkout sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/balance_transactions/list#quotes), and
more. Coupons do not work with conventional one-off
[charges](https://docs.stripe.com/api/balance_transactions/list#create_charge)
...
[coupon](https://docs.stripe.com/api/balance_transactions/list#coupons). It can
...
[coupon](https://docs.stripe.com/api/balance_transactions/list#coupons) or
[promotion
code](https://docs.stripe.com/api/balance_transactions/list#promotion_codes). It
...
items](https://docs.stripe.com/api/balance_transactions/list#invoiceitems), and
...
API](https://docs.stripe.com/api/balance_transactions/list#prices). It replaces
...
[Payout](https://docs.stripe.com/api/balance_transactions/list#payout_object)
...
[FinancialAccount’s](https://docs.stripe.com/api/balance_transactions/list#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/balance_transactions/list#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/balance_transactions/list#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/balance_transactions/list#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/balance_transactions/list#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/balance_transactions/list#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/balance_transactions/list#received_debits)
