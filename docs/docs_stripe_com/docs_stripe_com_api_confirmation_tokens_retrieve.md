...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fconfirmation_tokens%2Fretrieve)
...
event](https://docs.stripe.com/api/confirmation_tokens/retrieve#retrieve_event)
or a [list of
events](https://docs.stripe.com/api/confirmation_tokens/retrieve#list_events)
...
API](https://docs.stripe.com/api/confirmation_tokens/retrieve#retrieve_event)
for 30 days.
...
with the [create
file](https://docs.stripe.com/api/confirmation_tokens/retrieve#create_file)
...
query](https://docs.stripe.com/api/confirmation_tokens/retrieve#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/confirmation_tokens/retrieve#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/confirmation_tokens/retrieve#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/confirmation_tokens/retrieve#payment_intent_object-setup_future_usage)
...
conjunction with
[Prices](https://docs.stripe.com/api/confirmation_tokens/retrieve#prices) to
...
[Products](https://docs.stripe.com/api/confirmation_tokens/retrieve#products)
...
[subscriptions](https://docs.stripe.com/api/confirmation_tokens/retrieve#subscriptions),
[invoices](https://docs.stripe.com/api/confirmation_tokens/retrieve#invoices),
[checkout sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/confirmation_tokens/retrieve#quotes), and
more. Coupons do not work with conventional one-off
[charges](https://docs.stripe.com/api/confirmation_tokens/retrieve#create_charge)
...
[coupon](https://docs.stripe.com/api/confirmation_tokens/retrieve#coupons). It
...
[coupon](https://docs.stripe.com/api/confirmation_tokens/retrieve#coupons) or
[promotion
code](https://docs.stripe.com/api/confirmation_tokens/retrieve#promotion_codes).
...
items](https://docs.stripe.com/api/confirmation_tokens/retrieve#invoiceitems),
...
API](https://docs.stripe.com/api/confirmation_tokens/retrieve#prices). It
...
[Payout](https://docs.stripe.com/api/confirmation_tokens/retrieve#payout_object)
...
[FinancialAccount’s](https://docs.stripe.com/api/confirmation_tokens/retrieve#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/confirmation_tokens/retrieve#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/confirmation_tokens/retrieve#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/confirmation_tokens/retrieve#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/confirmation_tokens/retrieve#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/confirmation_tokens/retrieve#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/confirmation_tokens/retrieve#received_debits)
