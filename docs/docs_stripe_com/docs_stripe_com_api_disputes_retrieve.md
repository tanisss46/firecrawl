...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fdisputes%2Fretrieve)
...
error](https://docs.stripe.com/api/disputes/retrieve#errors) otherwise.
...
event](https://docs.stripe.com/api/disputes/retrieve#retrieve_event) or a [list
of events](https://docs.stripe.com/api/disputes/retrieve#list_events) from the
...
API](https://docs.stripe.com/api/disputes/retrieve#retrieve_event) for 30 days.
...
with the [create
file](https://docs.stripe.com/api/disputes/retrieve#create_file) request (for
...
query](https://docs.stripe.com/api/disputes/retrieve#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/disputes/retrieve#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/disputes/retrieve#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/disputes/retrieve#payment_intent_object-setup_future_usage)
...
conjunction with [Prices](https://docs.stripe.com/api/disputes/retrieve#prices)
...
[Products](https://docs.stripe.com/api/disputes/retrieve#products) help you
...
[subscriptions](https://docs.stripe.com/api/disputes/retrieve#subscriptions),
[invoices](https://docs.stripe.com/api/disputes/retrieve#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/disputes/retrieve#quotes), and more.
Coupons do not work with conventional one-off
[charges](https://docs.stripe.com/api/disputes/retrieve#create_charge) or
[payment intents](https://docs.stripe.com/api/payment_intents).
...
[coupon](https://docs.stripe.com/api/disputes/retrieve#coupons). It can be used
...
[coupon](https://docs.stripe.com/api/disputes/retrieve#coupons) or [promotion
code](https://docs.stripe.com/api/disputes/retrieve#promotion_codes). It
...
items](https://docs.stripe.com/api/disputes/retrieve#invoiceitems), and
...
API](https://docs.stripe.com/api/disputes/retrieve#prices). It replaces the
...
of products. [Products](https://docs.stripe.com/api/disputes/retrieve#products)
...
[Payout](https://docs.stripe.com/api/disputes/retrieve#payout_object) object,
...
[FinancialAccount’s](https://docs.stripe.com/api/disputes/retrieve#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/disputes/retrieve#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/disputes/retrieve#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/disputes/retrieve#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/disputes/retrieve#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/disputes/retrieve#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/disputes/retrieve#received_debits)
