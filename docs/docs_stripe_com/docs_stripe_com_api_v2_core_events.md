...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fv2%2Fcore%2Fevents)
...
event](https://docs.stripe.com/api/v2/core/events#retrieve_event) or a [list of
events](https://docs.stripe.com/api/v2/core/events#list_events) from the API. We
...
API](https://docs.stripe.com/api/v2/core/events#retrieve_event) for 30 days.
...
with the [create file](https://docs.stripe.com/api/v2/core/events#create_file)
...
query](https://docs.stripe.com/api/v2/core/events#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/v2/core/events#payment_intents) to
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/v2/core/events#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/v2/core/events#payment_intent_object-setup_future_usage)
...
conjunction with [Prices](https://docs.stripe.com/api/v2/core/events#prices) to
...
[Products](https://docs.stripe.com/api/v2/core/events#products) help you track
...
[subscriptions](https://docs.stripe.com/api/v2/core/events#subscriptions),
[invoices](https://docs.stripe.com/api/v2/core/events#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/v2/core/events#quotes), and more. Coupons
do not work with conventional one-off
[charges](https://docs.stripe.com/api/v2/core/events#create_charge) or [payment
...
[coupon](https://docs.stripe.com/api/v2/core/events#coupons). It can be used to
...
[coupon](https://docs.stripe.com/api/v2/core/events#coupons) or [promotion
code](https://docs.stripe.com/api/v2/core/events#promotion_codes). It contains
...
items](https://docs.stripe.com/api/v2/core/events#invoiceitems), and proration
...
API](https://docs.stripe.com/api/v2/core/events#prices). It replaces the Plans
...
of products. [Products](https://docs.stripe.com/api/v2/core/events#products)
...
[Payout](https://docs.stripe.com/api/v2/core/events#payout_object) object, with
...
[FinancialAccount’s](https://docs.stripe.com/api/v2/core/events#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/v2/core/events#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/v2/core/events#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/v2/core/events#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/v2/core/events#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/v2/core/events#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/v2/core/events#received_debits)
