...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fpagination)
...
event](https://docs.stripe.com/api/pagination#retrieve_event) or a [list of
events](https://docs.stripe.com/api/pagination#list_events) from the API. We
...
API](https://docs.stripe.com/api/pagination#retrieve_event) for 30 days.
...
with the [create file](https://docs.stripe.com/api/pagination#create_file)
...
query](https://docs.stripe.com/api/pagination#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/pagination#payment_intents) to
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/pagination#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/pagination#payment_intent_object-setup_future_usage)
...
conjunction with [Prices](https://docs.stripe.com/api/pagination#prices) to
...
[Products](https://docs.stripe.com/api/pagination#products) help you track
...
[subscriptions](https://docs.stripe.com/api/pagination#subscriptions),
[invoices](https://docs.stripe.com/api/pagination#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/pagination#quotes), and more. Coupons do
not work with conventional one-off
[charges](https://docs.stripe.com/api/pagination#create_charge) or [payment
...
[coupon](https://docs.stripe.com/api/pagination#coupons). It can be used to
...
[coupon](https://docs.stripe.com/api/pagination#coupons) or [promotion
code](https://docs.stripe.com/api/pagination#promotion_codes). It contains
...
items](https://docs.stripe.com/api/pagination#invoiceitems), and proration
...
API](https://docs.stripe.com/api/pagination#prices). It replaces the Plans API
...
of products. [Products](https://docs.stripe.com/api/pagination#products) help
...
[Payout](https://docs.stripe.com/api/pagination#payout_object) object, with
...
[FinancialAccount’s](https://docs.stripe.com/api/pagination#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/pagination#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/pagination#financial_accounts) to
a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/pagination#outbound_payments)
...
[FinancialAccount](https://docs.stripe.com/api/pagination#financial_accounts).
To send money to an account belonging to the same user, use an
[OutboundTransfer](https://docs.stripe.com/api/pagination#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/pagination#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/pagination#received_debits)
