...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fexpanding_objects)
...
event](https://docs.stripe.com/api/expanding_objects#retrieve_event) or a [list
of events](https://docs.stripe.com/api/expanding_objects#list_events) from the
...
API](https://docs.stripe.com/api/expanding_objects#retrieve_event) for 30 days.
...
with the [create
file](https://docs.stripe.com/api/expanding_objects#create_file) request (for
...
query](https://docs.stripe.com/api/expanding_objects#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/expanding_objects#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/expanding_objects#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/expanding_objects#payment_intent_object-setup_future_usage)
...
conjunction with [Prices](https://docs.stripe.com/api/expanding_objects#prices)
...
[Products](https://docs.stripe.com/api/expanding_objects#products) help you
...
[subscriptions](https://docs.stripe.com/api/expanding_objects#subscriptions),
[invoices](https://docs.stripe.com/api/expanding_objects#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/expanding_objects#quotes), and more.
Coupons do not work with conventional one-off
[charges](https://docs.stripe.com/api/expanding_objects#create_charge) or
[payment intents](https://docs.stripe.com/api/payment_intents).
...
[coupon](https://docs.stripe.com/api/expanding_objects#coupons). It can be used
...
[coupon](https://docs.stripe.com/api/expanding_objects#coupons) or [promotion
code](https://docs.stripe.com/api/expanding_objects#promotion_codes). It
...
items](https://docs.stripe.com/api/expanding_objects#invoiceitems), and
...
API](https://docs.stripe.com/api/expanding_objects#prices). It replaces the
...
of products. [Products](https://docs.stripe.com/api/expanding_objects#products)
...
[Payout](https://docs.stripe.com/api/expanding_objects#payout_object) object,
...
[FinancialAccount’s](https://docs.stripe.com/api/expanding_objects#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/expanding_objects#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/expanding_objects#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/expanding_objects#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/expanding_objects#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/expanding_objects#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/expanding_objects#received_debits)
