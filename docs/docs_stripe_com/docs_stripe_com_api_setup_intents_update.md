...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fsetup_intents%2Fupdate)
...
event](https://docs.stripe.com/api/setup_intents/update#retrieve_event) or a
[list of events](https://docs.stripe.com/api/setup_intents/update#list_events)
...
API](https://docs.stripe.com/api/setup_intents/update#retrieve_event) for 30
days.
...
with the [create
file](https://docs.stripe.com/api/setup_intents/update#create_file) request (for
...
query](https://docs.stripe.com/api/setup_intents/update#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/setup_intents/update#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/setup_intents/update#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/setup_intents/update#payment_intent_object-setup_future_usage)
...
[SetupIntent](https://docs.stripe.com/api/setup_intents/update#setup_intent_object)
...
conjunction with
[Prices](https://docs.stripe.com/api/setup_intents/update#prices) to configure
...
[Products](https://docs.stripe.com/api/setup_intents/update#products) help you
...
[subscriptions](https://docs.stripe.com/api/setup_intents/update#subscriptions),
[invoices](https://docs.stripe.com/api/setup_intents/update#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/setup_intents/update#quotes), and more.
Coupons do not work with conventional one-off
[charges](https://docs.stripe.com/api/setup_intents/update#create_charge) or
[payment intents](https://docs.stripe.com/api/payment_intents).
...
[coupon](https://docs.stripe.com/api/setup_intents/update#coupons). It can be
...
[coupon](https://docs.stripe.com/api/setup_intents/update#coupons) or [promotion
code](https://docs.stripe.com/api/setup_intents/update#promotion_codes). It
...
items](https://docs.stripe.com/api/setup_intents/update#invoiceitems), and
...
API](https://docs.stripe.com/api/setup_intents/update#prices). It replaces the
...
[Payout](https://docs.stripe.com/api/setup_intents/update#payout_object) object,
...
[FinancialAccount’s](https://docs.stripe.com/api/setup_intents/update#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/setup_intents/update#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/setup_intents/update#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/setup_intents/update#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/setup_intents/update#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/setup_intents/update#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/setup_intents/update#received_debits)
