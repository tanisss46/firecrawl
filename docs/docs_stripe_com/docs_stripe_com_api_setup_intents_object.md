...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fsetup_intents%2Fobject)
...
event](https://docs.stripe.com/api/setup_intents/object#retrieve_event) or a
[list of events](https://docs.stripe.com/api/setup_intents/object#list_events)
...
API](https://docs.stripe.com/api/setup_intents/object#retrieve_event) for 30
days.
...
with the [create
file](https://docs.stripe.com/api/setup_intents/object#create_file) request (for
...
query](https://docs.stripe.com/api/setup_intents/object#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/setup_intents/object#payment_intents)
...
[setup_future_usage](https://docs.stripe.com/api/setup_intents/object#payment_intent_object-setup_future_usage)
...
[SetupIntent](https://docs.stripe.com/api/setup_intents/object#setup_intent_object)
...
conjunction with
[Prices](https://docs.stripe.com/api/setup_intents/object#prices) to configure
...
[Products](https://docs.stripe.com/api/setup_intents/object#products) help you
...
[subscriptions](https://docs.stripe.com/api/setup_intents/object#subscriptions),
[invoices](https://docs.stripe.com/api/setup_intents/object#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/setup_intents/object#quotes), and more.
Coupons do not work with conventional one-off
[charges](https://docs.stripe.com/api/setup_intents/object#create_charge) or
[payment intents](https://docs.stripe.com/api/payment_intents).
...
[coupon](https://docs.stripe.com/api/setup_intents/object#coupons). It can be
...
[coupon](https://docs.stripe.com/api/setup_intents/object#coupons) or [promotion
code](https://docs.stripe.com/api/setup_intents/object#promotion_codes). It
...
items](https://docs.stripe.com/api/setup_intents/object#invoiceitems), and
...
API](https://docs.stripe.com/api/setup_intents/object#prices). It replaces the
...
[Payout](https://docs.stripe.com/api/setup_intents/object#payout_object) object,
...
[FinancialAccount’s](https://docs.stripe.com/api/setup_intents/object#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/setup_intents/object#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/setup_intents/object#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/setup_intents/object#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/setup_intents/object#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/setup_intents/object#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/setup_intents/object#received_debits)
