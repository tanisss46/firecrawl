...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fcustomer_sessions)
...
event](https://docs.stripe.com/api/customer_sessions#retrieve_event) or a [list
of events](https://docs.stripe.com/api/customer_sessions#list_events) from the
...
API](https://docs.stripe.com/api/customer_sessions#retrieve_event) for 30 days.
...
with the [create
file](https://docs.stripe.com/api/customer_sessions#create_file) request (for
...
query](https://docs.stripe.com/api/customer_sessions#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/customer_sessions#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/customer_sessions#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/customer_sessions#payment_intent_object-setup_future_usage)
...
conjunction with [Prices](https://docs.stripe.com/api/customer_sessions#prices)
...
[Products](https://docs.stripe.com/api/customer_sessions#products) help you
...
[subscriptions](https://docs.stripe.com/api/customer_sessions#subscriptions),
[invoices](https://docs.stripe.com/api/customer_sessions#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/customer_sessions#quotes), and more.
Coupons do not work with conventional one-off
[charges](https://docs.stripe.com/api/customer_sessions#create_charge) or
[payment intents](https://docs.stripe.com/api/payment_intents).
...
[coupon](https://docs.stripe.com/api/customer_sessions#coupons). It can be used
...
[coupon](https://docs.stripe.com/api/customer_sessions#coupons) or [promotion
code](https://docs.stripe.com/api/customer_sessions#promotion_codes). It
...
items](https://docs.stripe.com/api/customer_sessions#invoiceitems), and
...
API](https://docs.stripe.com/api/customer_sessions#prices). It replaces the
...
of products. [Products](https://docs.stripe.com/api/customer_sessions#products)
...
[Payout](https://docs.stripe.com/api/customer_sessions#payout_object) object,
...
[FinancialAccount’s](https://docs.stripe.com/api/customer_sessions#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/customer_sessions#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/customer_sessions#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/customer_sessions#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/customer_sessions#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/customer_sessions#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/customer_sessions#received_debits)
