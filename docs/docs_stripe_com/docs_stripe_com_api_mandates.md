...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fmandates)
...
event](https://docs.stripe.com/api/mandates#retrieve_event) or a [list of
events](https://docs.stripe.com/api/mandates#list_events) from the API. We also
...
API](https://docs.stripe.com/api/mandates#retrieve_event) for 30 days.
...
with the [create file](https://docs.stripe.com/api/mandates#create_file) request
...
query](https://docs.stripe.com/api/mandates#scheduled_queries)).
...
`inactive`
The mandate was rejected, revoked, or previously used, and may not be used to
...
Possible enum values`multi_use`
...
The Mandate object
```
{ "id": "mandate_1MvojA2eZvKYlo2CvqTABjZs", "object": "mandate",
"customer_acceptance": { "accepted_at": 123456789, "online": { "ip_address":
"127.0.0.0", "user_agent": "device" }, "type": "online" }, "livemode": false,
"multi_use": {}, "payment_method": "pm_123456789", "payment_method_details": {
"sepa_debit": { "reference": "123456789", "url": "" }, "type": "sepa_debit" },
"status": "active", "type": "multi_use"}
```
...
GET /v1/mandates/:idServer-side languageStripe
CLIcURL.NETGoJavaNode.jsPHPPythonRuby
```
curl https://api.stripe.com/v1/mandates/mandate_1MvojA2eZvKYlo2CvqTABjZs \ -u
...
[PaymentIntents](https://docs.stripe.com/api/mandates#payment_intents) to drive
the payment flow.
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/mandates#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/mandates#payment_intent_object-setup_future_usage)
...
conjunction with [Prices](https://docs.stripe.com/api/mandates#prices) to
...
[Products](https://docs.stripe.com/api/mandates#products) help you track
...
[subscriptions](https://docs.stripe.com/api/mandates#subscriptions),
[invoices](https://docs.stripe.com/api/mandates#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/mandates#quotes), and more. Coupons do not
work with conventional one-off
[charges](https://docs.stripe.com/api/mandates#create_charge) or [payment
...
[coupon](https://docs.stripe.com/api/mandates#coupons). It can be used to create
...
[coupon](https://docs.stripe.com/api/mandates#coupons) or [promotion
code](https://docs.stripe.com/api/mandates#promotion_codes). It contains
...
They contain [invoice items](https://docs.stripe.com/api/mandates#invoiceitems),
...
API](https://docs.stripe.com/api/mandates#prices). It replaces the Plans API and
...
of products. [Products](https://docs.stripe.com/api/mandates#products) help you
...
[Payout](https://docs.stripe.com/api/mandates#payout_object) object, with
...
[FinancialAccount’s](https://docs.stripe.com/api/mandates#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/mandates#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/mandates#financial_accounts) to a
PaymentMethod belonging to the same entity. To send funds to a different party,
use [OutboundPayments](https://docs.stripe.com/api/mandates#outbound_payments)
...
[FinancialAccount](https://docs.stripe.com/api/mandates#financial_accounts). To
send money to an account belonging to the same user, use an
[OutboundTransfer](https://docs.stripe.com/api/mandates#outbound_transfers).
...
[FinancialAccount](https://docs.stripe.com/api/mandates#financial_accounts) via
...
[FinancialAccount](https://docs.stripe.com/api/mandates#financial_accounts) (for
...
[FinancialAccount](https://docs.stripe.com/api/mandates#financial_accounts).
...
[ReceivedCredits](https://docs.stripe.com/api/mandates#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/mandates#received_debits) depending
