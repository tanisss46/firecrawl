...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fpayouts%2Fupdate)
...
event](https://docs.stripe.com/api/payouts/update#retrieve_event) or a [list of
events](https://docs.stripe.com/api/payouts/update#list_events) from the API. We
...
API](https://docs.stripe.com/api/payouts/update#retrieve_event) for 30 days.
...
with the [create file](https://docs.stripe.com/api/payouts/update#create_file)
...
query](https://docs.stripe.com/api/payouts/update#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/payouts/update#payment_intents) to
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/payouts/update#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/payouts/update#payment_intent_object-setup_future_usage)
...
balance](https://docs.stripe.com/api/payouts/update#balance) must cover the
...
from. The [balance
object](https://docs.stripe.com/api/payouts/update#balance_object) details
...
error](https://docs.stripe.com/api/payouts/update#errors) if update parameters
are invalid.
...
error](https://docs.stripe.com/api/payouts/update#errors) occurs otherwise.
...
conjunction with [Prices](https://docs.stripe.com/api/payouts/update#prices) to
...
[Products](https://docs.stripe.com/api/payouts/update#products) help you track
...
[subscriptions](https://docs.stripe.com/api/payouts/update#subscriptions),
[invoices](https://docs.stripe.com/api/payouts/update#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/payouts/update#quotes), and more. Coupons
do not work with conventional one-off
[charges](https://docs.stripe.com/api/payouts/update#create_charge) or [payment
...
[coupon](https://docs.stripe.com/api/payouts/update#coupons). It can be used to
...
[coupon](https://docs.stripe.com/api/payouts/update#coupons) or [promotion
code](https://docs.stripe.com/api/payouts/update#promotion_codes). It contains
...
items](https://docs.stripe.com/api/payouts/update#invoiceitems), and proration
...
API](https://docs.stripe.com/api/payouts/update#prices). It replaces the Plans
...
of products. [Products](https://docs.stripe.com/api/payouts/update#products)
...
[Payout](https://docs.stripe.com/api/payouts/update#payout_object) object, with
...
[FinancialAccount’s](https://docs.stripe.com/api/payouts/update#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/payouts/update#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/payouts/update#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/payouts/update#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/payouts/update#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/payouts/update#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/payouts/update#received_debits)
