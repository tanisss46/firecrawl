...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fbalance_transactions%2Fretrieve)
...
Gross amount of this transaction (in cents). A positive value represents funds
charged to another party, and a negative value represents funds sent to another
party.
- #### currencyenum
...
Fees (in cents) paid for this transaction. Represented as a positive integer
when assessed.
...
Net impact to a Stripe balance (in cents). A positive value represents
incrementing a Stripe balance, and a negative value decrementing a Stripe
balance. You can calculate the net impact of a transaction on a balance by
`amount` - `fee`
...
`transfer_failure`, or `transfer_refund`. Learn more about [balance transaction
types and what they
represent](https://stripe.com/docs/reports/balance-transaction-types). To
classify transactions for accounting purposes, consider `reporting_category`
instead.

Possible enum
values`adjustment``advance``advance_funding``anticipation_repayment``application_fee``application_fee_refund``charge``climate_order_purchase``climate_order_refund``connect_collection_transfer`Show
32 more
...
```
{ "id": "txn_1MiN3gLkdIwHu7ixxapQrznl", "object": "balance_transaction",
"amount": -400, "available_on": 1678043844, "created": 1678043844, "currency":
"usd", "description": null, "exchange_rate": null, "fee": 0, "fee_details": [],
"net": -400, "reporting_category": "transfer", "source":
"tr_1MiN3gLkdIwHu7ixNCZvFdgA", "status": "available", "type": "transfer"}
```
...
Raises [an
error](https://docs.stripe.com/api/balance_transactions/retrieve#errors)
otherwise.

GET /v1/balance_transactions/:idServer-side languageStripe
CLIcURL.NETGoJavaNode.jsPHPPythonRuby
```
...
For automatic Stripe payouts only, only returns transactions that were paid out
on the specified payout ID.
- #### typestring
...
transactions, starting after transaction `starting_after`. Each entry in the
array is a separate transaction history object. If no more transactions are
available, the resulting array will be empty.

GET /v1/balance_transactionsServer-side languageStripe
CLIcURL.NETGoJavaNode.jsPHPPythonRuby
```
...
"data": [ { "id": "txn_1MiN3gLkdIwHu7ixxapQrznl", "object":
"balance_transaction", "amount": -400, "available_on": 1678043844, "created":
1678043844, "currency": "usd", "description": null, "exchange_rate": null,
"fee": 0, "fee_details": [], "net": -400, "reporting_category": "transfer",
"source": "tr_1MiN3gLkdIwHu7ixNCZvFdgA", "status": "available", "type":
"transfer" } ]}
```
...
event](https://docs.stripe.com/api/balance_transactions/retrieve#retrieve_event)
or a [list of
events](https://docs.stripe.com/api/balance_transactions/retrieve#list_events)
...
API](https://docs.stripe.com/api/balance_transactions/retrieve#retrieve_event)
for 30 days.
...
with the [create
file](https://docs.stripe.com/api/balance_transactions/retrieve#create_file)
...
query](https://docs.stripe.com/api/balance_transactions/retrieve#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/balance_transactions/retrieve#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/balance_transactions/retrieve#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/balance_transactions/retrieve#payment_intent_object-setup_future_usage)
...
conjunction with
[Prices](https://docs.stripe.com/api/balance_transactions/retrieve#prices) to
...
[Products](https://docs.stripe.com/api/balance_transactions/retrieve#products)
...
[subscriptions](https://docs.stripe.com/api/balance_transactions/retrieve#subscriptions),
[invoices](https://docs.stripe.com/api/balance_transactions/retrieve#invoices),
[checkout sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/balance_transactions/retrieve#quotes), and
more. Coupons do not work with conventional one-off
[charges](https://docs.stripe.com/api/balance_transactions/retrieve#create_charge)
...
[coupon](https://docs.stripe.com/api/balance_transactions/retrieve#coupons). It
...
[coupon](https://docs.stripe.com/api/balance_transactions/retrieve#coupons) or
[promotion
code](https://docs.stripe.com/api/balance_transactions/retrieve#promotion_codes).
...
items](https://docs.stripe.com/api/balance_transactions/retrieve#invoiceitems),
...
API](https://docs.stripe.com/api/balance_transactions/retrieve#prices). It
...
[Payout](https://docs.stripe.com/api/balance_transactions/retrieve#payout_object)
...
[FinancialAccount’s](https://docs.stripe.com/api/balance_transactions/retrieve#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/balance_transactions/retrieve#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/balance_transactions/retrieve#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/balance_transactions/retrieve#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/balance_transactions/retrieve#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/balance_transactions/retrieve#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/balance_transactions/retrieve#received_debits)
...
- [supported currency](https://stripe.com/docs/currencies)
- [balance transaction types and what they
