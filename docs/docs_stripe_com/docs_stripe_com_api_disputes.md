...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fdisputes)
...
Evidence provided to respond to a dispute. Updating any field in the hash
submits all fields in the hash for review.
...
Possible enum
values`lost``needs_response``under_review``warning_closed``warning_needs_response``warning_under_review``won`
...
The Dispute object
```
{ "id": "du_1MtJUT2eZvKYlo2CNaw2HvEv", "object": "dispute", "amount": 1000,
"balance_transactions": [], "charge": "ch_1AZtxr2eZvKYlo2CJDX8whov", "created":
1680651737, "currency": "usd", "evidence": { "access_activity_log": null,
"billing_address": null, "cancellation_policy": null,
"cancellation_policy_disclosure": null, "cancellation_rebuttal": null,
"customer_communication": null, "customer_email_address": null, "customer_name":
null, "customer_purchase_ip": null, "customer_signature": null,
"duplicate_charge_documentation": null, "duplicate_charge_explanation": null,
"duplicate_charge_id": null, "product_description": null, "receipt": null,
"refund_policy": null, "refund_policy_disclosure": null,
"refund_refusal_explanation": null, "service_date": null,
"service_documentation": null, "shipping_address": null, "shipping_carrier":
null, "shipping_date": null, "shipping_documentation": null,
"shipping_tracking_number": null, "uncategorized_file": null,
"uncategorized_text": null }, "evidence_details": { "due_by": 1682294399,
"has_evidence": false, "past_due": false, "submission_count": 0 },
"is_charge_refundable": true, "livemode": false, "metadata": {},
"payment_intent": null, "reason": "general", "status": "warning_needs_response"}
```
...
your favor. You can do this in your
[dashboard](https://dashboard.stripe.com/disputes), but if you prefer, you can
...
see our [guide to dispute types](https://docs.stripe.com/disputes/categories).
...
POST /v1/disputes/:idServer-side languageStripe
CLIcURL.NETGoJavaNode.jsPHPPythonRuby
```
curl https://api.stripe.com/v1/disputes/du_1MtJUT2eZvKYlo2CNaw2HvEv \ -u
"sk_test_BQokikJ...2HlWgH4olfQ2sk_test_BQokikJOvBiI2HlWgH4olfQ2:" \ -d
"metadata[order_id]"=6735
```
...
"uncategorized_text": null }, "evidence_details": { "due_by": 1682294399,
"has_evidence": false, "past_due": false, "submission_count": 0 },
"is_charge_refundable": true, "livemode": false, "metadata": { "order_id":
"6735" }, "payment_intent": null, "reason": "general", "status":
...
Returns a dispute if a valid dispute ID was provided. Raises [an
error](https://docs.stripe.com/api/disputes#errors) otherwise.

GET /v1/disputes/:idServer-side languageStripe
CLIcURL.NETGoJavaNode.jsPHPPythonRuby
```
curl https://api.stripe.com/v1/disputes/du_1MtJUT2eZvKYlo2CNaw2HvEv \ -u
...
disputes, starting after dispute `starting_after`. Each entry in the array is a
separate dispute object. If no more disputes are available, the resulting array
will be empty.

GET /v1/disputesServer-side languageStripe CLIcURL.NETGoJavaNode.jsPHPPythonRuby
```
...
Response
```
{ "object": "list", "url": "/v1/disputes", "has_more": false, "data": [ { "id":
"du_1MtJUT2eZvKYlo2CNaw2HvEv", "object": "dispute", "amount": 1000,
"balance_transactions": [], "charge": "ch_1AZtxr2eZvKYlo2CJDX8whov", "created":
1680651737, "currency": "usd", "evidence": { "access_activity_log": null,
"billing_address": null, "cancellation_policy": null,
"cancellation_policy_disclosure": null, "cancellation_rebuttal": null,
...
The status of the dispute will change from `needs_response` to `lost`. *Closing
...
POST /v1/disputes/:id/closeServer-side languageStripe
CLIcURL.NETGoJavaNode.jsPHPPythonRuby
```
curl -X POST
https://api.stripe.com/v1/disputes/du_1MtJUT2eZvKYlo2CNaw2HvEv/close \ -u
"sk_test_BQokikJ...2HlWgH4olfQ2sk_test_BQokikJOvBiI2HlWgH4olfQ2:"
```
...
event](https://docs.stripe.com/api/disputes#retrieve_event) or a [list of
events](https://docs.stripe.com/api/disputes#list_events) from the API. We also
...
API](https://docs.stripe.com/api/disputes#retrieve_event) for 30 days.
...
with the [create file](https://docs.stripe.com/api/disputes#create_file) request
...
query](https://docs.stripe.com/api/disputes#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/disputes#payment_intents) to drive
the payment flow.
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/disputes#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/disputes#payment_intent_object-setup_future_usage)
...
conjunction with [Prices](https://docs.stripe.com/api/disputes#prices) to
...
[Products](https://docs.stripe.com/api/disputes#products) help you track
...
[subscriptions](https://docs.stripe.com/api/disputes#subscriptions),
[invoices](https://docs.stripe.com/api/disputes#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/disputes#quotes), and more. Coupons do not
work with conventional one-off
[charges](https://docs.stripe.com/api/disputes#create_charge) or [payment
...
[coupon](https://docs.stripe.com/api/disputes#coupons). It can be used to create
...
[coupon](https://docs.stripe.com/api/disputes#coupons) or [promotion
code](https://docs.stripe.com/api/disputes#promotion_codes). It contains
...
They contain [invoice items](https://docs.stripe.com/api/disputes#invoiceitems),
...
API](https://docs.stripe.com/api/disputes#prices). It replaces the Plans API and
...
of products. [Products](https://docs.stripe.com/api/disputes#products) help you
...
[Payout](https://docs.stripe.com/api/disputes#payout_object) object, with
...
[FinancialAccount’s](https://docs.stripe.com/api/disputes#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/disputes#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/disputes#financial_accounts) to a
PaymentMethod belonging to the same entity. To send funds to a different party,
use [OutboundPayments](https://docs.stripe.com/api/disputes#outbound_payments)
...
[FinancialAccount](https://docs.stripe.com/api/disputes#financial_accounts). To
send money to an account belonging to the same user, use an
[OutboundTransfer](https://docs.stripe.com/api/disputes#outbound_transfers).
...
[FinancialAccount](https://docs.stripe.com/api/disputes#financial_accounts) via
a PaymentMethod that is owned by you. The funds will be transferred via an ACH
debit.
...
[FinancialAccount](https://docs.stripe.com/api/disputes#financial_accounts) (for
...
[FinancialAccount](https://docs.stripe.com/api/disputes#financial_accounts).
...
[ReceivedCredits](https://docs.stripe.com/api/disputes#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/disputes#received_debits) depending
