...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Ffiles%2Fobject)
...
event](https://docs.stripe.com/api/files/object#retrieve_event) or a [list of
events](https://docs.stripe.com/api/files/object#list_events) from the API. We
...
API](https://docs.stripe.com/api/files/object#retrieve_event) for 30 days.
...
with the [create file](https://docs.stripe.com/api/files/object#create_file)
...
query](https://docs.stripe.com/api/files/object#scheduled_queries)).
...
raises [an error](https://docs.stripe.com/api/files/object#errors).
...
[PaymentIntents](https://docs.stripe.com/api/files/object#payment_intents) to
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/files/object#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/files/object#payment_intent_object-setup_future_usage)
...
conjunction with [Prices](https://docs.stripe.com/api/files/object#prices) to
...
[Products](https://docs.stripe.com/api/files/object#products) help you track
...
[subscriptions](https://docs.stripe.com/api/files/object#subscriptions),
[invoices](https://docs.stripe.com/api/files/object#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/files/object#quotes), and more. Coupons do
not work with conventional one-off
[charges](https://docs.stripe.com/api/files/object#create_charge) or [payment
...
[coupon](https://docs.stripe.com/api/files/object#coupons). It can be used to
...
[coupon](https://docs.stripe.com/api/files/object#coupons) or [promotion
code](https://docs.stripe.com/api/files/object#promotion_codes). It contains
...
items](https://docs.stripe.com/api/files/object#invoiceitems), and proration
...
API](https://docs.stripe.com/api/files/object#prices). It replaces the Plans API
...
of products. [Products](https://docs.stripe.com/api/files/object#products) help
...
[Payout](https://docs.stripe.com/api/files/object#payout_object) object, with
...
[FinancialAccount’s](https://docs.stripe.com/api/files/object#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/files/object#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/files/object#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/files/object#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/files/object#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/files/object#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/files/object#received_debits)
