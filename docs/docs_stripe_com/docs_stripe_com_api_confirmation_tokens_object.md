...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fconfirmation_tokens%2Fobject)
...
event](https://docs.stripe.com/api/confirmation_tokens/object#retrieve_event) or
a [list of
events](https://docs.stripe.com/api/confirmation_tokens/object#list_events) from
...
API](https://docs.stripe.com/api/confirmation_tokens/object#retrieve_event) for
30 days.
...
with the [create
file](https://docs.stripe.com/api/confirmation_tokens/object#create_file)
...
query](https://docs.stripe.com/api/confirmation_tokens/object#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/confirmation_tokens/object#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/confirmation_tokens/object#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/confirmation_tokens/object#payment_intent_object-setup_future_usage)
...
conjunction with
[Prices](https://docs.stripe.com/api/confirmation_tokens/object#prices) to
...
[Products](https://docs.stripe.com/api/confirmation_tokens/object#products) help
...
[subscriptions](https://docs.stripe.com/api/confirmation_tokens/object#subscriptions),
[invoices](https://docs.stripe.com/api/confirmation_tokens/object#invoices),
[checkout sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/confirmation_tokens/object#quotes), and
more. Coupons do not work with conventional one-off
[charges](https://docs.stripe.com/api/confirmation_tokens/object#create_charge)
...
[coupon](https://docs.stripe.com/api/confirmation_tokens/object#coupons). It can
...
[coupon](https://docs.stripe.com/api/confirmation_tokens/object#coupons) or
[promotion
code](https://docs.stripe.com/api/confirmation_tokens/object#promotion_codes).
...
items](https://docs.stripe.com/api/confirmation_tokens/object#invoiceitems), and
...
API](https://docs.stripe.com/api/confirmation_tokens/object#prices). It replaces
...
[Payout](https://docs.stripe.com/api/confirmation_tokens/object#payout_object)
...
[FinancialAccount’s](https://docs.stripe.com/api/confirmation_tokens/object#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/confirmation_tokens/object#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/confirmation_tokens/object#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/confirmation_tokens/object#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/confirmation_tokens/object#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/confirmation_tokens/object#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/confirmation_tokens/object#received_debits)
