...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Ftokens)
...
event](https://docs.stripe.com/api/tokens#retrieve_event) or a [list of
events](https://docs.stripe.com/api/tokens#list_events) from the API. We also
...
API](https://docs.stripe.com/api/tokens#retrieve_event) for 30 days.
...
with the [create file](https://docs.stripe.com/api/tokens#create_file) request
...
query](https://docs.stripe.com/api/tokens#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/tokens#payment_intents) to drive
the payment flow.
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/tokens#setup_intent_object-customer), it
...
[setup_future_usage](https://docs.stripe.com/api/tokens#payment_intent_object-setup_future_usage)
...
raises [an error](https://docs.stripe.com/api/tokens#errors).
...
account](https://docs.stripe.com/api/tokens#accounts) where
...
object](https://docs.stripe.com/api/tokens#create_charge) or by attaching them
to a [Customer object](https://docs.stripe.com/api/tokens#create_customer).
...
[an error](https://docs.stripe.com/api/tokens#errors).
...
[id_number](https://docs.stripe.com/api/tokens#update_account-individual-id_number)
or
[id_number_secondary](https://docs.stripe.com/api/tokens#update_account-individual-id_number_secondary)
...
error](https://docs.stripe.com/api/tokens#errors) otherwise.
...
conjunction with [Prices](https://docs.stripe.com/api/tokens#prices) to
...
[Products](https://docs.stripe.com/api/tokens#products) help you track inventory
...
[subscriptions](https://docs.stripe.com/api/tokens#subscriptions),
[invoices](https://docs.stripe.com/api/tokens#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/tokens#quotes), and more. Coupons do not
work with conventional one-off
[charges](https://docs.stripe.com/api/tokens#create_charge) or [payment
...
[coupon](https://docs.stripe.com/api/tokens#coupons). It can be used to create
...
[coupon](https://docs.stripe.com/api/tokens#coupons) or [promotion
code](https://docs.stripe.com/api/tokens#promotion_codes). It contains
...
They contain [invoice items](https://docs.stripe.com/api/tokens#invoiceitems),
...
API](https://docs.stripe.com/api/tokens#prices). It replaces the Plans API and
...
of products. [Products](https://docs.stripe.com/api/tokens#products) help you
...
[Payout](https://docs.stripe.com/api/tokens#payout_object) object, with
...
[FinancialAccount’s](https://docs.stripe.com/api/tokens#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/tokens#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/tokens#financial_accounts) to a
PaymentMethod belonging to the same entity. To send funds to a different party,
use [OutboundPayments](https://docs.stripe.com/api/tokens#outbound_payments)
...
[FinancialAccount](https://docs.stripe.com/api/tokens#financial_accounts). To
send money to an account belonging to the same user, use an
[OutboundTransfer](https://docs.stripe.com/api/tokens#outbound_transfers).
...
[FinancialAccount](https://docs.stripe.com/api/tokens#financial_accounts) via a
...
[FinancialAccount](https://docs.stripe.com/api/tokens#financial_accounts) (for
...
[FinancialAccount](https://docs.stripe.com/api/tokens#financial_accounts). These
...
[ReceivedCredits](https://docs.stripe.com/api/tokens#received_credits) depending
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/tokens#received_debits) depending
