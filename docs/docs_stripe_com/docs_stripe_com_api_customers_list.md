...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fcustomers%2Flist)
...
error](https://docs.stripe.com/api/customers/list#errors) if create parameters
are invalid (for example, specifying an invalid coupon or an invalid source).
...
error](https://docs.stripe.com/api/customers/list#errors) if update parameters
...
error](https://docs.stripe.com/api/customers/list#errors).
...
event](https://docs.stripe.com/api/customers/list#retrieve_event) or a [list of
events](https://docs.stripe.com/api/customers/list#list_events) from the API. We
...
API](https://docs.stripe.com/api/customers/list#retrieve_event) for 30 days.
...
with the [create file](https://docs.stripe.com/api/customers/list#create_file)
...
query](https://docs.stripe.com/api/customers/list#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/customers/list#payment_intents) to
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/customers/list#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/customers/list#payment_intent_object-setup_future_usage)
...
conjunction with [Prices](https://docs.stripe.com/api/customers/list#prices) to
...
[Products](https://docs.stripe.com/api/customers/list#products) help you track
...
[subscriptions](https://docs.stripe.com/api/customers/list#subscriptions),
[invoices](https://docs.stripe.com/api/customers/list#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/customers/list#quotes), and more. Coupons
do not work with conventional one-off
[charges](https://docs.stripe.com/api/customers/list#create_charge) or [payment
...
[coupon](https://docs.stripe.com/api/customers/list#coupons). It can be used to
...
[coupon](https://docs.stripe.com/api/customers/list#coupons) or [promotion
code](https://docs.stripe.com/api/customers/list#promotion_codes). It contains
...
items](https://docs.stripe.com/api/customers/list#invoiceitems), and proration
...
API](https://docs.stripe.com/api/customers/list#prices). It replaces the Plans
...
of products. [Products](https://docs.stripe.com/api/customers/list#products)
...
[Payout](https://docs.stripe.com/api/customers/list#payout_object) object, with
...
[FinancialAccount’s](https://docs.stripe.com/api/customers/list#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/customers/list#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/customers/list#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/customers/list#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/customers/list#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/customers/list#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/customers/list#received_debits)
