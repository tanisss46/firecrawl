...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fsetup_attempts%2Fobject)
...
event](https://docs.stripe.com/api/setup_attempts/object#retrieve_event) or a
[list of events](https://docs.stripe.com/api/setup_attempts/object#list_events)
...
API](https://docs.stripe.com/api/setup_attempts/object#retrieve_event) for 30
days.
...
with the [create
file](https://docs.stripe.com/api/setup_attempts/object#create_file) request
...
query](https://docs.stripe.com/api/setup_attempts/object#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/setup_attempts/object#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/setup_attempts/object#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/setup_attempts/object#payment_intent_object-setup_future_usage)
...
conjunction with
[Prices](https://docs.stripe.com/api/setup_attempts/object#prices) to configure
...
[Products](https://docs.stripe.com/api/setup_attempts/object#products) help you
...
[subscriptions](https://docs.stripe.com/api/setup_attempts/object#subscriptions),
[invoices](https://docs.stripe.com/api/setup_attempts/object#invoices),
[checkout sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/setup_attempts/object#quotes), and more.
Coupons do not work with conventional one-off
[charges](https://docs.stripe.com/api/setup_attempts/object#create_charge) or
[payment intents](https://docs.stripe.com/api/payment_intents).
...
[coupon](https://docs.stripe.com/api/setup_attempts/object#coupons). It can be
...
[coupon](https://docs.stripe.com/api/setup_attempts/object#coupons) or
[promotion
code](https://docs.stripe.com/api/setup_attempts/object#promotion_codes). It
...
items](https://docs.stripe.com/api/setup_attempts/object#invoiceitems), and
...
API](https://docs.stripe.com/api/setup_attempts/object#prices). It replaces the
...
[Payout](https://docs.stripe.com/api/setup_attempts/object#payout_object)
...
[FinancialAccount’s](https://docs.stripe.com/api/setup_attempts/object#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/setup_attempts/object#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/setup_attempts/object#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/setup_attempts/object#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/setup_attempts/object#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/setup_attempts/object#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/setup_attempts/object#received_debits)
