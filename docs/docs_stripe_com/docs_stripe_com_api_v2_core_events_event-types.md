...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fv2%2Fcore%2Fevents%2Fevent-types)
...
event](https://docs.stripe.com/api/v2/core/events/event-types#retrieve_event) or
a [list of
events](https://docs.stripe.com/api/v2/core/events/event-types#list_events) from
...
API](https://docs.stripe.com/api/v2/core/events/event-types#retrieve_event) for
30 days.
...
# [Retrieve an Event object](https://docs.stripe.com/api/v2/core/events/retrieve) v2
...
GET /v2/core/events/:idServer-side languageStripe
CLIcURL.NETGoJavaNode.jsPHPPythonRuby
```
curl
...
Response
```
{ "id": "evt_test_65RCjj4EqW1sabcjs2Z16RCMoNQdSQkOWvfL6L5uU2K40u", "object":
"v2.core.event", "context": null, "created": "2024-09-26T17:46:22.134Z", "data":
{ "developer_message_summary": "There is 1 invalid event", "reason": {
"error_count": 1, "error_types": [ { "code": "meter_event_no_customer_defined",
"error_count": 1, "sample_errors": [ { "error_message": "Customer mapping key
stripe_customer_id not found in payload.", "request": { "identifier":
"cb447754-6880-45c2-8f2f-ef19b6ce81e9" } } ] } ] }, "validation_end":
"2024-09-26T17:46:20.000Z", "validation_start": "2024-09-26T17:46:10.000Z" },
"livemode": false, "reason": null, "related_object": { "id":
"mtr_test_61RCjiqdTDC91zgip41IqPCzPnxqqSVc", "type": "billing.meter", "url":
"/v1/billing/meters/mtr_test_61RCjiqdTDC91zgip41IqPCzPnxqqSVc" }, "type":
"v1.billing.meter.error_report_triggered"}
```

# [List all Event objects](https://docs.stripe.com/api/v2/core/events/list) v2
...
GET /v2/core/eventsServer-side languageStripe
CLIcURL.NETGoJavaNode.jsPHPPythonRuby
```
curl -G https://api.stripe.com/v2/core/events \ -H "Authorization: Bearer
{{YOUR_API_KEY}}{{YOUR_API_KEY}}" \ -H "Stripe-Version: 2025-02-24.acacia" \ -d
object_id=mtr_test_61RCjiqdTDC91zgip41IqPCzPnxqqSVc
```

Response
```
{ "data": [ { "id": "evt_test_65RCjj4EqW1sabcjs2Z16RCMoNQdSQkOWvfL6L5uU2K40u",
"object": "v2.core.event", "context": null, "created":
"2024-09-26T17:46:22.134Z", "data": { "developer_message_summary": "There is 1
invalid event", "reason": { "error_count": 1, "error_types": [ { "code":
"meter_event_no_customer_defined", "error_count": 1, "sample_errors": [ {
"error_message": "Customer mapping key stripe_customer_id not found in
payload.", "request": { "identifier": "cb447754-6880-45c2-8f2f-ef19b6ce81e9" } }
] } ] }, "validation_end": "2024-09-26T17:46:20.000Z", "validation_start":
"2024-09-26T17:46:10.000Z" }, "livemode": false, "reason": null,
"related_object": { "id": "mtr_test_61RCjiqdTDC91zgip41IqPCzPnxqqSVc", "type":
"billing.meter", "url":
"/v1/billing/meters/mtr_test_61RCjiqdTDC91zgip41IqPCzPnxqqSVc" }, "type":
"v1.billing.meter.error_report_triggered" } ], "next_page_url": null,
"previous_page_url": null}
```

# [Types of events](https://docs.stripe.com/api/v2/core/events/event-types)
...
with the [create
file](https://docs.stripe.com/api/v2/core/events/event-types#create_file)
...
query](https://docs.stripe.com/api/v2/core/events/event-types#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/v2/core/events/event-types#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/v2/core/events/event-types#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/v2/core/events/event-types#payment_intent_object-setup_future_usage)
...
conjunction with
[Prices](https://docs.stripe.com/api/v2/core/events/event-types#prices) to
...
[Products](https://docs.stripe.com/api/v2/core/events/event-types#products) help
...
[subscriptions](https://docs.stripe.com/api/v2/core/events/event-types#subscriptions),
[invoices](https://docs.stripe.com/api/v2/core/events/event-types#invoices),
[checkout sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/v2/core/events/event-types#quotes), and
more. Coupons do not work with conventional one-off
[charges](https://docs.stripe.com/api/v2/core/events/event-types#create_charge)
...
[coupon](https://docs.stripe.com/api/v2/core/events/event-types#coupons). It can
...
[coupon](https://docs.stripe.com/api/v2/core/events/event-types#coupons) or
[promotion
code](https://docs.stripe.com/api/v2/core/events/event-types#promotion_codes).
...
items](https://docs.stripe.com/api/v2/core/events/event-types#invoiceitems), and
...
API](https://docs.stripe.com/api/v2/core/events/event-types#prices). It replaces
...
[Payout](https://docs.stripe.com/api/v2/core/events/event-types#payout_object)
...
[FinancialAccount’s](https://docs.stripe.com/api/v2/core/events/event-types#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/v2/core/events/event-types#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/v2/core/events/event-types#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/v2/core/events/event-types#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/v2/core/events/event-types#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/v2/core/events/event-types#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/v2/core/events/event-types#received_debits)
