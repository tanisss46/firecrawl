...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fevents)
...
event](https://docs.stripe.com/api/events#retrieve_event) or a [list of
events](https://docs.stripe.com/api/events#list_events) from the API. We also
have a separate [webhooks](http://en.wikipedia.org/wiki/Webhook) system for
...
(e.g., [card](https://docs.stripe.com/api/events#account_card_object) or [bank
account](https://docs.stripe.com/api/events#account_bank_account_object))
...
an[account](https://docs.stripe.com/api/events#account_object)

Occurs whenever an account status or property has changed.
- #### application_fee.created`data.object` is an[application
fee](https://docs.stripe.com/api/events#application_fee_object)

Occurs whenever an application fee is created on a charge.
- #### application_fee.refund.updated`data.object` is a[fee
refund](https://docs.stripe.com/api/events#fee_refund_object)
...
directly](https://docs.stripe.com/api/events#fee_refunds). This includes partial
refunds.
- #### balance.available`data.object` is
a[balance](https://docs.stripe.com/api/events#balance_object)
...
configuration](https://docs.stripe.com/api/events#portal_configuration_object)
...
session](https://docs.stripe.com/api/events#portal_session_object)
...
a[capability](https://docs.stripe.com/api/events#capability_object)

Occurs whenever a capability has new requirements or a new status.
- #### cash_balance.funds_available`data.object` is a[cash
balance](https://docs.stripe.com/api/events#cash_balance_object)
...
a[charge](https://docs.stripe.com/api/events#charge_object)

Occurs whenever a previously uncaptured charge is captured.
- #### charge.dispute.closed`data.object` is
a[dispute](https://docs.stripe.com/api/events#dispute_object)
...
a[refund](https://docs.stripe.com/api/events#refund_object)
...
session](https://docs.stripe.com/api/events#checkout_session_object)
...
order](https://docs.stripe.com/api/events#climate_order_object)
...
product](https://docs.stripe.com/api/events#climate_product_object)
...
a[coupon](https://docs.stripe.com/api/events#coupon_object)
...
note](https://docs.stripe.com/api/events#credit_note_object)
...
balance
transaction](https://docs.stripe.com/api/events#customer_cash_balance_transaction_object)

Occurs whenever a new customer cash balance transactions is created.
- #### customer.created`data.object` is
a[customer](https://docs.stripe.com/api/events#customer_object)
...
a[discount](https://docs.stripe.com/api/events#discount_object)
...
[card](https://docs.stripe.com/api/events#account_card_object))
...
a[subscription](https://docs.stripe.com/api/events#subscription_object)
...
id](https://docs.stripe.com/api/events#tax_id_object)
...
a[file](https://docs.stripe.com/api/events#file_object)

Occurs whenever a new Stripe-generated file is available for your account.
- #### financial_connections.account.created`data.object` is a[financial
connections
account](https://docs.stripe.com/api/events#financial_connections_account_object)
...
verification
session](https://docs.stripe.com/api/events#identity_verification_session_object)
...
verification
session](https://docs.stripe.com/api/events#identity_verification_session_object)Selection
required
...
an[invoice](https://docs.stripe.com/api/events#invoice_object)
...
an[invoiceitem](https://docs.stripe.com/api/events#invoiceitem_object)
...
authorization](https://docs.stripe.com/api/events#issuing_authorization_object)

Occurs whenever an authorization is created.
- #### issuing_authorization.request`data.object` is an[issuing
authorization](https://docs.stripe.com/api/events#issuing_authorization_object)Selection
required
...
card](https://docs.stripe.com/api/events#issuing_card_object)
...
cardholder](https://docs.stripe.com/api/events#issuing_cardholder_object)
...
dispute](https://docs.stripe.com/api/events#issuing_dispute_object)
...
personalization
design](https://docs.stripe.com/api/events#issuing_personalization_design_object)
...
token](https://docs.stripe.com/api/events#issuing_token_object)
...
transaction](https://docs.stripe.com/api/events#issuing_transaction_object)
...
a[mandate](https://docs.stripe.com/api/events#mandate_object)

Occurs whenever a Mandate is updated.
- #### payment_intent.amount_capturable_updated`data.object` is a[payment
intent](https://docs.stripe.com/api/events#payment_intent_object)
...
link](https://docs.stripe.com/api/events#payment_link_object)
...
method](https://docs.stripe.com/api/events#payment_method_object)
...
a[payout](https://docs.stripe.com/api/events#payout_object)
...
a[person](https://docs.stripe.com/api/events#person_object)
...
a[plan](https://docs.stripe.com/api/events#plan_object)
...
a[price](https://docs.stripe.com/api/events#price_object)
...
a[product](https://docs.stripe.com/api/events#product_object)
...
code](https://docs.stripe.com/api/events#promotion_code_object)
...
a[quote](https://docs.stripe.com/api/events#quote_object)
...
warning](https://docs.stripe.com/api/events#early_fraud_warning_object)
...
run](https://docs.stripe.com/api/events#reporting_report_run_object)
...
type](https://docs.stripe.com/api/events#reporting_report_type_object)Selection
required
...
a[review](https://docs.stripe.com/api/events#review_object)
...
intent](https://docs.stripe.com/api/events#setup_intent_object)
...
run](https://docs.stripe.com/api/events#scheduled_query_run_object)
...
schedule](https://docs.stripe.com/api/events#subscription_schedule_object)
...
rate](https://docs.stripe.com/api/events#tax_rate_object)
...
settings](https://docs.stripe.com/api/events#tax_settings_object)

Occurs whenever tax settings is updated.
- #### terminal.reader.action_failed`data.object` is a[terminal
reader](https://docs.stripe.com/api/events#terminal_reader_object)
...
clock](https://docs.stripe.com/api/events#test_clock_object)
...
test clock](https://docs.stripe.com/api/events#test_clock_object)
...
a[topup](https://docs.stripe.com/api/events#topup_object)
...
a[transfer](https://docs.stripe.com/api/events#transfer_object)
...
with the [create file](https://docs.stripe.com/api/events#create_file) request
...
query](https://docs.stripe.com/api/events#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/events#payment_intents) to drive
the payment flow.
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/events#setup_intent_object-customer), it
...
[setup_future_usage](https://docs.stripe.com/api/events#payment_intent_object-setup_future_usage)
...
conjunction with [Prices](https://docs.stripe.com/api/events#prices) to
...
[Products](https://docs.stripe.com/api/events#products) help you track inventory
...
[subscriptions](https://docs.stripe.com/api/events#subscriptions),
[invoices](https://docs.stripe.com/api/events#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/events#quotes), and more. Coupons do not
work with conventional one-off
[charges](https://docs.stripe.com/api/events#create_charge) or [payment
...
[coupon](https://docs.stripe.com/api/events#coupons). It can be used to create
...
[coupon](https://docs.stripe.com/api/events#coupons) or [promotion
code](https://docs.stripe.com/api/events#promotion_codes). It contains
...
They contain [invoice items](https://docs.stripe.com/api/events#invoiceitems),
and proration adjustments that may be caused by subscription upgrades/downgrades
(if necessary).
...
API](https://docs.stripe.com/api/events#prices). It replaces the Plans API and
...
of products. [Products](https://docs.stripe.com/api/events#products) help you
...
[Payout](https://docs.stripe.com/api/events#payout_object) object, with
...
[FinancialAccount’s](https://docs.stripe.com/api/events#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/events#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/events#financial_accounts) to a
PaymentMethod belonging to the same entity. To send funds to a different party,
use [OutboundPayments](https://docs.stripe.com/api/events#outbound_payments)
...
[FinancialAccount](https://docs.stripe.com/api/events#financial_accounts). To
send money to an account belonging to the same user, use an
[OutboundTransfer](https://docs.stripe.com/api/events#outbound_transfers).
...
[FinancialAccount](https://docs.stripe.com/api/events#financial_accounts) via a
...
[FinancialAccount](https://docs.stripe.com/api/events#financial_accounts) (for
...
[FinancialAccount](https://docs.stripe.com/api/events#financial_accounts). These
...
[ReceivedCredits](https://docs.stripe.com/api/events#received_credits) depending
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/events#received_debits) depending
