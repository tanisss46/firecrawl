...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fcharges%2Fsearch)
...
error](https://docs.stripe.com/api/charges/search#errors) if something goes
wrong. A common source of error is an invalid or expired card, or a valid card
with insufficient available balance.
...
error](https://docs.stripe.com/api/charges/search#errors) if update parameters
are invalid.
...
error](https://docs.stripe.com/api/charges/search#errors) otherwise.
...
error](https://docs.stripe.com/api/charges/search#errors).
...
method will raise [an error](https://docs.stripe.com/api/charges/search#errors).
...
event](https://docs.stripe.com/api/charges/search#retrieve_event) or a [list of
events](https://docs.stripe.com/api/charges/search#list_events) from the API. We
...
API](https://docs.stripe.com/api/charges/search#retrieve_event) for 30 days.
...
with the [create file](https://docs.stripe.com/api/charges/search#create_file)
...
query](https://docs.stripe.com/api/charges/search#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/charges/search#payment_intents) to
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/charges/search#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/charges/search#payment_intent_object-setup_future_usage)
...
conjunction with [Prices](https://docs.stripe.com/api/charges/search#prices) to
...
[Products](https://docs.stripe.com/api/charges/search#products) help you track
...
[subscriptions](https://docs.stripe.com/api/charges/search#subscriptions),
[invoices](https://docs.stripe.com/api/charges/search#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/charges/search#quotes), and more. Coupons
do not work with conventional one-off
[charges](https://docs.stripe.com/api/charges/search#create_charge) or [payment
...
[coupon](https://docs.stripe.com/api/charges/search#coupons). It can be used to
...
[coupon](https://docs.stripe.com/api/charges/search#coupons) or [promotion
code](https://docs.stripe.com/api/charges/search#promotion_codes). It contains
...
items](https://docs.stripe.com/api/charges/search#invoiceitems), and proration
...
API](https://docs.stripe.com/api/charges/search#prices). It replaces the Plans
...
of products. [Products](https://docs.stripe.com/api/charges/search#products)
...
[Payout](https://docs.stripe.com/api/charges/search#payout_object) object, with
...
[FinancialAccount’s](https://docs.stripe.com/api/charges/search#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/charges/search#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/charges/search#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/charges/search#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/charges/search#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/charges/search#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/charges/search#received_debits)
