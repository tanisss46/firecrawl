...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fpayment_intents%2Fverify_microdeposits)
...
event](https://docs.stripe.com/api/payment_intents/verify_microdeposits#retrieve_event)
or a [list of
events](https://docs.stripe.com/api/payment_intents/verify_microdeposits#list_events)
...
API](https://docs.stripe.com/api/payment_intents/verify_microdeposits#retrieve_event)
for 30 days.
...
with the [create
file](https://docs.stripe.com/api/payment_intents/verify_microdeposits#create_file)
...
query](https://docs.stripe.com/api/payment_intents/verify_microdeposits#scheduled_queries)).
...
If
[setup_future_usage](https://docs.stripe.com/api/payment_intents/verify_microdeposits#payment_intent_object-setup_future_usage)
...
intent](https://docs.stripe.com/api/payment_intents/verify_microdeposits#payment_intent_object)
...
[client_secret](https://docs.stripe.com/api/payment_intents/verify_microdeposits#payment_intent_object-client_secret).
...
[PaymentIntents](https://docs.stripe.com/api/payment_intents/verify_microdeposits#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/payment_intents/verify_microdeposits#setup_intent_object-customer),
...
conjunction with
[Prices](https://docs.stripe.com/api/payment_intents/verify_microdeposits#prices)
...
[Products](https://docs.stripe.com/api/payment_intents/verify_microdeposits#products)
...
[subscriptions](https://docs.stripe.com/api/payment_intents/verify_microdeposits#subscriptions),
[invoices](https://docs.stripe.com/api/payment_intents/verify_microdeposits#invoices),
[checkout sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/payment_intents/verify_microdeposits#quotes),
and more. Coupons do not work with conventional one-off
[charges](https://docs.stripe.com/api/payment_intents/verify_microdeposits#create_charge)
...
[coupon](https://docs.stripe.com/api/payment_intents/verify_microdeposits#coupons).
...
[coupon](https://docs.stripe.com/api/payment_intents/verify_microdeposits#coupons)
or [promotion
code](https://docs.stripe.com/api/payment_intents/verify_microdeposits#promotion_codes).
...
items](https://docs.stripe.com/api/payment_intents/verify_microdeposits#invoiceitems),
...
API](https://docs.stripe.com/api/payment_intents/verify_microdeposits#prices).
...
[Payout](https://docs.stripe.com/api/payment_intents/verify_microdeposits#payout_object)
...
[FinancialAccount’s](https://docs.stripe.com/api/payment_intents/verify_microdeposits#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/payment_intents/verify_microdeposits#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/payment_intents/verify_microdeposits#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/payment_intents/verify_microdeposits#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/payment_intents/verify_microdeposits#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/payment_intents/verify_microdeposits#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/payment_intents/verify_microdeposits#received_debits)
