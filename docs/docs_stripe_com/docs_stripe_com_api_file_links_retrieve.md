...
[FinancialAccount’s](https://docs.stripe.com/api/file_links/retrieve#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/file_links/retrieve#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/file_links/retrieve#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/file_links/retrieve#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/file_links/retrieve#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/file_links/retrieve#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/file_links/retrieve#received_debits)
