# Collect tax in Luxembourg

## Learn how to use Stripe Tax to calculate, collect, and report tax in Luxembourg.

Luxembourg is part of the EU and applies the EU VAT rules. Read more about those
...
about your potential tax registration obligations in Luxembourg. Stripe also
notifies you with email and Dashboard alerts when you need to register to
collect tax. Learn more about how the [monitoring tool
works](https://docs.stripe.com/tax/monitoring).

You can read more about registration obligations in Luxembourg on the [European
...
registration](https://guichet.public.lu/en/entreprises/creation-developpement/declarations-initiales/tva-impots/inscription-tva.html)
- [One-Stop Shop registration
schemes](https://pfi.public.lu/fr/professionnel/tva/oss/ossuk.html)

After you’ve registered to collect tax in Luxembourg, go to
[Registrations](https://dashboard.stripe.com/tax/registrations?location=lu) to
add your registrations to Stripe in the Dashboard. This turns on tax calculation
and collection in Stripe for your transactions in Luxembourg.
...
Luxembourg applies the EU VAT rules. Learn more about [tax calculation in the
...
- [One-Stop Shop registration
schemes](https://pfi.public.lu/fr/professionnel/tva/oss/ossuk.html)
- [Registrations](https://dashboard.stripe.com/tax/registrations?location=lu)
- [how to add your
registration](https://docs.stripe.com/tax/registering#track-your-registrations-in-the-tax-dashboard)
