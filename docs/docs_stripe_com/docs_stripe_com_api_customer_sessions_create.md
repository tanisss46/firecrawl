...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fcustomer_sessions%2Fcreate)
...
The client secret of this Customer Session. Used on the client to set up secure
access to the given `customer`.

The client secret can be used to provide access to `customer` from your
frontend. It should not be stored, logged, or exposed to anyone other than the
relevant customer. Make sure that you have TLS enabled on any page that includes
the client secret.
- #### componentsobject
...
```
{ "object": "customer_session", "client_secret":
"_POpxYpmkXdtttYtZQYhrsOJZ2RCQ9kCqqXRU6qrP5c4Jgje", "components": {
"buy_button": { "enabled": false }, "pricing_table": { "enabled": true } },
"customer": "cus_PO34b57IOUb83c", "expires_at": 1684790027, "livemode": false}
```
...
POST /v1/customer_sessionsServer-side languageStripe
CLIcURL.NETGoJavaNode.jsPHPPythonRuby
```
curl https://api.stripe.com/v1/customer_sessions \ -u
"sk_test_BQokikJ...2HlWgH4olfQ2sk_test_BQokikJOvBiI2HlWgH4olfQ2:" \ -d
customer=cus_PO34b57IOUb83c \ -d "components[pricing_table][enabled]"=true
```
...
event](https://docs.stripe.com/api/customer_sessions/create#retrieve_event) or a
[list of
events](https://docs.stripe.com/api/customer_sessions/create#list_events) from
...
API](https://docs.stripe.com/api/customer_sessions/create#retrieve_event) for 30
days.
...
with the [create
file](https://docs.stripe.com/api/customer_sessions/create#create_file) request
...
query](https://docs.stripe.com/api/customer_sessions/create#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/customer_sessions/create#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/customer_sessions/create#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/customer_sessions/create#payment_intent_object-setup_future_usage)
...
conjunction with
[Prices](https://docs.stripe.com/api/customer_sessions/create#prices) to
...
[Products](https://docs.stripe.com/api/customer_sessions/create#products) help
...
[subscriptions](https://docs.stripe.com/api/customer_sessions/create#subscriptions),
[invoices](https://docs.stripe.com/api/customer_sessions/create#invoices),
[checkout sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/customer_sessions/create#quotes), and more.
Coupons do not work with conventional one-off
[charges](https://docs.stripe.com/api/customer_sessions/create#create_charge) or
[payment intents](https://docs.stripe.com/api/payment_intents).
...
[coupon](https://docs.stripe.com/api/customer_sessions/create#coupons). It can
...
[coupon](https://docs.stripe.com/api/customer_sessions/create#coupons) or
[promotion
code](https://docs.stripe.com/api/customer_sessions/create#promotion_codes). It
...
items](https://docs.stripe.com/api/customer_sessions/create#invoiceitems), and
...
API](https://docs.stripe.com/api/customer_sessions/create#prices). It replaces
...
[Payout](https://docs.stripe.com/api/customer_sessions/create#payout_object)
...
[FinancialAccount’s](https://docs.stripe.com/api/customer_sessions/create#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/customer_sessions/create#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/customer_sessions/create#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/customer_sessions/create#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/customer_sessions/create#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/customer_sessions/create#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/customer_sessions/create#received_debits)
...
object](https://docs.stripe.com/api/customer_sessions/object)
- [Disputes](https://docs.stripe.com/api/disputes)
