...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fauthentication)
...
event](https://docs.stripe.com/api/authentication#retrieve_event) or a [list of
events](https://docs.stripe.com/api/authentication#list_events) from the API. We
...
API](https://docs.stripe.com/api/authentication#retrieve_event) for 30 days.
...
with the [create file](https://docs.stripe.com/api/authentication#create_file)
...
query](https://docs.stripe.com/api/authentication#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/authentication#payment_intents) to
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/authentication#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/authentication#payment_intent_object-setup_future_usage)
...
conjunction with [Prices](https://docs.stripe.com/api/authentication#prices) to
...
[Products](https://docs.stripe.com/api/authentication#products) help you track
...
[subscriptions](https://docs.stripe.com/api/authentication#subscriptions),
[invoices](https://docs.stripe.com/api/authentication#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/authentication#quotes), and more. Coupons
do not work with conventional one-off
[charges](https://docs.stripe.com/api/authentication#create_charge) or [payment
...
[coupon](https://docs.stripe.com/api/authentication#coupons). It can be used to
...
[coupon](https://docs.stripe.com/api/authentication#coupons) or [promotion
code](https://docs.stripe.com/api/authentication#promotion_codes). It contains
...
items](https://docs.stripe.com/api/authentication#invoiceitems), and proration
...
API](https://docs.stripe.com/api/authentication#prices). It replaces the Plans
...
of products. [Products](https://docs.stripe.com/api/authentication#products)
...
[Payout](https://docs.stripe.com/api/authentication#payout_object) object, with
...
[FinancialAccount’s](https://docs.stripe.com/api/authentication#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/authentication#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/authentication#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/authentication#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/authentication#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/authentication#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/authentication#received_debits)
