...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Ffile_links%2Fcreate)
...
event](https://docs.stripe.com/api/file_links/create#retrieve_event) or a [list
of events](https://docs.stripe.com/api/file_links/create#list_events) from the
...
API](https://docs.stripe.com/api/file_links/create#retrieve_event) for 30 days.
...
with the [create
file](https://docs.stripe.com/api/file_links/create#create_file) request (for
...
query](https://docs.stripe.com/api/file_links/create#scheduled_queries)).
...
error](https://docs.stripe.com/api/file_links/create#errors) otherwise.
...
Stripe raises [an error](https://docs.stripe.com/api/file_links/create#errors).
...
[PaymentIntents](https://docs.stripe.com/api/file_links/create#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/file_links/create#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/file_links/create#payment_intent_object-setup_future_usage)
...
conjunction with [Prices](https://docs.stripe.com/api/file_links/create#prices)
...
[Products](https://docs.stripe.com/api/file_links/create#products) help you
...
[subscriptions](https://docs.stripe.com/api/file_links/create#subscriptions),
[invoices](https://docs.stripe.com/api/file_links/create#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/file_links/create#quotes), and more.
Coupons do not work with conventional one-off
[charges](https://docs.stripe.com/api/file_links/create#create_charge) or
[payment intents](https://docs.stripe.com/api/payment_intents).
...
[coupon](https://docs.stripe.com/api/file_links/create#coupons). It can be used
...
[coupon](https://docs.stripe.com/api/file_links/create#coupons) or [promotion
code](https://docs.stripe.com/api/file_links/create#promotion_codes). It
...
items](https://docs.stripe.com/api/file_links/create#invoiceitems), and
...
API](https://docs.stripe.com/api/file_links/create#prices). It replaces the
...
of products. [Products](https://docs.stripe.com/api/file_links/create#products)
...
[Payout](https://docs.stripe.com/api/file_links/create#payout_object) object,
...
[FinancialAccount’s](https://docs.stripe.com/api/file_links/create#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/file_links/create#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/file_links/create#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/file_links/create#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/file_links/create#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/file_links/create#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/file_links/create#received_debits)
