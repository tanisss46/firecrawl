...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fmandates%2Fretrieve)
...
event](https://docs.stripe.com/api/mandates/retrieve#retrieve_event) or a [list
of events](https://docs.stripe.com/api/mandates/retrieve#list_events) from the
...
API](https://docs.stripe.com/api/mandates/retrieve#retrieve_event) for 30 days.
...
with the [create
file](https://docs.stripe.com/api/mandates/retrieve#create_file) request (for
...
query](https://docs.stripe.com/api/mandates/retrieve#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/mandates/retrieve#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/mandates/retrieve#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/mandates/retrieve#payment_intent_object-setup_future_usage)
...
conjunction with [Prices](https://docs.stripe.com/api/mandates/retrieve#prices)
...
[Products](https://docs.stripe.com/api/mandates/retrieve#products) help you
...
[subscriptions](https://docs.stripe.com/api/mandates/retrieve#subscriptions),
[invoices](https://docs.stripe.com/api/mandates/retrieve#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/mandates/retrieve#quotes), and more.
Coupons do not work with conventional one-off
[charges](https://docs.stripe.com/api/mandates/retrieve#create_charge) or
[payment intents](https://docs.stripe.com/api/payment_intents).
...
[coupon](https://docs.stripe.com/api/mandates/retrieve#coupons). It can be used
...
[coupon](https://docs.stripe.com/api/mandates/retrieve#coupons) or [promotion
code](https://docs.stripe.com/api/mandates/retrieve#promotion_codes). It
...
items](https://docs.stripe.com/api/mandates/retrieve#invoiceitems), and
...
API](https://docs.stripe.com/api/mandates/retrieve#prices). It replaces the
...
of products. [Products](https://docs.stripe.com/api/mandates/retrieve#products)
...
[Payout](https://docs.stripe.com/api/mandates/retrieve#payout_object) object,
...
[FinancialAccount’s](https://docs.stripe.com/api/mandates/retrieve#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/mandates/retrieve#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/mandates/retrieve#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/mandates/retrieve#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/mandates/retrieve#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/mandates/retrieve#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/mandates/retrieve#received_debits)
