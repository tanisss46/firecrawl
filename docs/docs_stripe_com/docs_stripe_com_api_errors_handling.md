...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Ferrors%2Fhandling)
...
event](https://docs.stripe.com/api/errors/handling#retrieve_event) or a [list of
events](https://docs.stripe.com/api/errors/handling#list_events) from the API.
...
API](https://docs.stripe.com/api/errors/handling#retrieve_event) for 30 days.
...
with the [create file](https://docs.stripe.com/api/errors/handling#create_file)
...
query](https://docs.stripe.com/api/errors/handling#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/errors/handling#payment_intents) to
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/errors/handling#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/errors/handling#payment_intent_object-setup_future_usage)
...
conjunction with [Prices](https://docs.stripe.com/api/errors/handling#prices) to
...
[Products](https://docs.stripe.com/api/errors/handling#products) help you track
...
[subscriptions](https://docs.stripe.com/api/errors/handling#subscriptions),
[invoices](https://docs.stripe.com/api/errors/handling#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/errors/handling#quotes), and more. Coupons
do not work with conventional one-off
[charges](https://docs.stripe.com/api/errors/handling#create_charge) or [payment
...
[coupon](https://docs.stripe.com/api/errors/handling#coupons). It can be used to
...
[coupon](https://docs.stripe.com/api/errors/handling#coupons) or [promotion
code](https://docs.stripe.com/api/errors/handling#promotion_codes). It contains
...
items](https://docs.stripe.com/api/errors/handling#invoiceitems), and proration
...
API](https://docs.stripe.com/api/errors/handling#prices). It replaces the Plans
...
of products. [Products](https://docs.stripe.com/api/errors/handling#products)
...
[Payout](https://docs.stripe.com/api/errors/handling#payout_object) object, with
...
[FinancialAccount’s](https://docs.stripe.com/api/errors/handling#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/errors/handling#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/errors/handling#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/errors/handling#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/errors/handling#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/errors/handling#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/errors/handling#received_debits)
