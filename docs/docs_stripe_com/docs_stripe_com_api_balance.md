...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fbalance)
...
API](https://docs.stripe.com/api/balance#transfers) or [Payouts
API](https://docs.stripe.com/api/balance#payouts). You can find the available
...
event](https://docs.stripe.com/api/balance#retrieve_event) or a [list of
events](https://docs.stripe.com/api/balance#list_events) from the API. We also
...
API](https://docs.stripe.com/api/balance#retrieve_event) for 30 days.
...
with the [create file](https://docs.stripe.com/api/balance#create_file) request
...
query](https://docs.stripe.com/api/balance#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/balance#payment_intents) to drive
the payment flow.
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/balance#setup_intent_object-customer), it
...
[setup_future_usage](https://docs.stripe.com/api/balance#payment_intent_object-setup_future_usage)
...
conjunction with [Prices](https://docs.stripe.com/api/balance#prices) to
...
[Products](https://docs.stripe.com/api/balance#products) help you track
...
[subscriptions](https://docs.stripe.com/api/balance#subscriptions),
[invoices](https://docs.stripe.com/api/balance#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/balance#quotes), and more. Coupons do not
work with conventional one-off
[charges](https://docs.stripe.com/api/balance#create_charge) or [payment
...
[coupon](https://docs.stripe.com/api/balance#coupons). It can be used to create
...
[coupon](https://docs.stripe.com/api/balance#coupons) or [promotion
code](https://docs.stripe.com/api/balance#promotion_codes). It contains
...
They contain [invoice items](https://docs.stripe.com/api/balance#invoiceitems),
...
API](https://docs.stripe.com/api/balance#prices). It replaces the Plans API and
...
of products. [Products](https://docs.stripe.com/api/balance#products) help you
...
[Payout](https://docs.stripe.com/api/balance#payout_object) object, with
...
[FinancialAccount’s](https://docs.stripe.com/api/balance#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/balance#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/balance#financial_accounts) to a
PaymentMethod belonging to the same entity. To send funds to a different party,
use [OutboundPayments](https://docs.stripe.com/api/balance#outbound_payments)
...
[FinancialAccount](https://docs.stripe.com/api/balance#financial_accounts). To
send money to an account belonging to the same user, use an
[OutboundTransfer](https://docs.stripe.com/api/balance#outbound_transfers).
...
[FinancialAccount](https://docs.stripe.com/api/balance#financial_accounts) via a
...
[FinancialAccount](https://docs.stripe.com/api/balance#financial_accounts) (for
...
[FinancialAccount](https://docs.stripe.com/api/balance#financial_accounts).
...
[ReceivedCredits](https://docs.stripe.com/api/balance#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/balance#received_debits) depending
