...
[Products](https://docs.stripe.com/api/payment_intents#products) help you track
...
[subscriptions](https://docs.stripe.com/api/payment_intents#subscriptions),
[invoices](https://docs.stripe.com/api/payment_intents#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/payment_intents#quotes), and more. Coupons
do not work with conventional one-off
[charges](https://docs.stripe.com/api/payment_intents#create_charge) or [payment
...
[coupon](https://docs.stripe.com/api/payment_intents#coupons). It can be used to
...
[coupon](https://docs.stripe.com/api/payment_intents#coupons) or [promotion
code](https://docs.stripe.com/api/payment_intents#promotion_codes). It contains
...
items](https://docs.stripe.com/api/payment_intents#invoiceitems), and proration
...
API](https://docs.stripe.com/api/payment_intents#prices). It replaces the Plans
...
of products. [Products](https://docs.stripe.com/api/payment_intents#products)
...
[Payout](https://docs.stripe.com/api/payment_intents#payout_object) object, with
...
[FinancialAccount’s](https://docs.stripe.com/api/payment_intents#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/payment_intents#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/payment_intents#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/payment_intents#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/payment_intents#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/payment_intents#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/payment_intents#received_debits)
