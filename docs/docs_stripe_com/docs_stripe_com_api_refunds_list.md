...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Frefunds%2Flist)
...
event](https://docs.stripe.com/api/refunds/list#retrieve_event) or a [list of
events](https://docs.stripe.com/api/refunds/list#list_events) from the API. We
...
API](https://docs.stripe.com/api/refunds/list#retrieve_event) for 30 days.
...
with the [create file](https://docs.stripe.com/api/refunds/list#create_file)
...
query](https://docs.stripe.com/api/refunds/list#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/refunds/list#payment_intents) to
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/refunds/list#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/refunds/list#payment_intent_object-setup_future_usage)
...
error](https://docs.stripe.com/api/refunds/list#errors) if the
...
error](https://docs.stripe.com/api/refunds/list#errors) if update parameters are
invalid.
...
error](https://docs.stripe.com/api/refunds/list#errors) otherwise.
...
error](https://docs.stripe.com/api/refunds/list#errors).
...
error](https://docs.stripe.com/api/refunds/list#errors) if you can’t cancel the
refund.
...
conjunction with [Prices](https://docs.stripe.com/api/refunds/list#prices) to
...
[Products](https://docs.stripe.com/api/refunds/list#products) help you track
...
[subscriptions](https://docs.stripe.com/api/refunds/list#subscriptions),
[invoices](https://docs.stripe.com/api/refunds/list#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/refunds/list#quotes), and more. Coupons do
not work with conventional one-off
[charges](https://docs.stripe.com/api/refunds/list#create_charge) or [payment
...
[coupon](https://docs.stripe.com/api/refunds/list#coupons). It can be used to
...
[coupon](https://docs.stripe.com/api/refunds/list#coupons) or [promotion
code](https://docs.stripe.com/api/refunds/list#promotion_codes). It contains
...
items](https://docs.stripe.com/api/refunds/list#invoiceitems), and proration
...
API](https://docs.stripe.com/api/refunds/list#prices). It replaces the Plans API
...
of products. [Products](https://docs.stripe.com/api/refunds/list#products) help
...
[Payout](https://docs.stripe.com/api/refunds/list#payout_object) object, with
...
[FinancialAccount’s](https://docs.stripe.com/api/refunds/list#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/refunds/list#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/refunds/list#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/refunds/list#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/refunds/list#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/refunds/list#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/refunds/list#received_debits)
