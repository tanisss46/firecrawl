...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fevents%2Ftypes)
...
event](https://docs.stripe.com/api/events/types#retrieve_event) or a [list of
events](https://docs.stripe.com/api/events/types#list_events) from the API. We
...
API](https://docs.stripe.com/api/events/types#retrieve_event) for 30 days.
...
(e.g., [card](https://docs.stripe.com/api/events/types#account_card_object) or
[bank
account](https://docs.stripe.com/api/events/types#account_bank_account_object))
...
an[account](https://docs.stripe.com/api/events/types#account_object)

Occurs whenever an account status or property has changed.
- #### application_fee.created`data.object` is an[application
fee](https://docs.stripe.com/api/events/types#application_fee_object)

Occurs whenever an application fee is created on a charge.
- #### application_fee.refund.updated`data.object` is a[fee
refund](https://docs.stripe.com/api/events/types#fee_refund_object)
...
directly](https://docs.stripe.com/api/events/types#fee_refunds). This includes
partial refunds.
- #### balance.available`data.object` is
a[balance](https://docs.stripe.com/api/events/types#balance_object)
...
configuration](https://docs.stripe.com/api/events/types#portal_configuration_object)
...
session](https://docs.stripe.com/api/events/types#portal_session_object)
...
a[capability](https://docs.stripe.com/api/events/types#capability_object)

Occurs whenever a capability has new requirements or a new status.
- #### cash_balance.funds_available`data.object` is a[cash
balance](https://docs.stripe.com/api/events/types#cash_balance_object)
...
a[charge](https://docs.stripe.com/api/events/types#charge_object)

Occurs whenever a previously uncaptured charge is captured.
- #### charge.dispute.closed`data.object` is
a[dispute](https://docs.stripe.com/api/events/types#dispute_object)
...
a[refund](https://docs.stripe.com/api/events/types#refund_object)
...
session](https://docs.stripe.com/api/events/types#checkout_session_object)
...
order](https://docs.stripe.com/api/events/types#climate_order_object)
...
product](https://docs.stripe.com/api/events/types#climate_product_object)
...
a[coupon](https://docs.stripe.com/api/events/types#coupon_object)
...
note](https://docs.stripe.com/api/events/types#credit_note_object)
...
balance
transaction](https://docs.stripe.com/api/events/types#customer_cash_balance_transaction_object)

Occurs whenever a new customer cash balance transactions is created.
- #### customer.created`data.object` is
a[customer](https://docs.stripe.com/api/events/types#customer_object)
...
a[discount](https://docs.stripe.com/api/events/types#discount_object)
...
[card](https://docs.stripe.com/api/events/types#account_card_object))
...
a[subscription](https://docs.stripe.com/api/events/types#subscription_object)
...
id](https://docs.stripe.com/api/events/types#tax_id_object)
...
a[file](https://docs.stripe.com/api/events/types#file_object)

Occurs whenever a new Stripe-generated file is available for your account.
- #### financial_connections.account.created`data.object` is a[financial
connections
account](https://docs.stripe.com/api/events/types#financial_connections_account_object)
...
verification
session](https://docs.stripe.com/api/events/types#identity_verification_session_object)
...
verification
session](https://docs.stripe.com/api/events/types#identity_verification_session_object)Selection
required
...
an[invoice](https://docs.stripe.com/api/events/types#invoice_object)
...
an[invoiceitem](https://docs.stripe.com/api/events/types#invoiceitem_object)
...
authorization](https://docs.stripe.com/api/events/types#issuing_authorization_object)

Occurs whenever an authorization is created.
- #### issuing_authorization.request`data.object` is an[issuing
authorization](https://docs.stripe.com/api/events/types#issuing_authorization_object)Selection
required
...
card](https://docs.stripe.com/api/events/types#issuing_card_object)
...
cardholder](https://docs.stripe.com/api/events/types#issuing_cardholder_object)
...
dispute](https://docs.stripe.com/api/events/types#issuing_dispute_object)
...
personalization
design](https://docs.stripe.com/api/events/types#issuing_personalization_design_object)
...
token](https://docs.stripe.com/api/events/types#issuing_token_object)
...
transaction](https://docs.stripe.com/api/events/types#issuing_transaction_object)
...
a[mandate](https://docs.stripe.com/api/events/types#mandate_object)

Occurs whenever a Mandate is updated.
- #### payment_intent.amount_capturable_updated`data.object` is a[payment
intent](https://docs.stripe.com/api/events/types#payment_intent_object)
...
link](https://docs.stripe.com/api/events/types#payment_link_object)
...
method](https://docs.stripe.com/api/events/types#payment_method_object)
...
a[payout](https://docs.stripe.com/api/events/types#payout_object)
...
a[person](https://docs.stripe.com/api/events/types#person_object)
...
a[plan](https://docs.stripe.com/api/events/types#plan_object)
...
a[price](https://docs.stripe.com/api/events/types#price_object)
...
a[product](https://docs.stripe.com/api/events/types#product_object)
...
code](https://docs.stripe.com/api/events/types#promotion_code_object)
...
a[quote](https://docs.stripe.com/api/events/types#quote_object)
...
warning](https://docs.stripe.com/api/events/types#early_fraud_warning_object)
...
run](https://docs.stripe.com/api/events/types#reporting_report_run_object)
...
type](https://docs.stripe.com/api/events/types#reporting_report_type_object)Selection
required
...
a[review](https://docs.stripe.com/api/events/types#review_object)
...
intent](https://docs.stripe.com/api/events/types#setup_intent_object)
...
run](https://docs.stripe.com/api/events/types#scheduled_query_run_object)
...
schedule](https://docs.stripe.com/api/events/types#subscription_schedule_object)
...
rate](https://docs.stripe.com/api/events/types#tax_rate_object)
...
settings](https://docs.stripe.com/api/events/types#tax_settings_object)

Occurs whenever tax settings is updated.
- #### terminal.reader.action_failed`data.object` is a[terminal
reader](https://docs.stripe.com/api/events/types#terminal_reader_object)
...
clock](https://docs.stripe.com/api/events/types#test_clock_object)
...
test clock](https://docs.stripe.com/api/events/types#test_clock_object)
...
a[topup](https://docs.stripe.com/api/events/types#topup_object)
...
a[transfer](https://docs.stripe.com/api/events/types#transfer_object)
...
with the [create file](https://docs.stripe.com/api/events/types#create_file)
...
query](https://docs.stripe.com/api/events/types#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/events/types#payment_intents) to
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/events/types#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/events/types#payment_intent_object-setup_future_usage)
...
conjunction with [Prices](https://docs.stripe.com/api/events/types#prices) to
...
[Products](https://docs.stripe.com/api/events/types#products) help you track
...
[subscriptions](https://docs.stripe.com/api/events/types#subscriptions),
[invoices](https://docs.stripe.com/api/events/types#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/events/types#quotes), and more. Coupons do
not work with conventional one-off
[charges](https://docs.stripe.com/api/events/types#create_charge) or [payment
...
[coupon](https://docs.stripe.com/api/events/types#coupons). It can be used to
...
[coupon](https://docs.stripe.com/api/events/types#coupons) or [promotion
code](https://docs.stripe.com/api/events/types#promotion_codes). It contains
...
items](https://docs.stripe.com/api/events/types#invoiceitems), and proration
...
API](https://docs.stripe.com/api/events/types#prices). It replaces the Plans API
...
of products. [Products](https://docs.stripe.com/api/events/types#products) help
...
[Payout](https://docs.stripe.com/api/events/types#payout_object) object, with
...
[FinancialAccount’s](https://docs.stripe.com/api/events/types#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/events/types#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/events/types#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/events/types#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/events/types#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/events/types#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/events/types#received_debits)
