...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fpayment_intents%2Fincrement_authorization)
...
event](https://docs.stripe.com/api/payment_intents/increment_authorization#retrieve_event)
or a [list of
events](https://docs.stripe.com/api/payment_intents/increment_authorization#list_events)
...
API](https://docs.stripe.com/api/payment_intents/increment_authorization#retrieve_event)
for 30 days.
...
with the [create
file](https://docs.stripe.com/api/payment_intents/increment_authorization#create_file)
...
query](https://docs.stripe.com/api/payment_intents/increment_authorization#scheduled_queries)).
...
If
[setup_future_usage](https://docs.stripe.com/api/payment_intents/increment_authorization#payment_intent_object-setup_future_usage)
...
Possible enum
values`canceled``processing``requires_action``requires_capture``requires_confirmation``requires_payment_method``succeeded`
...
- #### canceled_atnullable timestampretrievable with publishable key
...
When you enable this parameter, this PaymentIntent accepts payment methods that
...
intent](https://docs.stripe.com/api/payment_intents/increment_authorization#payment_intent_object)
...
[client_secret](https://docs.stripe.com/api/payment_intents/increment_authorization#payment_intent_object-client_secret).
...
# [Reconcile a customer_balance PaymentIntent](https://docs.stripe.com/api/payment_intents/apply_customer_balance)
...
[PaymentIntents](https://docs.stripe.com/api/payment_intents/increment_authorization#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/payment_intents/increment_authorization#setup_intent_object-customer),
...
conjunction with
[Prices](https://docs.stripe.com/api/payment_intents/increment_authorization#prices)
...
[Products](https://docs.stripe.com/api/payment_intents/increment_authorization#products)
...
[subscriptions](https://docs.stripe.com/api/payment_intents/increment_authorization#subscriptions),
[invoices](https://docs.stripe.com/api/payment_intents/increment_authorization#invoices),
[checkout sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/payment_intents/increment_authorization#quotes),
and more. Coupons do not work with conventional one-off
[charges](https://docs.stripe.com/api/payment_intents/increment_authorization#create_charge)
...
[coupon](https://docs.stripe.com/api/payment_intents/increment_authorization#coupons).
...
[coupon](https://docs.stripe.com/api/payment_intents/increment_authorization#coupons)
or [promotion
code](https://docs.stripe.com/api/payment_intents/increment_authorization#promotion_codes).
...
items](https://docs.stripe.com/api/payment_intents/increment_authorization#invoiceitems),
...
API](https://docs.stripe.com/api/payment_intents/increment_authorization#prices).
...
[Payout](https://docs.stripe.com/api/payment_intents/increment_authorization#payout_object)
...
[FinancialAccount’s](https://docs.stripe.com/api/payment_intents/increment_authorization#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/payment_intents/increment_authorization#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/payment_intents/increment_authorization#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/payment_intents/increment_authorization#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/payment_intents/increment_authorization#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/payment_intents/increment_authorization#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/payment_intents/increment_authorization#received_debits)
...
prefix](https://docs.stripe.com/get-started/account/statement-descriptors#static)
- [charge them
later](https://docs.stripe.com/payments/cards/charging-saved-cards)
-
[confirm=true](https://docs.stripe.com/api/payment_intents/create#create_payment_intent-confirm)
- [compatible
Source](https://docs.stripe.com/payments/payment-methods/transitioning#compatibility)
- [in rare cases](https://docs.stripe.com/payments/intents)
- [Expire the Checkout
