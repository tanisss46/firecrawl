...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Ffile_links%2Flist)
...
event](https://docs.stripe.com/api/file_links/list#retrieve_event) or a [list of
events](https://docs.stripe.com/api/file_links/list#list_events) from the API.
...
API](https://docs.stripe.com/api/file_links/list#retrieve_event) for 30 days.
...
with the [create file](https://docs.stripe.com/api/file_links/list#create_file)
...
query](https://docs.stripe.com/api/file_links/list#scheduled_queries)).
...
error](https://docs.stripe.com/api/file_links/list#errors) otherwise.
...
Stripe raises [an error](https://docs.stripe.com/api/file_links/list#errors).
...
[PaymentIntents](https://docs.stripe.com/api/file_links/list#payment_intents) to
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/file_links/list#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/file_links/list#payment_intent_object-setup_future_usage)
...
conjunction with [Prices](https://docs.stripe.com/api/file_links/list#prices) to
...
[Products](https://docs.stripe.com/api/file_links/list#products) help you track
...
[subscriptions](https://docs.stripe.com/api/file_links/list#subscriptions),
[invoices](https://docs.stripe.com/api/file_links/list#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/file_links/list#quotes), and more. Coupons
do not work with conventional one-off
[charges](https://docs.stripe.com/api/file_links/list#create_charge) or [payment
...
[coupon](https://docs.stripe.com/api/file_links/list#coupons). It can be used to
...
[coupon](https://docs.stripe.com/api/file_links/list#coupons) or [promotion
code](https://docs.stripe.com/api/file_links/list#promotion_codes). It contains
...
items](https://docs.stripe.com/api/file_links/list#invoiceitems), and proration
...
API](https://docs.stripe.com/api/file_links/list#prices). It replaces the Plans
...
of products. [Products](https://docs.stripe.com/api/file_links/list#products)
...
[Payout](https://docs.stripe.com/api/file_links/list#payout_object) object, with
...
[FinancialAccount’s](https://docs.stripe.com/api/file_links/list#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/file_links/list#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/file_links/list#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/file_links/list#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/file_links/list#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/file_links/list#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/file_links/list#received_debits)
