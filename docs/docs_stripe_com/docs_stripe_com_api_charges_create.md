...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fcharges%2Fcreate)
...
error](https://docs.stripe.com/api/charges/create#errors) if something goes
...
error](https://docs.stripe.com/api/charges/create#errors) if update parameters
are invalid.
...
error](https://docs.stripe.com/api/charges/create#errors) otherwise.
...
error](https://docs.stripe.com/api/charges/create#errors).
...
method will raise [an error](https://docs.stripe.com/api/charges/create#errors).
...
event](https://docs.stripe.com/api/charges/create#retrieve_event) or a [list of
events](https://docs.stripe.com/api/charges/create#list_events) from the API. We
...
API](https://docs.stripe.com/api/charges/create#retrieve_event) for 30 days.
...
with the [create file](https://docs.stripe.com/api/charges/create#create_file)
...
query](https://docs.stripe.com/api/charges/create#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/charges/create#payment_intents) to
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/charges/create#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/charges/create#payment_intent_object-setup_future_usage)
...
conjunction with [Prices](https://docs.stripe.com/api/charges/create#prices) to
...
[Products](https://docs.stripe.com/api/charges/create#products) help you track
...
[subscriptions](https://docs.stripe.com/api/charges/create#subscriptions),
[invoices](https://docs.stripe.com/api/charges/create#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/charges/create#quotes), and more. Coupons
do not work with conventional one-off
[charges](https://docs.stripe.com/api/charges/create#create_charge) or [payment
...
[coupon](https://docs.stripe.com/api/charges/create#coupons). It can be used to
...
[coupon](https://docs.stripe.com/api/charges/create#coupons) or [promotion
code](https://docs.stripe.com/api/charges/create#promotion_codes). It contains
...
items](https://docs.stripe.com/api/charges/create#invoiceitems), and proration
...
API](https://docs.stripe.com/api/charges/create#prices). It replaces the Plans
...
of products. [Products](https://docs.stripe.com/api/charges/create#products)
...
[Payout](https://docs.stripe.com/api/charges/create#payout_object) object, with
...
[FinancialAccount’s](https://docs.stripe.com/api/charges/create#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/charges/create#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/charges/create#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/charges/create#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/charges/create#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/charges/create#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/charges/create#received_debits)
