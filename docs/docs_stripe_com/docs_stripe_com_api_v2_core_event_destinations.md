...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fv2%2Fcore%2Fevent_destinations)
...
event](https://docs.stripe.com/api/v2/core/event_destinations#retrieve_event) or
a [list of
events](https://docs.stripe.com/api/v2/core/event_destinations#list_events) from
...
API](https://docs.stripe.com/api/v2/core/event_destinations#retrieve_event) for
30 days.
...
with the [create
file](https://docs.stripe.com/api/v2/core/event_destinations#create_file)
...
query](https://docs.stripe.com/api/v2/core/event_destinations#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/v2/core/event_destinations#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/v2/core/event_destinations#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/v2/core/event_destinations#payment_intent_object-setup_future_usage)
...
conjunction with
[Prices](https://docs.stripe.com/api/v2/core/event_destinations#prices) to
...
[Products](https://docs.stripe.com/api/v2/core/event_destinations#products) help
you track inventory or provisioning, and prices help you track payment terms.
...
[subscriptions](https://docs.stripe.com/api/v2/core/event_destinations#subscriptions),
[invoices](https://docs.stripe.com/api/v2/core/event_destinations#invoices),
[checkout sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/v2/core/event_destinations#quotes), and
more. Coupons do not work with conventional one-off
[charges](https://docs.stripe.com/api/v2/core/event_destinations#create_charge)
...
[coupon](https://docs.stripe.com/api/v2/core/event_destinations#coupons). It can
be used to create multiple codes for a single coupon.
...
[coupon](https://docs.stripe.com/api/v2/core/event_destinations#coupons) or
[promotion
code](https://docs.stripe.com/api/v2/core/event_destinations#promotion_codes).
...
items](https://docs.stripe.com/api/v2/core/event_destinations#invoiceitems), and
...
API](https://docs.stripe.com/api/v2/core/event_destinations#prices). It replaces
...
[Payout](https://docs.stripe.com/api/v2/core/event_destinations#payout_object)
...
[FinancialAccount’s](https://docs.stripe.com/api/v2/core/event_destinations#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/v2/core/event_destinations#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/v2/core/event_destinations#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/v2/core/event_destinations#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/v2/core/event_destinations#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/v2/core/event_destinations#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/v2/core/event_destinations#received_debits)
