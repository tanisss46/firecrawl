...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fconnected-accounts)
...
event](https://docs.stripe.com/api/connected-accounts#retrieve_event) or a [list
of events](https://docs.stripe.com/api/connected-accounts#list_events) from the
...
API](https://docs.stripe.com/api/connected-accounts#retrieve_event) for 30 days.
...
with the [create
file](https://docs.stripe.com/api/connected-accounts#create_file) request (for
...
query](https://docs.stripe.com/api/connected-accounts#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/connected-accounts#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/connected-accounts#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/connected-accounts#payment_intent_object-setup_future_usage)
...
conjunction with [Prices](https://docs.stripe.com/api/connected-accounts#prices)
...
[Products](https://docs.stripe.com/api/connected-accounts#products) help you
...
[subscriptions](https://docs.stripe.com/api/connected-accounts#subscriptions),
[invoices](https://docs.stripe.com/api/connected-accounts#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/connected-accounts#quotes), and more.
Coupons do not work with conventional one-off
[charges](https://docs.stripe.com/api/connected-accounts#create_charge) or
[payment intents](https://docs.stripe.com/api/payment_intents).
...
[coupon](https://docs.stripe.com/api/connected-accounts#coupons). It can be used
...
[coupon](https://docs.stripe.com/api/connected-accounts#coupons) or [promotion
code](https://docs.stripe.com/api/connected-accounts#promotion_codes). It
...
items](https://docs.stripe.com/api/connected-accounts#invoiceitems), and
...
API](https://docs.stripe.com/api/connected-accounts#prices). It replaces the
...
of products. [Products](https://docs.stripe.com/api/connected-accounts#products)
...
[Payout](https://docs.stripe.com/api/connected-accounts#payout_object) object,
...
[FinancialAccount’s](https://docs.stripe.com/api/connected-accounts#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/connected-accounts#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/connected-accounts#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/connected-accounts#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/connected-accounts#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/connected-accounts#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/connected-accounts#received_debits)
