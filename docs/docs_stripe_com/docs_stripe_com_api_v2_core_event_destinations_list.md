...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fv2%2Fcore%2Fevent_destinations%2Flist)
...
event](https://docs.stripe.com/api/v2/core/event_destinations/list#retrieve_event)
or a [list of
events](https://docs.stripe.com/api/v2/core/event_destinations/list#list_events)
...
API](https://docs.stripe.com/api/v2/core/event_destinations/list#retrieve_event)
for 30 days.
...
with the [create
file](https://docs.stripe.com/api/v2/core/event_destinations/list#create_file)
...
query](https://docs.stripe.com/api/v2/core/event_destinations/list#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/v2/core/event_destinations/list#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/v2/core/event_destinations/list#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/v2/core/event_destinations/list#payment_intent_object-setup_future_usage)
...
conjunction with
[Prices](https://docs.stripe.com/api/v2/core/event_destinations/list#prices) to
...
[Products](https://docs.stripe.com/api/v2/core/event_destinations/list#products)
...
[subscriptions](https://docs.stripe.com/api/v2/core/event_destinations/list#subscriptions),
[invoices](https://docs.stripe.com/api/v2/core/event_destinations/list#invoices),
[checkout sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/v2/core/event_destinations/list#quotes),
and more. Coupons do not work with conventional one-off
[charges](https://docs.stripe.com/api/v2/core/event_destinations/list#create_charge)
...
[coupon](https://docs.stripe.com/api/v2/core/event_destinations/list#coupons).
...
[coupon](https://docs.stripe.com/api/v2/core/event_destinations/list#coupons) or
[promotion
code](https://docs.stripe.com/api/v2/core/event_destinations/list#promotion_codes).
...
items](https://docs.stripe.com/api/v2/core/event_destinations/list#invoiceitems),
...
API](https://docs.stripe.com/api/v2/core/event_destinations/list#prices). It
...
[Payout](https://docs.stripe.com/api/v2/core/event_destinations/list#payout_object)
...
[FinancialAccount’s](https://docs.stripe.com/api/v2/core/event_destinations/list#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/v2/core/event_destinations/list#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/v2/core/event_destinations/list#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/v2/core/event_destinations/list#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/v2/core/event_destinations/list#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/v2/core/event_destinations/list#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/v2/core/event_destinations/list#received_debits)
