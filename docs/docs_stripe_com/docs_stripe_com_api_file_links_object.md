...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Ffile_links%2Fobject)
...
event](https://docs.stripe.com/api/file_links/object#retrieve_event) or a [list
of events](https://docs.stripe.com/api/file_links/object#list_events) from the
...
API](https://docs.stripe.com/api/file_links/object#retrieve_event) for 30 days.
...
with the [create
file](https://docs.stripe.com/api/file_links/object#create_file) request (for
...
query](https://docs.stripe.com/api/file_links/object#scheduled_queries)).
...
error](https://docs.stripe.com/api/file_links/object#errors) otherwise.
...
Stripe raises [an error](https://docs.stripe.com/api/file_links/object#errors).
...
[PaymentIntents](https://docs.stripe.com/api/file_links/object#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/file_links/object#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/file_links/object#payment_intent_object-setup_future_usage)
...
conjunction with [Prices](https://docs.stripe.com/api/file_links/object#prices)
...
[Products](https://docs.stripe.com/api/file_links/object#products) help you
...
[subscriptions](https://docs.stripe.com/api/file_links/object#subscriptions),
[invoices](https://docs.stripe.com/api/file_links/object#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/file_links/object#quotes), and more.
Coupons do not work with conventional one-off
[charges](https://docs.stripe.com/api/file_links/object#create_charge) or
[payment intents](https://docs.stripe.com/api/payment_intents).
...
[coupon](https://docs.stripe.com/api/file_links/object#coupons). It can be used
...
[coupon](https://docs.stripe.com/api/file_links/object#coupons) or [promotion
code](https://docs.stripe.com/api/file_links/object#promotion_codes). It
...
items](https://docs.stripe.com/api/file_links/object#invoiceitems), and
...
API](https://docs.stripe.com/api/file_links/object#prices). It replaces the
...
of products. [Products](https://docs.stripe.com/api/file_links/object#products)
...
[Payout](https://docs.stripe.com/api/file_links/object#payout_object) object,
...
[FinancialAccount’s](https://docs.stripe.com/api/file_links/object#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/file_links/object#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/file_links/object#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/file_links/object#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/file_links/object#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/file_links/object#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/file_links/object#received_debits)
