...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fcustomers)
...
error](https://docs.stripe.com/api/customers#errors) if create parameters are
invalid (for example, specifying an invalid coupon or an invalid source).
...
error](https://docs.stripe.com/api/customers#errors) if update parameters are
invalid (e.g. specifying an invalid coupon or an invalid source).
...
error](https://docs.stripe.com/api/customers#errors).
...
event](https://docs.stripe.com/api/customers#retrieve_event) or a [list of
events](https://docs.stripe.com/api/customers#list_events) from the API. We also
...
API](https://docs.stripe.com/api/customers#retrieve_event) for 30 days.
...
with the [create file](https://docs.stripe.com/api/customers#create_file)
...
query](https://docs.stripe.com/api/customers#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/customers#payment_intents) to drive
the payment flow.
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/customers#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/customers#payment_intent_object-setup_future_usage)
...
conjunction with [Prices](https://docs.stripe.com/api/customers#prices) to
...
[Products](https://docs.stripe.com/api/customers#products) help you track
...
[subscriptions](https://docs.stripe.com/api/customers#subscriptions),
[invoices](https://docs.stripe.com/api/customers#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/customers#quotes), and more. Coupons do not
work with conventional one-off
[charges](https://docs.stripe.com/api/customers#create_charge) or [payment
...
[coupon](https://docs.stripe.com/api/customers#coupons). It can be used to
...
[coupon](https://docs.stripe.com/api/customers#coupons) or [promotion
code](https://docs.stripe.com/api/customers#promotion_codes). It contains
...
items](https://docs.stripe.com/api/customers#invoiceitems), and proration
...
API](https://docs.stripe.com/api/customers#prices). It replaces the Plans API
...
of products. [Products](https://docs.stripe.com/api/customers#products) help you
...
[Payout](https://docs.stripe.com/api/customers#payout_object) object, with
...
[FinancialAccount’s](https://docs.stripe.com/api/customers#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/customers#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/customers#financial_accounts) to
a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/customers#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/customers#outbound_transfers).
...
[FinancialAccount](https://docs.stripe.com/api/customers#financial_accounts) via
...
[FinancialAccount](https://docs.stripe.com/api/customers#financial_accounts)
...
[ReceivedCredits](https://docs.stripe.com/api/customers#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/customers#received_debits)
