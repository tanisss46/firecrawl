...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fcharges%2Flist)
...
error](https://docs.stripe.com/api/charges/list#errors) if something goes wrong.
A common source of error is an invalid or expired card, or a valid card with
...
error](https://docs.stripe.com/api/charges/list#errors) if update parameters are
invalid.
...
error](https://docs.stripe.com/api/charges/list#errors) otherwise.
...
error](https://docs.stripe.com/api/charges/list#errors).
...
method will raise [an error](https://docs.stripe.com/api/charges/list#errors).
...
event](https://docs.stripe.com/api/charges/list#retrieve_event) or a [list of
events](https://docs.stripe.com/api/charges/list#list_events) from the API. We
...
API](https://docs.stripe.com/api/charges/list#retrieve_event) for 30 days.
...
with the [create file](https://docs.stripe.com/api/charges/list#create_file)
...
query](https://docs.stripe.com/api/charges/list#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/charges/list#payment_intents) to
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/charges/list#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/charges/list#payment_intent_object-setup_future_usage)
...
conjunction with [Prices](https://docs.stripe.com/api/charges/list#prices) to
...
[Products](https://docs.stripe.com/api/charges/list#products) help you track
...
[subscriptions](https://docs.stripe.com/api/charges/list#subscriptions),
[invoices](https://docs.stripe.com/api/charges/list#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/charges/list#quotes), and more. Coupons do
not work with conventional one-off
[charges](https://docs.stripe.com/api/charges/list#create_charge) or [payment
...
[coupon](https://docs.stripe.com/api/charges/list#coupons). It can be used to
...
[coupon](https://docs.stripe.com/api/charges/list#coupons) or [promotion
code](https://docs.stripe.com/api/charges/list#promotion_codes). It contains
...
items](https://docs.stripe.com/api/charges/list#invoiceitems), and proration
...
API](https://docs.stripe.com/api/charges/list#prices). It replaces the Plans API
...
of products. [Products](https://docs.stripe.com/api/charges/list#products) help
...
[Payout](https://docs.stripe.com/api/charges/list#payout_object) object, with
...
[FinancialAccount’s](https://docs.stripe.com/api/charges/list#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/charges/list#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/charges/list#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/charges/list#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/charges/list#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/charges/list#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/charges/list#received_debits)
