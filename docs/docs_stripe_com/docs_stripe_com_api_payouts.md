...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fpayouts)
...
event](https://docs.stripe.com/api/payouts#retrieve_event) or a [list of
events](https://docs.stripe.com/api/payouts#list_events) from the API. We also
...
API](https://docs.stripe.com/api/payouts#retrieve_event) for 30 days.
...
with the [create file](https://docs.stripe.com/api/payouts#create_file) request
...
query](https://docs.stripe.com/api/payouts#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/payouts#payment_intents) to drive
the payment flow.
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/payouts#setup_intent_object-customer), it
...
[setup_future_usage](https://docs.stripe.com/api/payouts#payment_intent_object-setup_future_usage)
...
balance](https://docs.stripe.com/api/payouts#balance) must cover the payout
...
from. The [balance object](https://docs.stripe.com/api/payouts#balance_object)
...
error](https://docs.stripe.com/api/payouts#errors) if update parameters are
invalid.
...
error](https://docs.stripe.com/api/payouts#errors) occurs otherwise.
...
GET /v1/payoutsServer-side languageStripe CLIcURL.NETGoJavaNode.jsPHPPythonRuby
```
...
conjunction with [Prices](https://docs.stripe.com/api/payouts#prices) to
...
[Products](https://docs.stripe.com/api/payouts#products) help you track
...
[subscriptions](https://docs.stripe.com/api/payouts#subscriptions),
[invoices](https://docs.stripe.com/api/payouts#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/payouts#quotes), and more. Coupons do not
work with conventional one-off
[charges](https://docs.stripe.com/api/payouts#create_charge) or [payment
...
[coupon](https://docs.stripe.com/api/payouts#coupons). It can be used to create
...
[coupon](https://docs.stripe.com/api/payouts#coupons) or [promotion
code](https://docs.stripe.com/api/payouts#promotion_codes). It contains
...
They contain [invoice items](https://docs.stripe.com/api/payouts#invoiceitems),
...
API](https://docs.stripe.com/api/payouts#prices). It replaces the Plans API and
...
of products. [Products](https://docs.stripe.com/api/payouts#products) help you
...
[Payout](https://docs.stripe.com/api/payouts#payout_object) object, with
...
[FinancialAccount’s](https://docs.stripe.com/api/payouts#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/payouts#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/payouts#financial_accounts) to a
PaymentMethod belonging to the same entity. To send funds to a different party,
use [OutboundPayments](https://docs.stripe.com/api/payouts#outbound_payments)
...
[FinancialAccount](https://docs.stripe.com/api/payouts#financial_accounts). To
send money to an account belonging to the same user, use an
[OutboundTransfer](https://docs.stripe.com/api/payouts#outbound_transfers).
...
[FinancialAccount](https://docs.stripe.com/api/payouts#financial_accounts) via a
...
[FinancialAccount](https://docs.stripe.com/api/payouts#financial_accounts) (for
...
[FinancialAccount](https://docs.stripe.com/api/payouts#financial_accounts).
...
[ReceivedCredits](https://docs.stripe.com/api/payouts#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/payouts#received_debits) depending
