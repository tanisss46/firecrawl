...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fsetup_intents%2Fretrieve)
...
event](https://docs.stripe.com/api/setup_intents/retrieve#retrieve_event) or a
[list of events](https://docs.stripe.com/api/setup_intents/retrieve#list_events)
...
API](https://docs.stripe.com/api/setup_intents/retrieve#retrieve_event) for 30
days.
...
with the [create
file](https://docs.stripe.com/api/setup_intents/retrieve#create_file) request
...
query](https://docs.stripe.com/api/setup_intents/retrieve#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/setup_intents/retrieve#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/setup_intents/retrieve#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/setup_intents/retrieve#payment_intent_object-setup_future_usage)
...
[SetupIntent](https://docs.stripe.com/api/setup_intents/retrieve#setup_intent_object)
...
conjunction with
[Prices](https://docs.stripe.com/api/setup_intents/retrieve#prices) to configure
...
[Products](https://docs.stripe.com/api/setup_intents/retrieve#products) help you
...
[subscriptions](https://docs.stripe.com/api/setup_intents/retrieve#subscriptions),
[invoices](https://docs.stripe.com/api/setup_intents/retrieve#invoices),
[checkout sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/setup_intents/retrieve#quotes), and more.
Coupons do not work with conventional one-off
[charges](https://docs.stripe.com/api/setup_intents/retrieve#create_charge) or
[payment intents](https://docs.stripe.com/api/payment_intents).
...
[coupon](https://docs.stripe.com/api/setup_intents/retrieve#coupons). It can be
...
[coupon](https://docs.stripe.com/api/setup_intents/retrieve#coupons) or
[promotion
code](https://docs.stripe.com/api/setup_intents/retrieve#promotion_codes). It
...
items](https://docs.stripe.com/api/setup_intents/retrieve#invoiceitems), and
...
API](https://docs.stripe.com/api/setup_intents/retrieve#prices). It replaces the
...
[Payout](https://docs.stripe.com/api/setup_intents/retrieve#payout_object)
...
[FinancialAccount’s](https://docs.stripe.com/api/setup_intents/retrieve#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/setup_intents/retrieve#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/setup_intents/retrieve#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/setup_intents/retrieve#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/setup_intents/retrieve#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/setup_intents/retrieve#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/setup_intents/retrieve#received_debits)
