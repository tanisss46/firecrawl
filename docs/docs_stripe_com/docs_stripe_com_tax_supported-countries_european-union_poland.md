# Collect tax in Poland

## Learn how to use Stripe Tax to calculate, collect, and report tax in Poland.

Poland is part of the EU and applies the EU VAT rules. Read more about those
...
about your potential tax registration obligations in Poland. Stripe also
notifies you with email and Dashboard alerts when you need to register to
collect tax. Learn more about how the [monitoring tool
works](https://docs.stripe.com/tax/monitoring).

You can read more about registration obligations in Poland on the [European
...
- [Domestic VAT
registration](https://www.podatki.gov.pl/en/value-added-tax/registering-for-vat/)
- [One-Stop Shop registration
schemes](https://www.podatki.gov.pl/vat/abc-vat/procedury/punkt-kompleksowej-obslugi-oss-i-ioss/)
(Polish content)

After you’ve registered to collect tax in Poland, go to
[Registrations](https://dashboard.stripe.com/tax/registrations?location=pl) to
add your registrations to Stripe in the Dashboard. This turns on tax calculation
and collection in Stripe for your transactions in Poland.
...
Poland applies the EU VAT rules. Learn more about [tax calculation in the
...
- [One-Stop Shop registration
schemes](https://www.podatki.gov.pl/vat/abc-vat/procedury/punkt-kompleksowej-obslugi-oss-i-ioss/)
- [Registrations](https://dashboard.stripe.com/tax/registrations?location=pl)
- [how to add your
registration](https://docs.stripe.com/tax/registering#track-your-registrations-in-the-tax-dashboard)
