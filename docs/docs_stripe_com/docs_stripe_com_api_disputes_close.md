...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fdisputes%2Fclose)
...
error](https://docs.stripe.com/api/disputes/close#errors) otherwise.
...
event](https://docs.stripe.com/api/disputes/close#retrieve_event) or a [list of
events](https://docs.stripe.com/api/disputes/close#list_events) from the API. We
...
API](https://docs.stripe.com/api/disputes/close#retrieve_event) for 30 days.
...
with the [create file](https://docs.stripe.com/api/disputes/close#create_file)
...
query](https://docs.stripe.com/api/disputes/close#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/disputes/close#payment_intents) to
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/disputes/close#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/disputes/close#payment_intent_object-setup_future_usage)
...
conjunction with [Prices](https://docs.stripe.com/api/disputes/close#prices) to
...
[Products](https://docs.stripe.com/api/disputes/close#products) help you track
...
[subscriptions](https://docs.stripe.com/api/disputes/close#subscriptions),
[invoices](https://docs.stripe.com/api/disputes/close#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/disputes/close#quotes), and more. Coupons
do not work with conventional one-off
[charges](https://docs.stripe.com/api/disputes/close#create_charge) or [payment
...
[coupon](https://docs.stripe.com/api/disputes/close#coupons). It can be used to
...
[coupon](https://docs.stripe.com/api/disputes/close#coupons) or [promotion
code](https://docs.stripe.com/api/disputes/close#promotion_codes). It contains
...
items](https://docs.stripe.com/api/disputes/close#invoiceitems), and proration
...
API](https://docs.stripe.com/api/disputes/close#prices). It replaces the Plans
...
of products. [Products](https://docs.stripe.com/api/disputes/close#products)
...
[Payout](https://docs.stripe.com/api/disputes/close#payout_object) object, with
...
[FinancialAccount’s](https://docs.stripe.com/api/disputes/close#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/disputes/close#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/disputes/close#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/disputes/close#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/disputes/close#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/disputes/close#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/disputes/close#received_debits)
