...
Adds the Amazon Pay `dispute_type` to the `Dispute.payment_method_details`
field.

Addedpayment_method_details.amazon_payobject
AmazonPay specific dispute details.

## Impact

This change helps you understand the details of Amazon Pay disputes directly
from [Disputes](https://docs.stripe.com/api/disputes).

## Changes

REST APIRubyPythonPHPJavaNodeGo.NETParameterChangeResources or
endpointsamazon_payAdded[Dispute.payment_method_details](https://docs.stripe.com/api/disputes/object#dispute_object-payment_method_details)ValueChangeEnumamazon_payAdded[Dispute.payment_method_details.type](https://docs.stripe.com/api/disputes/object#dispute_object-payment_method_details-type)
## Upgrade
...
-
[Dispute.payment_method_details](https://docs.stripe.com/api/disputes/object#dispute_object-payment_method_details)
-
[Dispute.payment_method_details.type](https://docs.stripe.com/api/disputes/object#dispute_object-payment_method_details-type)
- [View your current API
version](https://docs.stripe.com/upgrades#view-your-api-version-and-the-latest-available-upgrade-in-workbench)
