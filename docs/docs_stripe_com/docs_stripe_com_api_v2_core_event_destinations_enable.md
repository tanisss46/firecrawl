...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fv2%2Fcore%2Fevent_destinations%2Fenable)
...
event](https://docs.stripe.com/api/v2/core/event_destinations/enable#retrieve_event)
or a [list of
events](https://docs.stripe.com/api/v2/core/event_destinations/enable#list_events)
...
API](https://docs.stripe.com/api/v2/core/event_destinations/enable#retrieve_event)
for 30 days.
...
with the [create
file](https://docs.stripe.com/api/v2/core/event_destinations/enable#create_file)
...
query](https://docs.stripe.com/api/v2/core/event_destinations/enable#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/v2/core/event_destinations/enable#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/v2/core/event_destinations/enable#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/v2/core/event_destinations/enable#payment_intent_object-setup_future_usage)
...
conjunction with
[Prices](https://docs.stripe.com/api/v2/core/event_destinations/enable#prices)
...
[Products](https://docs.stripe.com/api/v2/core/event_destinations/enable#products)
...
[subscriptions](https://docs.stripe.com/api/v2/core/event_destinations/enable#subscriptions),
[invoices](https://docs.stripe.com/api/v2/core/event_destinations/enable#invoices),
[checkout sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/v2/core/event_destinations/enable#quotes),
and more. Coupons do not work with conventional one-off
[charges](https://docs.stripe.com/api/v2/core/event_destinations/enable#create_charge)
...
[coupon](https://docs.stripe.com/api/v2/core/event_destinations/enable#coupons).
...
[coupon](https://docs.stripe.com/api/v2/core/event_destinations/enable#coupons)
or [promotion
code](https://docs.stripe.com/api/v2/core/event_destinations/enable#promotion_codes).
...
items](https://docs.stripe.com/api/v2/core/event_destinations/enable#invoiceitems),
...
API](https://docs.stripe.com/api/v2/core/event_destinations/enable#prices). It
...
[Payout](https://docs.stripe.com/api/v2/core/event_destinations/enable#payout_object)
...
[FinancialAccount’s](https://docs.stripe.com/api/v2/core/event_destinations/enable#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/v2/core/event_destinations/enable#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/v2/core/event_destinations/enable#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/v2/core/event_destinations/enable#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/v2/core/event_destinations/enable#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/v2/core/event_destinations/enable#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/v2/core/event_destinations/enable#received_debits)
