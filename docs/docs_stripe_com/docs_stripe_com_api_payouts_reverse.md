...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fpayouts%2Freverse)
...
event](https://docs.stripe.com/api/payouts/reverse#retrieve_event) or a [list of
events](https://docs.stripe.com/api/payouts/reverse#list_events) from the API.
...
API](https://docs.stripe.com/api/payouts/reverse#retrieve_event) for 30 days.
...
with the [create file](https://docs.stripe.com/api/payouts/reverse#create_file)
...
query](https://docs.stripe.com/api/payouts/reverse#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/payouts/reverse#payment_intents) to
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/payouts/reverse#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/payouts/reverse#payment_intent_object-setup_future_usage)
...
balance](https://docs.stripe.com/api/payouts/reverse#balance) must cover the
payout amount. If it doesn’t, you receive an “Insufficient Funds” error.
...
from. The [balance
object](https://docs.stripe.com/api/payouts/reverse#balance_object) details
...
error](https://docs.stripe.com/api/payouts/reverse#errors) if update parameters
are invalid.
...
error](https://docs.stripe.com/api/payouts/reverse#errors) occurs otherwise.
...
conjunction with [Prices](https://docs.stripe.com/api/payouts/reverse#prices) to
...
[Products](https://docs.stripe.com/api/payouts/reverse#products) help you track
...
[subscriptions](https://docs.stripe.com/api/payouts/reverse#subscriptions),
[invoices](https://docs.stripe.com/api/payouts/reverse#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/payouts/reverse#quotes), and more. Coupons
do not work with conventional one-off
[charges](https://docs.stripe.com/api/payouts/reverse#create_charge) or [payment
...
[coupon](https://docs.stripe.com/api/payouts/reverse#coupons). It can be used to
...
[coupon](https://docs.stripe.com/api/payouts/reverse#coupons) or [promotion
code](https://docs.stripe.com/api/payouts/reverse#promotion_codes). It contains
...
items](https://docs.stripe.com/api/payouts/reverse#invoiceitems), and proration
...
API](https://docs.stripe.com/api/payouts/reverse#prices). It replaces the Plans
...
of products. [Products](https://docs.stripe.com/api/payouts/reverse#products)
...
[Payout](https://docs.stripe.com/api/payouts/reverse#payout_object) object, with
...
[FinancialAccount’s](https://docs.stripe.com/api/payouts/reverse#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/payouts/reverse#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/payouts/reverse#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/payouts/reverse#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/payouts/reverse#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/payouts/reverse#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/payouts/reverse#received_debits)
