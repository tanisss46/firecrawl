...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fpayouts%2Fobject)
...
event](https://docs.stripe.com/api/payouts/object#retrieve_event) or a [list of
events](https://docs.stripe.com/api/payouts/object#list_events) from the API. We
...
API](https://docs.stripe.com/api/payouts/object#retrieve_event) for 30 days.
...
with the [create file](https://docs.stripe.com/api/payouts/object#create_file)
...
query](https://docs.stripe.com/api/payouts/object#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/payouts/object#payment_intents) to
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/payouts/object#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/payouts/object#payment_intent_object-setup_future_usage)
...
balance](https://docs.stripe.com/api/payouts/object#balance) must cover the
...
from. The [balance
object](https://docs.stripe.com/api/payouts/object#balance_object) details
...
error](https://docs.stripe.com/api/payouts/object#errors) if update parameters
are invalid.
...
error](https://docs.stripe.com/api/payouts/object#errors) occurs otherwise.
...
conjunction with [Prices](https://docs.stripe.com/api/payouts/object#prices) to
...
[Products](https://docs.stripe.com/api/payouts/object#products) help you track
...
[subscriptions](https://docs.stripe.com/api/payouts/object#subscriptions),
[invoices](https://docs.stripe.com/api/payouts/object#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/payouts/object#quotes), and more. Coupons
do not work with conventional one-off
[charges](https://docs.stripe.com/api/payouts/object#create_charge) or [payment
...
[coupon](https://docs.stripe.com/api/payouts/object#coupons). It can be used to
...
[coupon](https://docs.stripe.com/api/payouts/object#coupons) or [promotion
code](https://docs.stripe.com/api/payouts/object#promotion_codes). It contains
...
items](https://docs.stripe.com/api/payouts/object#invoiceitems), and proration
...
API](https://docs.stripe.com/api/payouts/object#prices). It replaces the Plans
...
of products. [Products](https://docs.stripe.com/api/payouts/object#products)
...
[Payout](https://docs.stripe.com/api/payouts/object#payout_object) object, with
...
[FinancialAccount’s](https://docs.stripe.com/api/payouts/object#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/payouts/object#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/payouts/object#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/payouts/object#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/payouts/object#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/payouts/object#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/payouts/object#received_debits)
