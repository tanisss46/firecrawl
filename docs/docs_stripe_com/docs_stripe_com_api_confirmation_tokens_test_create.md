...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fconfirmation_tokens%2Ftest_create)
...
event](https://docs.stripe.com/api/confirmation_tokens/test_create#retrieve_event)
or a [list of
events](https://docs.stripe.com/api/confirmation_tokens/test_create#list_events)
...
API](https://docs.stripe.com/api/confirmation_tokens/test_create#retrieve_event)
for 30 days.
...
with the [create
file](https://docs.stripe.com/api/confirmation_tokens/test_create#create_file)
...
query](https://docs.stripe.com/api/confirmation_tokens/test_create#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/confirmation_tokens/test_create#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/confirmation_tokens/test_create#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/confirmation_tokens/test_create#payment_intent_object-setup_future_usage)
...
Time at which this ConfirmationToken expires and can no longer be used to
confirm a PaymentIntent or SetupIntent.
- #### livemodeboolean
...
ID of the PaymentIntent that this ConfirmationToken was used to confirm, or null
if this ConfirmationToken has not yet been used.
...
Indicates that you intend to make future payments with this ConfirmationToken’s
payment method.

The presence of this property will [attach the payment
method](https://docs.stripe.com/payments/save-during-payment) to the
PaymentIntent’s Customer, if present, after the PaymentIntent is confirmed and
any required actions from the user are complete.
...
ID of the SetupIntent that this ConfirmationToken was used to confirm, or null
if this ConfirmationToken has not yet been used.
...
Indicates whether the Stripe SDK is used to handle confirmation flow. Defaults
to `true` on ConfirmationToken.
The Confirmation Token object
```
{ "id": "ctoken_1NnQUf2eZvKYlo2CIObdtbnb", "object": "confirmation_token",
"created": 1694025025, "expires_at": 1694068225, "livemode": true,
"mandate_data": null, "payment_intent": null, "payment_method": null,
"payment_method_preview": { "billing_details": { "address": { "city": "Hyde
Park", "country": "US", "line1": "50 Sprague St", "line2": "", "postal_code":
"02136", "state": "MA" }, "email": "jennyrosen@stripe.com", "name": "Jenny
Rosen", "phone": null }, "card": { "brand": "visa", "checks": {
"address_line1_check": null, "address_postal_code_check": null, "cvc_check":
null }, "country": "US", "display_brand": "visa", "exp_month": 8, "exp_year":
2026, "funding": "credit", "generated_from": null, "last4": "4242", "networks":
{ "available": [ "visa" ], "preferred": null }, "three_d_secure_usage": {
"supported": true }, "wallet": null }, "type": "card" }, "return_url":
"https://example.com/return", "setup_future_usage": "off_session",
"setup_intent": null, "shipping": { "address": { "city": "Hyde Park", "country":
"US", "line1": "50 Sprague St", "line2": "", "postal_code": "02136", "state":
"MA" }, "name": "Jenny Rosen", "phone": null }}
```
...
GET /v1/confirmation_tokens/:idServer-side languageStripe
CLIcURL.NETGoJavaNode.jsPHPPythonRuby
```
curl
...
POST /v1/test_helpers/confirmation_tokensServer-side languageStripe
CLIcURL.NETGoJavaNode.jsPHPPythonRuby
```
curl https://api.stripe.com/v1/test_helpers/confirmation_tokens \ -u
"sk_test_BQokikJ...2HlWgH4olfQ2sk_test_BQokikJOvBiI2HlWgH4olfQ2:" \ -d
...
Response
```
{ "id": "ctoken_1Ow71CL4FhS6zgoxWjxc7sfr", "object": "confirmation_token",
"created": 1710871450, "expires_at": 1710914650, "livemode": false,
"payment_intent": null, "payment_method_preview": { "billing_details": {
"address": { "city": null, "country": null, "line1": null, "line2": null,
"postal_code": null, "state": null }, "email": null, "name": null, "phone": null
}, "card": { "brand": "visa", "checks": { "address_line1_check": null,
"address_postal_code_check": null, "cvc_check": "unchecked" }, "country": "US",
"display_brand": "visa", "exp_month": 3, "exp_year": 2025, "fingerprint":
"jbGyCKrSRsFpOBWP", "funding": "credit", "generated_from": null, "last4":
"4242", "networks": { "available": [ "visa" ], "preferred": null },
"three_d_secure_usage": { "supported": true }, "wallet": null }, "type": "card"
}, "return_url": null, "setup_future_usage": null, "setup_intent": null,
"shipping": null, "use_stripe_sdk": true}
```
...
conjunction with
[Prices](https://docs.stripe.com/api/confirmation_tokens/test_create#prices) to
...
[Products](https://docs.stripe.com/api/confirmation_tokens/test_create#products)
...
[subscriptions](https://docs.stripe.com/api/confirmation_tokens/test_create#subscriptions),
[invoices](https://docs.stripe.com/api/confirmation_tokens/test_create#invoices),
[checkout sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/confirmation_tokens/test_create#quotes),
and more. Coupons do not work with conventional one-off
[charges](https://docs.stripe.com/api/confirmation_tokens/test_create#create_charge)
...
[coupon](https://docs.stripe.com/api/confirmation_tokens/test_create#coupons).
...
[coupon](https://docs.stripe.com/api/confirmation_tokens/test_create#coupons) or
[promotion
code](https://docs.stripe.com/api/confirmation_tokens/test_create#promotion_codes).
...
items](https://docs.stripe.com/api/confirmation_tokens/test_create#invoiceitems),
...
API](https://docs.stripe.com/api/confirmation_tokens/test_create#prices). It
...
[Payout](https://docs.stripe.com/api/confirmation_tokens/test_create#payout_object)
...
[FinancialAccount’s](https://docs.stripe.com/api/confirmation_tokens/test_create#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/confirmation_tokens/test_create#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/confirmation_tokens/test_create#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/confirmation_tokens/test_create#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/confirmation_tokens/test_create#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/confirmation_tokens/test_create#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/confirmation_tokens/test_create#received_debits)
...
object](https://docs.stripe.com/api/confirmation_tokens/object)
- [Tokens](https://docs.stripe.com/api/tokens)
