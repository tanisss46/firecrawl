...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fpagination%2Fauto)
...
event](https://docs.stripe.com/api/pagination/auto#retrieve_event) or a [list of
events](https://docs.stripe.com/api/pagination/auto#list_events) from the API.
...
API](https://docs.stripe.com/api/pagination/auto#retrieve_event) for 30 days.
...
with the [create file](https://docs.stripe.com/api/pagination/auto#create_file)
...
query](https://docs.stripe.com/api/pagination/auto#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/pagination/auto#payment_intents) to
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/pagination/auto#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/pagination/auto#payment_intent_object-setup_future_usage)
...
conjunction with [Prices](https://docs.stripe.com/api/pagination/auto#prices) to
...
[Products](https://docs.stripe.com/api/pagination/auto#products) help you track
...
[subscriptions](https://docs.stripe.com/api/pagination/auto#subscriptions),
[invoices](https://docs.stripe.com/api/pagination/auto#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/pagination/auto#quotes), and more. Coupons
do not work with conventional one-off
[charges](https://docs.stripe.com/api/pagination/auto#create_charge) or [payment
...
[coupon](https://docs.stripe.com/api/pagination/auto#coupons). It can be used to
...
[coupon](https://docs.stripe.com/api/pagination/auto#coupons) or [promotion
code](https://docs.stripe.com/api/pagination/auto#promotion_codes). It contains
...
items](https://docs.stripe.com/api/pagination/auto#invoiceitems), and proration
...
API](https://docs.stripe.com/api/pagination/auto#prices). It replaces the Plans
...
of products. [Products](https://docs.stripe.com/api/pagination/auto#products)
...
[Payout](https://docs.stripe.com/api/pagination/auto#payout_object) object, with
...
[FinancialAccount’s](https://docs.stripe.com/api/pagination/auto#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/pagination/auto#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/pagination/auto#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/pagination/auto#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/pagination/auto#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/pagination/auto#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/pagination/auto#received_debits)
