# Collect tax in Angola

## Learn how to use Stripe Tax to calculate, collect, and report tax in Angola.

In Angola, Stripe only supports collecting VAT for electronic services. In
...
about your potential tax registration obligations in Angola. Stripe also
...
You must be a remote seller with no physical presence in Angola to collect this
tax on Stripe. In order to register to collect tax in Angola, you need to
appoint a tax representative in Angola.

After you’ve registered to collect tax in Angola, go to
[Registrations](https://dashboard.stripe.com/tax/registrations?location=ao) to
add your registrations to Stripe in the Dashboard. This turns on tax calculation
and collection in Stripe for your transactions in Angola.
...
You’re responsible for filing and remitting your taxes to Angola. Stripe doesn’t
...
- [Registrations](https://dashboard.stripe.com/tax/registrations?location=ao)
- [how to add your
registration](https://docs.stripe.com/tax/registering#track-your-registrations-in-the-tax-dashboard)
