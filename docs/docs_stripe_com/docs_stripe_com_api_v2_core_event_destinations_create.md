...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fv2%2Fcore%2Fevent_destinations%2Fcreate)
...
event](https://docs.stripe.com/api/v2/core/event_destinations/create#retrieve_event)
or a [list of
events](https://docs.stripe.com/api/v2/core/event_destinations/create#list_events)
...
API](https://docs.stripe.com/api/v2/core/event_destinations/create#retrieve_event)
for 30 days.
...
with the [create
file](https://docs.stripe.com/api/v2/core/event_destinations/create#create_file)
...
query](https://docs.stripe.com/api/v2/core/event_destinations/create#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/v2/core/event_destinations/create#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/v2/core/event_destinations/create#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/v2/core/event_destinations/create#payment_intent_object-setup_future_usage)
...
conjunction with
[Prices](https://docs.stripe.com/api/v2/core/event_destinations/create#prices)
...
[Products](https://docs.stripe.com/api/v2/core/event_destinations/create#products)
...
[subscriptions](https://docs.stripe.com/api/v2/core/event_destinations/create#subscriptions),
[invoices](https://docs.stripe.com/api/v2/core/event_destinations/create#invoices),
[checkout sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/v2/core/event_destinations/create#quotes),
and more. Coupons do not work with conventional one-off
[charges](https://docs.stripe.com/api/v2/core/event_destinations/create#create_charge)
...
[coupon](https://docs.stripe.com/api/v2/core/event_destinations/create#coupons).
...
[coupon](https://docs.stripe.com/api/v2/core/event_destinations/create#coupons)
or [promotion
code](https://docs.stripe.com/api/v2/core/event_destinations/create#promotion_codes).
...
items](https://docs.stripe.com/api/v2/core/event_destinations/create#invoiceitems),
...
API](https://docs.stripe.com/api/v2/core/event_destinations/create#prices). It
...
[Payout](https://docs.stripe.com/api/v2/core/event_destinations/create#payout_object)
...
[FinancialAccount’s](https://docs.stripe.com/api/v2/core/event_destinations/create#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/v2/core/event_destinations/create#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/v2/core/event_destinations/create#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/v2/core/event_destinations/create#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/v2/core/event_destinations/create#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/v2/core/event_destinations/create#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/v2/core/event_destinations/create#received_debits)
