...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fcustomers%2Fsearch)
...
error](https://docs.stripe.com/api/customers/search#errors) if create parameters
...
error](https://docs.stripe.com/api/customers/search#errors) if update parameters
...
error](https://docs.stripe.com/api/customers/search#errors).
...
event](https://docs.stripe.com/api/customers/search#retrieve_event) or a [list
of events](https://docs.stripe.com/api/customers/search#list_events) from the
...
API](https://docs.stripe.com/api/customers/search#retrieve_event) for 30 days.
...
with the [create file](https://docs.stripe.com/api/customers/search#create_file)
...
query](https://docs.stripe.com/api/customers/search#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/customers/search#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/customers/search#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/customers/search#payment_intent_object-setup_future_usage)
...
conjunction with [Prices](https://docs.stripe.com/api/customers/search#prices)
...
[Products](https://docs.stripe.com/api/customers/search#products) help you track
...
[subscriptions](https://docs.stripe.com/api/customers/search#subscriptions),
[invoices](https://docs.stripe.com/api/customers/search#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/customers/search#quotes), and more. Coupons
do not work with conventional one-off
[charges](https://docs.stripe.com/api/customers/search#create_charge) or
[payment intents](https://docs.stripe.com/api/payment_intents).
...
[coupon](https://docs.stripe.com/api/customers/search#coupons). It can be used
...
[coupon](https://docs.stripe.com/api/customers/search#coupons) or [promotion
code](https://docs.stripe.com/api/customers/search#promotion_codes). It contains
...
items](https://docs.stripe.com/api/customers/search#invoiceitems), and proration
...
API](https://docs.stripe.com/api/customers/search#prices). It replaces the Plans
...
of products. [Products](https://docs.stripe.com/api/customers/search#products)
...
[Payout](https://docs.stripe.com/api/customers/search#payout_object) object,
...
[FinancialAccount’s](https://docs.stripe.com/api/customers/search#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/customers/search#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/customers/search#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/customers/search#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/customers/search#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/customers/search#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/customers/search#received_debits)
