...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fbalance_transactions%2Fobject)
...
Raises [an
error](https://docs.stripe.com/api/balance_transactions/object#errors)
otherwise.
...
event](https://docs.stripe.com/api/balance_transactions/object#retrieve_event)
or a [list of
events](https://docs.stripe.com/api/balance_transactions/object#list_events)
...
API](https://docs.stripe.com/api/balance_transactions/object#retrieve_event) for
30 days.
...
with the [create
file](https://docs.stripe.com/api/balance_transactions/object#create_file)
...
query](https://docs.stripe.com/api/balance_transactions/object#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/balance_transactions/object#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/balance_transactions/object#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/balance_transactions/object#payment_intent_object-setup_future_usage)
...
conjunction with
[Prices](https://docs.stripe.com/api/balance_transactions/object#prices) to
...
[Products](https://docs.stripe.com/api/balance_transactions/object#products)
...
[subscriptions](https://docs.stripe.com/api/balance_transactions/object#subscriptions),
[invoices](https://docs.stripe.com/api/balance_transactions/object#invoices),
[checkout sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/balance_transactions/object#quotes), and
more. Coupons do not work with conventional one-off
[charges](https://docs.stripe.com/api/balance_transactions/object#create_charge)
...
[coupon](https://docs.stripe.com/api/balance_transactions/object#coupons). It
...
[coupon](https://docs.stripe.com/api/balance_transactions/object#coupons) or
[promotion
code](https://docs.stripe.com/api/balance_transactions/object#promotion_codes).
...
items](https://docs.stripe.com/api/balance_transactions/object#invoiceitems),
...
API](https://docs.stripe.com/api/balance_transactions/object#prices). It
...
[Payout](https://docs.stripe.com/api/balance_transactions/object#payout_object)
...
[FinancialAccount’s](https://docs.stripe.com/api/balance_transactions/object#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/balance_transactions/object#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/balance_transactions/object#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/balance_transactions/object#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/balance_transactions/object#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/balance_transactions/object#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/balance_transactions/object#received_debits)
