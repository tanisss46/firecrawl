...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fcharges%2Fretrieve)
...
error](https://docs.stripe.com/api/charges/retrieve#errors) if something goes
...
error](https://docs.stripe.com/api/charges/retrieve#errors) if update parameters
are invalid.
...
error](https://docs.stripe.com/api/charges/retrieve#errors) otherwise.
...
error](https://docs.stripe.com/api/charges/retrieve#errors).
...
event](https://docs.stripe.com/api/charges/retrieve#retrieve_event) or a [list
of events](https://docs.stripe.com/api/charges/retrieve#list_events) from the
...
API](https://docs.stripe.com/api/charges/retrieve#retrieve_event) for 30 days.
...
with the [create file](https://docs.stripe.com/api/charges/retrieve#create_file)
...
query](https://docs.stripe.com/api/charges/retrieve#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/charges/retrieve#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/charges/retrieve#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/charges/retrieve#payment_intent_object-setup_future_usage)
...
conjunction with [Prices](https://docs.stripe.com/api/charges/retrieve#prices)
...
[Products](https://docs.stripe.com/api/charges/retrieve#products) help you track
...
[subscriptions](https://docs.stripe.com/api/charges/retrieve#subscriptions),
[invoices](https://docs.stripe.com/api/charges/retrieve#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/charges/retrieve#quotes), and more. Coupons
do not work with conventional one-off
[charges](https://docs.stripe.com/api/charges/retrieve#create_charge) or
[payment intents](https://docs.stripe.com/api/payment_intents).
...
[coupon](https://docs.stripe.com/api/charges/retrieve#coupons). It can be used
...
[coupon](https://docs.stripe.com/api/charges/retrieve#coupons) or [promotion
code](https://docs.stripe.com/api/charges/retrieve#promotion_codes). It contains
...
items](https://docs.stripe.com/api/charges/retrieve#invoiceitems), and proration
...
API](https://docs.stripe.com/api/charges/retrieve#prices). It replaces the Plans
...
of products. [Products](https://docs.stripe.com/api/charges/retrieve#products)
...
[Payout](https://docs.stripe.com/api/charges/retrieve#payout_object) object,
...
[FinancialAccount’s](https://docs.stripe.com/api/charges/retrieve#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/charges/retrieve#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/charges/retrieve#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/charges/retrieve#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/charges/retrieve#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/charges/retrieve#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/charges/retrieve#received_debits)
