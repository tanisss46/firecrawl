# Collect tax in Czechia

## Learn how to use Stripe Tax to calculate, collect, and report tax in Czechia.

Czechia is part of the EU and applies the EU VAT rules. Read more about those
...
about your potential tax registration obligations in Czechia. Stripe also
notifies you with email and Dashboard alerts when you need to register to
collect tax. Learn more about how the [monitoring tool
works](https://docs.stripe.com/tax/monitoring).

You can read more about registration obligations in Czechia on the [European
...
schemes](https://vat-one-stop-shop.ec.europa.eu/contact-country/czech-republic_en)

After you’ve registered to collect tax in Czechia, go to
[Registrations](https://dashboard.stripe.com/tax/registrations?location=cz) to
add your registrations to Stripe in the Dashboard. This turns on tax calculation
and collection in Stripe for your transactions in Czechia.
...
Czechia applies the EU VAT rules. Learn more about [tax calculation in the
...
- [Domestic VAT registration](https://adisspr.mfcr.cz/pmd/home)
- [One-Stop Shop registration
schemes](https://vat-one-stop-shop.ec.europa.eu/contact-country/czech-republic_en)
- [Registrations](https://dashboard.stripe.com/tax/registrations?location=cz)
- [how to add your
registration](https://docs.stripe.com/tax/registering#track-your-registrations-in-the-tax-dashboard)
