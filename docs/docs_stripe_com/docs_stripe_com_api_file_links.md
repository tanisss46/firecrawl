...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Ffile_links)
...
event](https://docs.stripe.com/api/file_links#retrieve_event) or a [list of
events](https://docs.stripe.com/api/file_links#list_events) from the API. We
...
API](https://docs.stripe.com/api/file_links#retrieve_event) for 30 days.
...
with the [create file](https://docs.stripe.com/api/file_links#create_file)
...
query](https://docs.stripe.com/api/file_links#scheduled_queries)).
...
error](https://docs.stripe.com/api/file_links#errors) otherwise.
...
Stripe raises [an error](https://docs.stripe.com/api/file_links#errors).
...
[PaymentIntents](https://docs.stripe.com/api/file_links#payment_intents) to
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/file_links#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/file_links#payment_intent_object-setup_future_usage)
...
conjunction with [Prices](https://docs.stripe.com/api/file_links#prices) to
...
[Products](https://docs.stripe.com/api/file_links#products) help you track
...
[subscriptions](https://docs.stripe.com/api/file_links#subscriptions),
[invoices](https://docs.stripe.com/api/file_links#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/file_links#quotes), and more. Coupons do
not work with conventional one-off
[charges](https://docs.stripe.com/api/file_links#create_charge) or [payment
...
[coupon](https://docs.stripe.com/api/file_links#coupons). It can be used to
...
[coupon](https://docs.stripe.com/api/file_links#coupons) or [promotion
code](https://docs.stripe.com/api/file_links#promotion_codes). It contains
...
items](https://docs.stripe.com/api/file_links#invoiceitems), and proration
...
API](https://docs.stripe.com/api/file_links#prices). It replaces the Plans API
...
of products. [Products](https://docs.stripe.com/api/file_links#products) help
...
[Payout](https://docs.stripe.com/api/file_links#payout_object) object, with
...
[FinancialAccount’s](https://docs.stripe.com/api/file_links#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/file_links#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/file_links#financial_accounts) to
a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/file_links#outbound_payments)
...
[FinancialAccount](https://docs.stripe.com/api/file_links#financial_accounts).
To send money to an account belonging to the same user, use an
[OutboundTransfer](https://docs.stripe.com/api/file_links#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/file_links#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/file_links#received_debits)
