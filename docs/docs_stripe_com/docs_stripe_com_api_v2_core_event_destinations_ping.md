...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fv2%2Fcore%2Fevent_destinations%2Fping)
...
event](https://docs.stripe.com/api/v2/core/event_destinations/ping#retrieve_event)
or a [list of
events](https://docs.stripe.com/api/v2/core/event_destinations/ping#list_events)
...
API](https://docs.stripe.com/api/v2/core/event_destinations/ping#retrieve_event)
for 30 days.
...
with the [create
file](https://docs.stripe.com/api/v2/core/event_destinations/ping#create_file)
...
query](https://docs.stripe.com/api/v2/core/event_destinations/ping#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/v2/core/event_destinations/ping#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/v2/core/event_destinations/ping#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/v2/core/event_destinations/ping#payment_intent_object-setup_future_usage)
...
conjunction with
[Prices](https://docs.stripe.com/api/v2/core/event_destinations/ping#prices) to
...
[Products](https://docs.stripe.com/api/v2/core/event_destinations/ping#products)
...
[subscriptions](https://docs.stripe.com/api/v2/core/event_destinations/ping#subscriptions),
[invoices](https://docs.stripe.com/api/v2/core/event_destinations/ping#invoices),
[checkout sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/v2/core/event_destinations/ping#quotes),
and more. Coupons do not work with conventional one-off
[charges](https://docs.stripe.com/api/v2/core/event_destinations/ping#create_charge)
...
[coupon](https://docs.stripe.com/api/v2/core/event_destinations/ping#coupons).
...
[coupon](https://docs.stripe.com/api/v2/core/event_destinations/ping#coupons) or
[promotion
code](https://docs.stripe.com/api/v2/core/event_destinations/ping#promotion_codes).
...
items](https://docs.stripe.com/api/v2/core/event_destinations/ping#invoiceitems),
...
API](https://docs.stripe.com/api/v2/core/event_destinations/ping#prices). It
...
[Payout](https://docs.stripe.com/api/v2/core/event_destinations/ping#payout_object)
...
[FinancialAccount’s](https://docs.stripe.com/api/v2/core/event_destinations/ping#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/v2/core/event_destinations/ping#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/v2/core/event_destinations/ping#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/v2/core/event_destinations/ping#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/v2/core/event_destinations/ping#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/v2/core/event_destinations/ping#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/v2/core/event_destinations/ping#received_debits)
