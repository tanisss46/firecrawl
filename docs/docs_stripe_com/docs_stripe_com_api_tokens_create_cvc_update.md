...
raises [an error](https://docs.stripe.com/api/tokens/create_cvc_update#errors).
...
[an error](https://docs.stripe.com/api/tokens/create_cvc_update#errors).
...
[id_number](https://docs.stripe.com/api/tokens/create_cvc_update#update_account-individual-id_number)
or
[id_number_secondary](https://docs.stripe.com/api/tokens/create_cvc_update#update_account-individual-id_number_secondary)
...
error](https://docs.stripe.com/api/tokens/create_cvc_update#errors) otherwise.
...
conjunction with
[Prices](https://docs.stripe.com/api/tokens/create_cvc_update#prices) to
...
[Products](https://docs.stripe.com/api/tokens/create_cvc_update#products) help
...
[subscriptions](https://docs.stripe.com/api/tokens/create_cvc_update#subscriptions),
[invoices](https://docs.stripe.com/api/tokens/create_cvc_update#invoices),
[checkout sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/tokens/create_cvc_update#quotes), and more.
Coupons do not work with conventional one-off
[charges](https://docs.stripe.com/api/tokens/create_cvc_update#create_charge) or
...
[coupon](https://docs.stripe.com/api/tokens/create_cvc_update#coupons). It can
...
[coupon](https://docs.stripe.com/api/tokens/create_cvc_update#coupons) or
[promotion
code](https://docs.stripe.com/api/tokens/create_cvc_update#promotion_codes). It
...
items](https://docs.stripe.com/api/tokens/create_cvc_update#invoiceitems), and
...
API](https://docs.stripe.com/api/tokens/create_cvc_update#prices). It replaces
...
[Payout](https://docs.stripe.com/api/tokens/create_cvc_update#payout_object)
...
[FinancialAccount’s](https://docs.stripe.com/api/tokens/create_cvc_update#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/tokens/create_cvc_update#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/tokens/create_cvc_update#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/tokens/create_cvc_update#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/tokens/create_cvc_update#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/tokens/create_cvc_update#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/tokens/create_cvc_update#received_debits)
...
-
[Balance](https://docs.stripe.com/api/customers/object#customer_object-balance)
- [update customer API](https://docs.stripe.com/api/customers/update)
...
-
[GET/v1/subscriptions/search](https://docs.stripe.com/api/subscriptions/search)
-
