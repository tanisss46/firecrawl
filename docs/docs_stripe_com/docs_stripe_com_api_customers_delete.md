...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fcustomers%2Fdelete)
...
error](https://docs.stripe.com/api/customers/delete#errors) if create parameters
...
error](https://docs.stripe.com/api/customers/delete#errors) if update parameters
...
error](https://docs.stripe.com/api/customers/delete#errors).
...
event](https://docs.stripe.com/api/customers/delete#retrieve_event) or a [list
of events](https://docs.stripe.com/api/customers/delete#list_events) from the
...
API](https://docs.stripe.com/api/customers/delete#retrieve_event) for 30 days.
...
with the [create file](https://docs.stripe.com/api/customers/delete#create_file)
...
query](https://docs.stripe.com/api/customers/delete#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/customers/delete#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/customers/delete#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/customers/delete#payment_intent_object-setup_future_usage)
...
conjunction with [Prices](https://docs.stripe.com/api/customers/delete#prices)
...
[Products](https://docs.stripe.com/api/customers/delete#products) help you track
...
[subscriptions](https://docs.stripe.com/api/customers/delete#subscriptions),
[invoices](https://docs.stripe.com/api/customers/delete#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/customers/delete#quotes), and more. Coupons
do not work with conventional one-off
[charges](https://docs.stripe.com/api/customers/delete#create_charge) or
[payment intents](https://docs.stripe.com/api/payment_intents).
...
[coupon](https://docs.stripe.com/api/customers/delete#coupons). It can be used
...
[coupon](https://docs.stripe.com/api/customers/delete#coupons) or [promotion
code](https://docs.stripe.com/api/customers/delete#promotion_codes). It contains
...
items](https://docs.stripe.com/api/customers/delete#invoiceitems), and proration
...
API](https://docs.stripe.com/api/customers/delete#prices). It replaces the Plans
...
of products. [Products](https://docs.stripe.com/api/customers/delete#products)
...
[Payout](https://docs.stripe.com/api/customers/delete#payout_object) object,
...
[FinancialAccount’s](https://docs.stripe.com/api/customers/delete#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/customers/delete#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/customers/delete#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/customers/delete#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/customers/delete#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/customers/delete#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/customers/delete#received_debits)
