...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Ffile_links%2Fupdate)
...
event](https://docs.stripe.com/api/file_links/update#retrieve_event) or a [list
of events](https://docs.stripe.com/api/file_links/update#list_events) from the
...
API](https://docs.stripe.com/api/file_links/update#retrieve_event) for 30 days.
...
with the [create
file](https://docs.stripe.com/api/file_links/update#create_file) request (for
...
query](https://docs.stripe.com/api/file_links/update#scheduled_queries)).
...
error](https://docs.stripe.com/api/file_links/update#errors) otherwise.
...
Stripe raises [an error](https://docs.stripe.com/api/file_links/update#errors).
...
[PaymentIntents](https://docs.stripe.com/api/file_links/update#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/file_links/update#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/file_links/update#payment_intent_object-setup_future_usage)
...
conjunction with [Prices](https://docs.stripe.com/api/file_links/update#prices)
...
[Products](https://docs.stripe.com/api/file_links/update#products) help you
...
[subscriptions](https://docs.stripe.com/api/file_links/update#subscriptions),
[invoices](https://docs.stripe.com/api/file_links/update#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/file_links/update#quotes), and more.
Coupons do not work with conventional one-off
[charges](https://docs.stripe.com/api/file_links/update#create_charge) or
[payment intents](https://docs.stripe.com/api/payment_intents).
...
[coupon](https://docs.stripe.com/api/file_links/update#coupons). It can be used
...
[coupon](https://docs.stripe.com/api/file_links/update#coupons) or [promotion
code](https://docs.stripe.com/api/file_links/update#promotion_codes). It
...
items](https://docs.stripe.com/api/file_links/update#invoiceitems), and
...
API](https://docs.stripe.com/api/file_links/update#prices). It replaces the
...
of products. [Products](https://docs.stripe.com/api/file_links/update#products)
...
[Payout](https://docs.stripe.com/api/file_links/update#payout_object) object,
...
[FinancialAccount’s](https://docs.stripe.com/api/file_links/update#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/file_links/update#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/file_links/update#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/file_links/update#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/file_links/update#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/file_links/update#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/file_links/update#received_debits)
