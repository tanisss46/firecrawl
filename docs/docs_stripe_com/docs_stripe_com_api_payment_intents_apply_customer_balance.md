...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fpayment_intents%2Fapply_customer_balance)
...
event](https://docs.stripe.com/api/payment_intents/apply_customer_balance#retrieve_event)
or a [list of
events](https://docs.stripe.com/api/payment_intents/apply_customer_balance#list_events)
...
API](https://docs.stripe.com/api/payment_intents/apply_customer_balance#retrieve_event)
for 30 days.
...
with the [create
file](https://docs.stripe.com/api/payment_intents/apply_customer_balance#create_file)
...
query](https://docs.stripe.com/api/payment_intents/apply_customer_balance#scheduled_queries)).
...
If
[setup_future_usage](https://docs.stripe.com/api/payment_intents/apply_customer_balance#payment_intent_object-setup_future_usage)
...
intent](https://docs.stripe.com/api/payment_intents/apply_customer_balance#payment_intent_object)
...
[client_secret](https://docs.stripe.com/api/payment_intents/apply_customer_balance#payment_intent_object-client_secret).
...
[PaymentIntents](https://docs.stripe.com/api/payment_intents/apply_customer_balance#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/payment_intents/apply_customer_balance#setup_intent_object-customer),
...
conjunction with
[Prices](https://docs.stripe.com/api/payment_intents/apply_customer_balance#prices)
...
[Products](https://docs.stripe.com/api/payment_intents/apply_customer_balance#products)
...
[subscriptions](https://docs.stripe.com/api/payment_intents/apply_customer_balance#subscriptions),
[invoices](https://docs.stripe.com/api/payment_intents/apply_customer_balance#invoices),
[checkout sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/payment_intents/apply_customer_balance#quotes),
and more. Coupons do not work with conventional one-off
[charges](https://docs.stripe.com/api/payment_intents/apply_customer_balance#create_charge)
...
[coupon](https://docs.stripe.com/api/payment_intents/apply_customer_balance#coupons).
...
[coupon](https://docs.stripe.com/api/payment_intents/apply_customer_balance#coupons)
or [promotion
code](https://docs.stripe.com/api/payment_intents/apply_customer_balance#promotion_codes).
...
items](https://docs.stripe.com/api/payment_intents/apply_customer_balance#invoiceitems),
...
API](https://docs.stripe.com/api/payment_intents/apply_customer_balance#prices).
...
[Payout](https://docs.stripe.com/api/payment_intents/apply_customer_balance#payout_object)
...
[FinancialAccount’s](https://docs.stripe.com/api/payment_intents/apply_customer_balance#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/payment_intents/apply_customer_balance#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/payment_intents/apply_customer_balance#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/payment_intents/apply_customer_balance#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/payment_intents/apply_customer_balance#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/payment_intents/apply_customer_balance#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/payment_intents/apply_customer_balance#received_debits)
