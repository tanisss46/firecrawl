...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Frefunds)
...
event](https://docs.stripe.com/api/refunds#retrieve_event) or a [list of
events](https://docs.stripe.com/api/refunds#list_events) from the API. We also
...
API](https://docs.stripe.com/api/refunds#retrieve_event) for 30 days.
...
with the [create file](https://docs.stripe.com/api/refunds#create_file) request
...
query](https://docs.stripe.com/api/refunds#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/refunds#payment_intents) to drive
the payment flow.
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/refunds#setup_intent_object-customer), it
...
[setup_future_usage](https://docs.stripe.com/api/refunds#payment_intent_object-setup_future_usage)
...
error](https://docs.stripe.com/api/refunds#errors) if the Charge/PaymentIntent
has already been refunded, or if an invalid identifier was provided.

POST /v1/refundsServer-side languageStripe CLIcURL.NETGoJavaNode.jsPHPPythonRuby
```
...
error](https://docs.stripe.com/api/refunds#errors) if update parameters are
invalid.
...
error](https://docs.stripe.com/api/refunds#errors) otherwise.
...
error](https://docs.stripe.com/api/refunds#errors).
...
error](https://docs.stripe.com/api/refunds#errors) if you can’t cancel the
refund.
...
conjunction with [Prices](https://docs.stripe.com/api/refunds#prices) to
...
[Products](https://docs.stripe.com/api/refunds#products) help you track
...
[subscriptions](https://docs.stripe.com/api/refunds#subscriptions),
[invoices](https://docs.stripe.com/api/refunds#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/refunds#quotes), and more. Coupons do not
work with conventional one-off
[charges](https://docs.stripe.com/api/refunds#create_charge) or [payment
...
[coupon](https://docs.stripe.com/api/refunds#coupons). It can be used to create
...
[coupon](https://docs.stripe.com/api/refunds#coupons) or [promotion
code](https://docs.stripe.com/api/refunds#promotion_codes). It contains
...
They contain [invoice items](https://docs.stripe.com/api/refunds#invoiceitems),
...
API](https://docs.stripe.com/api/refunds#prices). It replaces the Plans API and
...
of products. [Products](https://docs.stripe.com/api/refunds#products) help you
...
[Payout](https://docs.stripe.com/api/refunds#payout_object) object, with
...
[FinancialAccount’s](https://docs.stripe.com/api/refunds#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/refunds#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/refunds#financial_accounts) to a
PaymentMethod belonging to the same entity. To send funds to a different party,
use [OutboundPayments](https://docs.stripe.com/api/refunds#outbound_payments)
...
[FinancialAccount](https://docs.stripe.com/api/refunds#financial_accounts). To
send money to an account belonging to the same user, use an
[OutboundTransfer](https://docs.stripe.com/api/refunds#outbound_transfers).
...
[FinancialAccount](https://docs.stripe.com/api/refunds#financial_accounts) via a
...
[FinancialAccount](https://docs.stripe.com/api/refunds#financial_accounts) (for
...
[FinancialAccount](https://docs.stripe.com/api/refunds#financial_accounts).
...
[ReceivedCredits](https://docs.stripe.com/api/refunds#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/refunds#received_debits) depending
...
- [block lists](https://docs.stripe.com/radar/lists)
- [Confirmation Token](https://docs.stripe.com/api/confirmation_tokens)
- [Finalize payments on the
server](https://docs.stripe.com/payments/finalize-payments-on-the-server)
- [Build two-step
