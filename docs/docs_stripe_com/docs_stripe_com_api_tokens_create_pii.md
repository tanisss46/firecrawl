...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Ftokens%2Fcreate_pii)
...
event](https://docs.stripe.com/api/tokens/create_pii#retrieve_event) or a [list
of events](https://docs.stripe.com/api/tokens/create_pii#list_events) from the
...
API](https://docs.stripe.com/api/tokens/create_pii#retrieve_event) for 30 days.
...
with the [create
file](https://docs.stripe.com/api/tokens/create_pii#create_file) request (for
...
query](https://docs.stripe.com/api/tokens/create_pii#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/tokens/create_pii#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/tokens/create_pii#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/tokens/create_pii#payment_intent_object-setup_future_usage)
...
raises [an error](https://docs.stripe.com/api/tokens/create_pii#errors).
...
account](https://docs.stripe.com/api/tokens/create_pii#accounts) where
...
object](https://docs.stripe.com/api/tokens/create_pii#create_charge) or by
attaching them to a [Customer
object](https://docs.stripe.com/api/tokens/create_pii#create_customer).
...
[an error](https://docs.stripe.com/api/tokens/create_pii#errors).
...
[id_number](https://docs.stripe.com/api/tokens/create_pii#update_account-individual-id_number)
or
[id_number_secondary](https://docs.stripe.com/api/tokens/create_pii#update_account-individual-id_number_secondary)
...
error](https://docs.stripe.com/api/tokens/create_pii#errors) otherwise.
...
conjunction with [Prices](https://docs.stripe.com/api/tokens/create_pii#prices)
...
[Products](https://docs.stripe.com/api/tokens/create_pii#products) help you
...
[subscriptions](https://docs.stripe.com/api/tokens/create_pii#subscriptions),
[invoices](https://docs.stripe.com/api/tokens/create_pii#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/tokens/create_pii#quotes), and more.
Coupons do not work with conventional one-off
[charges](https://docs.stripe.com/api/tokens/create_pii#create_charge) or
[payment intents](https://docs.stripe.com/api/payment_intents).
...
[coupon](https://docs.stripe.com/api/tokens/create_pii#coupons). It can be used
...
[coupon](https://docs.stripe.com/api/tokens/create_pii#coupons) or [promotion
code](https://docs.stripe.com/api/tokens/create_pii#promotion_codes). It
...
items](https://docs.stripe.com/api/tokens/create_pii#invoiceitems), and
...
API](https://docs.stripe.com/api/tokens/create_pii#prices). It replaces the
...
of products. [Products](https://docs.stripe.com/api/tokens/create_pii#products)
...
[Payout](https://docs.stripe.com/api/tokens/create_pii#payout_object) object,
...
[FinancialAccount’s](https://docs.stripe.com/api/tokens/create_pii#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/tokens/create_pii#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/tokens/create_pii#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/tokens/create_pii#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/tokens/create_pii#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/tokens/create_pii#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/tokens/create_pii#received_debits)
