...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Frefunds%2Fcreate)
...
event](https://docs.stripe.com/api/refunds/create#retrieve_event) or a [list of
events](https://docs.stripe.com/api/refunds/create#list_events) from the API. We
...
API](https://docs.stripe.com/api/refunds/create#retrieve_event) for 30 days.
...
with the [create file](https://docs.stripe.com/api/refunds/create#create_file)
...
query](https://docs.stripe.com/api/refunds/create#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/refunds/create#payment_intents) to
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/refunds/create#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/refunds/create#payment_intent_object-setup_future_usage)
...
error](https://docs.stripe.com/api/refunds/create#errors) if the
...
error](https://docs.stripe.com/api/refunds/create#errors) if update parameters
are invalid.
...
error](https://docs.stripe.com/api/refunds/create#errors) otherwise.
...
error](https://docs.stripe.com/api/refunds/create#errors).
...
error](https://docs.stripe.com/api/refunds/create#errors) if you can’t cancel
the refund.
...
conjunction with [Prices](https://docs.stripe.com/api/refunds/create#prices) to
...
[Products](https://docs.stripe.com/api/refunds/create#products) help you track
...
[subscriptions](https://docs.stripe.com/api/refunds/create#subscriptions),
[invoices](https://docs.stripe.com/api/refunds/create#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/refunds/create#quotes), and more. Coupons
do not work with conventional one-off
[charges](https://docs.stripe.com/api/refunds/create#create_charge) or [payment
...
[coupon](https://docs.stripe.com/api/refunds/create#coupons). It can be used to
...
[coupon](https://docs.stripe.com/api/refunds/create#coupons) or [promotion
code](https://docs.stripe.com/api/refunds/create#promotion_codes). It contains
...
items](https://docs.stripe.com/api/refunds/create#invoiceitems), and proration
...
API](https://docs.stripe.com/api/refunds/create#prices). It replaces the Plans
...
of products. [Products](https://docs.stripe.com/api/refunds/create#products)
...
[Payout](https://docs.stripe.com/api/refunds/create#payout_object) object, with
...
[FinancialAccount’s](https://docs.stripe.com/api/refunds/create#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/refunds/create#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/refunds/create#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/refunds/create#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/refunds/create#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/refunds/create#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/refunds/create#received_debits)
