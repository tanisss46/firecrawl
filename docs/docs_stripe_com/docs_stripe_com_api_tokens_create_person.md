...
[an error](https://docs.stripe.com/api/tokens/create_person#errors).
...
[id_number](https://docs.stripe.com/api/tokens/create_person#update_account-individual-id_number)
or
[id_number_secondary](https://docs.stripe.com/api/tokens/create_person#update_account-individual-id_number_secondary)
...
error](https://docs.stripe.com/api/tokens/create_person#errors) otherwise.
...
conjunction with
[Prices](https://docs.stripe.com/api/tokens/create_person#prices) to configure
...
[Products](https://docs.stripe.com/api/tokens/create_person#products) help you
...
[subscriptions](https://docs.stripe.com/api/tokens/create_person#subscriptions),
[invoices](https://docs.stripe.com/api/tokens/create_person#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/tokens/create_person#quotes), and more.
Coupons do not work with conventional one-off
[charges](https://docs.stripe.com/api/tokens/create_person#create_charge) or
...
[coupon](https://docs.stripe.com/api/tokens/create_person#coupons). It can be
...
[coupon](https://docs.stripe.com/api/tokens/create_person#coupons) or [promotion
code](https://docs.stripe.com/api/tokens/create_person#promotion_codes). It
...
items](https://docs.stripe.com/api/tokens/create_person#invoiceitems), and
...
API](https://docs.stripe.com/api/tokens/create_person#prices). It replaces the
...
[Payout](https://docs.stripe.com/api/tokens/create_person#payout_object) object,
...
[FinancialAccount’s](https://docs.stripe.com/api/tokens/create_person#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/tokens/create_person#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/tokens/create_person#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/tokens/create_person#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/tokens/create_person#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/tokens/create_person#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/tokens/create_person#received_debits)
