...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Ffiles%2Flist)
...
event](https://docs.stripe.com/api/files/list#retrieve_event) or a [list of
events](https://docs.stripe.com/api/files/list#list_events) from the API. We
...
API](https://docs.stripe.com/api/files/list#retrieve_event) for 30 days.
...
with the [create file](https://docs.stripe.com/api/files/list#create_file)
...
query](https://docs.stripe.com/api/files/list#scheduled_queries)).
...
raises [an error](https://docs.stripe.com/api/files/list#errors).
...
[PaymentIntents](https://docs.stripe.com/api/files/list#payment_intents) to
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/files/list#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/files/list#payment_intent_object-setup_future_usage)
...
conjunction with [Prices](https://docs.stripe.com/api/files/list#prices) to
...
[Products](https://docs.stripe.com/api/files/list#products) help you track
...
[subscriptions](https://docs.stripe.com/api/files/list#subscriptions),
[invoices](https://docs.stripe.com/api/files/list#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/files/list#quotes), and more. Coupons do
not work with conventional one-off
[charges](https://docs.stripe.com/api/files/list#create_charge) or [payment
...
[coupon](https://docs.stripe.com/api/files/list#coupons). It can be used to
...
[coupon](https://docs.stripe.com/api/files/list#coupons) or [promotion
code](https://docs.stripe.com/api/files/list#promotion_codes). It contains
...
items](https://docs.stripe.com/api/files/list#invoiceitems), and proration
...
API](https://docs.stripe.com/api/files/list#prices). It replaces the Plans API
...
of products. [Products](https://docs.stripe.com/api/files/list#products) help
...
[Payout](https://docs.stripe.com/api/files/list#payout_object) object, with
...
[FinancialAccount’s](https://docs.stripe.com/api/files/list#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/files/list#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/files/list#financial_accounts) to
a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/files/list#outbound_payments)
...
[FinancialAccount](https://docs.stripe.com/api/files/list#financial_accounts).
To send money to an account belonging to the same user, use an
[OutboundTransfer](https://docs.stripe.com/api/files/list#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/files/list#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/files/list#received_debits)
