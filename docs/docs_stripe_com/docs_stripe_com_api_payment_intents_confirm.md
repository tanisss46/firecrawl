...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fpayment_intents%2Fconfirm)
...
event](https://docs.stripe.com/api/payment_intents/confirm#retrieve_event) or a
[list of
events](https://docs.stripe.com/api/payment_intents/confirm#list_events) from
...
API](https://docs.stripe.com/api/payment_intents/confirm#retrieve_event) for 30
days.
...
with the [create
file](https://docs.stripe.com/api/payment_intents/confirm#create_file) request
...
query](https://docs.stripe.com/api/payment_intents/confirm#scheduled_queries)).
...
If
[setup_future_usage](https://docs.stripe.com/api/payment_intents/confirm#payment_intent_object-setup_future_usage)
...
intent](https://docs.stripe.com/api/payment_intents/confirm#payment_intent_object)
...
[client_secret](https://docs.stripe.com/api/payment_intents/confirm#payment_intent_object-client_secret).
...
[PaymentIntents](https://docs.stripe.com/api/payment_intents/confirm#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/payment_intents/confirm#setup_intent_object-customer),
...
conjunction with
[Prices](https://docs.stripe.com/api/payment_intents/confirm#prices) to
...
[Products](https://docs.stripe.com/api/payment_intents/confirm#products) help
...
[subscriptions](https://docs.stripe.com/api/payment_intents/confirm#subscriptions),
[invoices](https://docs.stripe.com/api/payment_intents/confirm#invoices),
[checkout sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/payment_intents/confirm#quotes), and more.
Coupons do not work with conventional one-off
[charges](https://docs.stripe.com/api/payment_intents/confirm#create_charge) or
[payment intents](https://docs.stripe.com/api/payment_intents).
...
[coupon](https://docs.stripe.com/api/payment_intents/confirm#coupons). It can be
...
[coupon](https://docs.stripe.com/api/payment_intents/confirm#coupons) or
[promotion
code](https://docs.stripe.com/api/payment_intents/confirm#promotion_codes). It
...
items](https://docs.stripe.com/api/payment_intents/confirm#invoiceitems), and
...
API](https://docs.stripe.com/api/payment_intents/confirm#prices). It replaces
...
[Payout](https://docs.stripe.com/api/payment_intents/confirm#payout_object)
...
[FinancialAccount’s](https://docs.stripe.com/api/payment_intents/confirm#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/payment_intents/confirm#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/payment_intents/confirm#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/payment_intents/confirm#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/payment_intents/confirm#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/payment_intents/confirm#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/payment_intents/confirm#received_debits)
