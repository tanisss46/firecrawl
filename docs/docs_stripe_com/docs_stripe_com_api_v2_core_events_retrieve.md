...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fv2%2Fcore%2Fevents%2Fretrieve)
...
event](https://docs.stripe.com/api/v2/core/events/retrieve#retrieve_event) or a
[list of
events](https://docs.stripe.com/api/v2/core/events/retrieve#list_events) from
...
API](https://docs.stripe.com/api/v2/core/events/retrieve#retrieve_event) for 30
days.
...
with the [create
file](https://docs.stripe.com/api/v2/core/events/retrieve#create_file) request
...
query](https://docs.stripe.com/api/v2/core/events/retrieve#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/v2/core/events/retrieve#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/v2/core/events/retrieve#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/v2/core/events/retrieve#payment_intent_object-setup_future_usage)
...
conjunction with
[Prices](https://docs.stripe.com/api/v2/core/events/retrieve#prices) to
...
[Products](https://docs.stripe.com/api/v2/core/events/retrieve#products) help
...
[subscriptions](https://docs.stripe.com/api/v2/core/events/retrieve#subscriptions),
[invoices](https://docs.stripe.com/api/v2/core/events/retrieve#invoices),
[checkout sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/v2/core/events/retrieve#quotes), and more.
Coupons do not work with conventional one-off
[charges](https://docs.stripe.com/api/v2/core/events/retrieve#create_charge) or
[payment intents](https://docs.stripe.com/api/payment_intents).
...
[coupon](https://docs.stripe.com/api/v2/core/events/retrieve#coupons). It can be
...
[coupon](https://docs.stripe.com/api/v2/core/events/retrieve#coupons) or
[promotion
code](https://docs.stripe.com/api/v2/core/events/retrieve#promotion_codes). It
...
items](https://docs.stripe.com/api/v2/core/events/retrieve#invoiceitems), and
...
API](https://docs.stripe.com/api/v2/core/events/retrieve#prices). It replaces
...
[Payout](https://docs.stripe.com/api/v2/core/events/retrieve#payout_object)
...
[FinancialAccount’s](https://docs.stripe.com/api/v2/core/events/retrieve#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/v2/core/events/retrieve#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/v2/core/events/retrieve#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/v2/core/events/retrieve#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/v2/core/events/retrieve#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/v2/core/events/retrieve#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/v2/core/events/retrieve#received_debits)
