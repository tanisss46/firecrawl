...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fpayment_intents%2Fsearch)
...
event](https://docs.stripe.com/api/payment_intents/search#retrieve_event) or a
[list of events](https://docs.stripe.com/api/payment_intents/search#list_events)
...
API](https://docs.stripe.com/api/payment_intents/search#retrieve_event) for 30
days.
...
with the [create
file](https://docs.stripe.com/api/payment_intents/search#create_file) request
...
query](https://docs.stripe.com/api/payment_intents/search#scheduled_queries)).
...
If
[setup_future_usage](https://docs.stripe.com/api/payment_intents/search#payment_intent_object-setup_future_usage)
...
intent](https://docs.stripe.com/api/payment_intents/search#payment_intent_object)
...
[client_secret](https://docs.stripe.com/api/payment_intents/search#payment_intent_object-client_secret).
...
[PaymentIntents](https://docs.stripe.com/api/payment_intents/search#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/payment_intents/search#setup_intent_object-customer),
...
conjunction with
[Prices](https://docs.stripe.com/api/payment_intents/search#prices) to configure
...
[Products](https://docs.stripe.com/api/payment_intents/search#products) help you
...
[subscriptions](https://docs.stripe.com/api/payment_intents/search#subscriptions),
[invoices](https://docs.stripe.com/api/payment_intents/search#invoices),
[checkout sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/payment_intents/search#quotes), and more.
Coupons do not work with conventional one-off
[charges](https://docs.stripe.com/api/payment_intents/search#create_charge) or
[payment intents](https://docs.stripe.com/api/payment_intents).
...
[coupon](https://docs.stripe.com/api/payment_intents/search#coupons). It can be
...
[coupon](https://docs.stripe.com/api/payment_intents/search#coupons) or
[promotion
code](https://docs.stripe.com/api/payment_intents/search#promotion_codes). It
...
items](https://docs.stripe.com/api/payment_intents/search#invoiceitems), and
...
API](https://docs.stripe.com/api/payment_intents/search#prices). It replaces the
...
[Payout](https://docs.stripe.com/api/payment_intents/search#payout_object)
...
[FinancialAccount’s](https://docs.stripe.com/api/payment_intents/search#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/payment_intents/search#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/payment_intents/search#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/payment_intents/search#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/payment_intents/search#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/payment_intents/search#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/payment_intents/search#received_debits)
