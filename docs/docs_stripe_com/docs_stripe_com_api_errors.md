...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Ferrors)
...
event](https://docs.stripe.com/api/errors#retrieve_event) or a [list of
events](https://docs.stripe.com/api/errors#list_events) from the API. We also
...
API](https://docs.stripe.com/api/errors#retrieve_event) for 30 days.
...
with the [create file](https://docs.stripe.com/api/errors#create_file) request
...
query](https://docs.stripe.com/api/errors#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/errors#payment_intents) to drive
the payment flow.
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/errors#setup_intent_object-customer), it
...
[setup_future_usage](https://docs.stripe.com/api/errors#payment_intent_object-setup_future_usage)
...
conjunction with [Prices](https://docs.stripe.com/api/errors#prices) to
...
[Products](https://docs.stripe.com/api/errors#products) help you track inventory
...
[subscriptions](https://docs.stripe.com/api/errors#subscriptions),
[invoices](https://docs.stripe.com/api/errors#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/errors#quotes), and more. Coupons do not
work with conventional one-off
[charges](https://docs.stripe.com/api/errors#create_charge) or [payment
...
[coupon](https://docs.stripe.com/api/errors#coupons). It can be used to create
...
[coupon](https://docs.stripe.com/api/errors#coupons) or [promotion
code](https://docs.stripe.com/api/errors#promotion_codes). It contains
...
They contain [invoice items](https://docs.stripe.com/api/errors#invoiceitems),
...
API](https://docs.stripe.com/api/errors#prices). It replaces the Plans API and
...
of products. [Products](https://docs.stripe.com/api/errors#products) help you
...
[Payout](https://docs.stripe.com/api/errors#payout_object) object, with
...
[FinancialAccount’s](https://docs.stripe.com/api/errors#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/errors#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/errors#financial_accounts) to a
PaymentMethod belonging to the same entity. To send funds to a different party,
use [OutboundPayments](https://docs.stripe.com/api/errors#outbound_payments)
...
[FinancialAccount](https://docs.stripe.com/api/errors#financial_accounts). To
send money to an account belonging to the same user, use an
[OutboundTransfer](https://docs.stripe.com/api/errors#outbound_transfers).
...
[FinancialAccount](https://docs.stripe.com/api/errors#financial_accounts) via a
...
[FinancialAccount](https://docs.stripe.com/api/errors#financial_accounts) (for
...
[FinancialAccount](https://docs.stripe.com/api/errors#financial_accounts). These
...
[ReceivedCredits](https://docs.stripe.com/api/errors#received_credits) depending
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/errors#received_debits) depending
