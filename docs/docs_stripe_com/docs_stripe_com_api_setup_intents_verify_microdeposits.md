...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fsetup_intents%2Fverify_microdeposits)
...
event](https://docs.stripe.com/api/setup_intents/verify_microdeposits#retrieve_event)
or a [list of
events](https://docs.stripe.com/api/setup_intents/verify_microdeposits#list_events)
...
API](https://docs.stripe.com/api/setup_intents/verify_microdeposits#retrieve_event)
for 30 days.
...
with the [create
file](https://docs.stripe.com/api/setup_intents/verify_microdeposits#create_file)
...
query](https://docs.stripe.com/api/setup_intents/verify_microdeposits#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/setup_intents/verify_microdeposits#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/setup_intents/verify_microdeposits#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/setup_intents/verify_microdeposits#payment_intent_object-setup_future_usage)
...
your customer to continue payment setup.
...
Possible enum
values`canceled``processing``requires_action``requires_confirmation``requires_payment_method``succeeded`
...
```
{ "id": "seti_1Mm8s8LkdIwHu7ix0OXBfTRG", "object": "setup_intent",
"application": null, "cancellation_reason": null, "client_secret":
"seti_1Mm8s8LkdIwHu7ix0OXBfTRG_secret_NXDICkPqPeiBTAFqWmkbff09lRmSVXe",
"created": 1678942624, "customer": null, "description": null, "flow_directions":
null, "last_setup_error": null, "latest_attempt": null, "livemode": false,
"mandate": null, "metadata": {}, "next_action": null, "on_behalf_of": null,
"payment_method": null, "payment_method_options": { "card": { "mandate_options":
null, "network": null, "request_three_d_secure": "automatic" } },
"payment_method_types": [ "card" ], "single_use_mandate": null, "status":
"requires_payment_method", "usage": "off_session"}
```
...
[confirm](https://docs.stripe.com/api/setup_intents/confirm) it to collect any
...
When you enable this parameter, this SetupIntent accepts payment methods that
you enable in the Dashboard and that are compatible with its other parameters.
...
ID of the payment method (a PaymentMethod, Card, or saved Source object) to
...
`on_session`
Use `on_session` if you intend to only reuse the payment method when the
customer is in your checkout flow.
...
POST /v1/setup_intentsServer-side languageStripe
CLIcURL.NETGoJavaNode.jsPHPPythonRuby
```
...
ID of the payment method (a PaymentMethod, Card, or saved Source object) to
attach to this SetupIntent. To unset this field to null, pass in an empty
string.
...
POST /v1/setup_intents/:idServer-side languageStripe
CLIcURL.NETGoJavaNode.jsPHPPythonRuby
```
curl https://api.stripe.com/v1/setup_intents/seti_1Mm8s8LkdIwHu7ix0OXBfTRG \ -u
"sk_test_BQokikJ...2HlWgH4olfQ2sk_test_BQokikJOvBiI2HlWgH4olfQ2:" \ -d
"metadata[order_id]"=6735
```
...
"created": 1678942624, "customer": null, "description": null, "flow_directions":
null, "last_setup_error": null, "latest_attempt": null, "livemode": false,
"mandate": null, "metadata": { "order_id": "6735" }, "next_action": null,
"on_behalf_of": null, "payment_method": null, "payment_method_options": {
"card": { "mandate_options": null, "network": null, "request_three_d_secure":
"automatic" } }, "payment_method_types": [ "card" ], "single_use_mandate": null,
...
returned. Please refer to the
[SetupIntent](https://docs.stripe.com/api/setup_intents/verify_microdeposits#setup_intent_object)
...
The client secret of the SetupIntent. We require this string if you use a
publishable key to retrieve the SetupIntent.

### Returns

Returns a SetupIntent if a valid identifier was provided.

GET /v1/setup_intents/:idServer-side languageStripe
CLIcURL.NETGoJavaNode.jsPHPPythonRuby
```
curl https://api.stripe.com/v1/setup_intents/seti_1Mm8s8LkdIwHu7ix0OXBfTRG \ -u
...
SetupIntents, starting after SetupIntent `starting_after`. Each entry in the
array is a separate SetupIntent object. If no more SetupIntents are available,
the resulting array will be empty.

GET /v1/setup_intentsServer-side languageStripe
CLIcURL.NETGoJavaNode.jsPHPPythonRuby
```
curl -G https://api.stripe.com/v1/setup_intents \ -u
...
"id": "seti_1Mm8s8LkdIwHu7ix0OXBfTRG", "object": "setup_intent", "application":
null, "cancellation_reason": null, "client_secret":
"seti_1Mm8s8LkdIwHu7ix0OXBfTRG_secret_NXDICkPqPeiBTAFqWmkbff09lRmSVXe",
"created": 1678942624, "customer": null, "description": null, "flow_directions":
null, "last_setup_error": null, "latest_attempt": null, "livemode": false,
"mandate": null, "metadata": {}, "next_action": null, "on_behalf_of": null,
...
fail with an error. You can’t cancel the SetupIntent for a Checkout Session.
[Expire the Checkout
...
Returns a SetupIntent object if the cancellation succeeds. Returns an error if
the SetupIntent is already canceled or isn’t in a cancelable state.

POST /v1/setup_intents/:id/cancelServer-side languageStripe
CLIcURL.NETGoJavaNode.jsPHPPythonRuby
```
curl -X POST
https://api.stripe.com/v1/setup_intents/seti_1Mm8s8LkdIwHu7ix0OXBfTRG/cancel \
...
POST /v1/setup_intents/:id/confirmServer-side languageStripe
CLIcURL.NETGoJavaNode.jsPHPPythonRuby
```
curl
https://api.stripe.com/v1/setup_intents/seti_1Mm2cBLkdIwHu7ixaiKW3ElR/confirm \
...
Response
```
{ "id": "seti_1Mm2cBLkdIwHu7ixaiKW3ElR", "object": "setup_intent",
"application": null, "cancellation_reason": null, "client_secret":
"seti_1Mm2cBLkdIwHu7ixaiKW3ElR_secret_NX6phB7HbSmlkpqzKZ3Bxr7uXFRf9Jg",
"created": 1678918571, "customer": null, "description": null, "flow_directions":
null, "last_setup_error": null, "latest_attempt":
"setatt_1Mm2cBLkdIwHu7ixdEp1VkXJ", "livemode": false, "mandate": null,
"metadata": {}, "next_action": null, "on_behalf_of": null, "payment_method":
"pm_1Mm2cBLkdIwHu7ixGoOfZSsV", "payment_method_options": { "card": {
"mandate_options": null, "network": null, "request_three_d_secure": "automatic"
} }, "payment_method_types": [ "card" ], "single_use_mandate": null, "status":
"succeeded", "usage": "off_session"}
```

# [Verify microdeposits on a SetupIntent](https://docs.stripe.com/api/setup_intents/verify_microdeposits)
...
POST /v1/setup_intents/:id/verify_microdepositsServer-side languageStripe
CLIcURL.NETGoJavaNode.jsPHPPythonRuby
```
curl
https://api.stripe.com/v1/setup_intents/seti_1Mm5yZLkdIwHu7ixm0sPzrx4/verify_microdeposits
\ -u "sk_test_BQokikJ...2HlWgH4olfQ2sk_test_BQokikJOvBiI2HlWgH4olfQ2:" \ -d
...
Response
```
{ "id": "seti_1Mm5yZLkdIwHu7ixm0sPzrx4", "object": "setup_intent",
"application": null, "cancellation_reason": null, "client_secret":
"seti_1Mm5yZLkdIwHu7ixm0sPzrx4_secret_NXAJ5iPM38ITW1pI7o8VZZhoZyDrrWR",
"created": 1678931491, "customer": null, "description": null, "flow_directions":
null, "last_setup_error": null, "latest_attempt":
"setatt_1Mm5yZLkdIwHu7ix7QtOkLAu", "livemode": false, "mandate":
"mandate_1Mm5yaLkdIwHu7ixmNoLkKLC", "metadata": {}, "next_action": null,
"on_behalf_of": null, "payment_method": "pm_1Mm5yZLkdIwHu7ixf89jW57b",
"payment_method_options": { "acss_debit": { "currency": "cad",
"mandate_options": { "interval_description": "First of every month",
"payment_schedule": "interval", "transaction_type": "personal" },
"verification_method": "automatic" } }, "payment_method_types": [ "acss_debit"
], "single_use_mandate": null, "status": "succeeded", "usage": "off_session"}
```
...
conjunction with
[Prices](https://docs.stripe.com/api/setup_intents/verify_microdeposits#prices)
...
[Products](https://docs.stripe.com/api/setup_intents/verify_microdeposits#products)
...
[subscriptions](https://docs.stripe.com/api/setup_intents/verify_microdeposits#subscriptions),
[invoices](https://docs.stripe.com/api/setup_intents/verify_microdeposits#invoices),
[checkout sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/setup_intents/verify_microdeposits#quotes),
and more. Coupons do not work with conventional one-off
[charges](https://docs.stripe.com/api/setup_intents/verify_microdeposits#create_charge)
...
[coupon](https://docs.stripe.com/api/setup_intents/verify_microdeposits#coupons).
...
[coupon](https://docs.stripe.com/api/setup_intents/verify_microdeposits#coupons)
or [promotion
code](https://docs.stripe.com/api/setup_intents/verify_microdeposits#promotion_codes).
...
items](https://docs.stripe.com/api/setup_intents/verify_microdeposits#invoiceitems),
...
API](https://docs.stripe.com/api/setup_intents/verify_microdeposits#prices). It
...
[Payout](https://docs.stripe.com/api/setup_intents/verify_microdeposits#payout_object)
...
[FinancialAccount’s](https://docs.stripe.com/api/setup_intents/verify_microdeposits#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/setup_intents/verify_microdeposits#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/setup_intents/verify_microdeposits#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/setup_intents/verify_microdeposits#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/setup_intents/verify_microdeposits#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/setup_intents/verify_microdeposits#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/setup_intents/verify_microdeposits#received_debits)
...
[generated_card](https://docs.stripe.com/api/setup_attempts/object#setup_attempt_object-payment_method_details-card_present-generated_card)
- [Expire the Checkout
Session](https://docs.stripe.com/api/checkout/sessions/expire)
- [Setup Attempts](https://docs.stripe.com/api/setup_attempts)
