...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fpayment_intents%2Fcapture)
...
event](https://docs.stripe.com/api/payment_intents/capture#retrieve_event) or a
[list of
events](https://docs.stripe.com/api/payment_intents/capture#list_events) from
...
API](https://docs.stripe.com/api/payment_intents/capture#retrieve_event) for 30
days.
...
with the [create
file](https://docs.stripe.com/api/payment_intents/capture#create_file) request
...
query](https://docs.stripe.com/api/payment_intents/capture#scheduled_queries)).
...
If
[setup_future_usage](https://docs.stripe.com/api/payment_intents/capture#payment_intent_object-setup_future_usage)
...
intent](https://docs.stripe.com/api/payment_intents/capture#payment_intent_object)
...
[client_secret](https://docs.stripe.com/api/payment_intents/capture#payment_intent_object-client_secret).
...
[PaymentIntents](https://docs.stripe.com/api/payment_intents/capture#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/payment_intents/capture#setup_intent_object-customer),
...
conjunction with
[Prices](https://docs.stripe.com/api/payment_intents/capture#prices) to
...
[Products](https://docs.stripe.com/api/payment_intents/capture#products) help
...
[subscriptions](https://docs.stripe.com/api/payment_intents/capture#subscriptions),
[invoices](https://docs.stripe.com/api/payment_intents/capture#invoices),
[checkout sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/payment_intents/capture#quotes), and more.
Coupons do not work with conventional one-off
[charges](https://docs.stripe.com/api/payment_intents/capture#create_charge) or
[payment intents](https://docs.stripe.com/api/payment_intents).
...
[coupon](https://docs.stripe.com/api/payment_intents/capture#coupons). It can be
...
[coupon](https://docs.stripe.com/api/payment_intents/capture#coupons) or
[promotion
code](https://docs.stripe.com/api/payment_intents/capture#promotion_codes). It
...
items](https://docs.stripe.com/api/payment_intents/capture#invoiceitems), and
...
API](https://docs.stripe.com/api/payment_intents/capture#prices). It replaces
...
[Payout](https://docs.stripe.com/api/payment_intents/capture#payout_object)
...
[FinancialAccount’s](https://docs.stripe.com/api/payment_intents/capture#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/payment_intents/capture#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/payment_intents/capture#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/payment_intents/capture#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/payment_intents/capture#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/payment_intents/capture#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/payment_intents/capture#received_debits)
