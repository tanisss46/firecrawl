...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fsetup_intents%2Fcancel)
...
event](https://docs.stripe.com/api/setup_intents/cancel#retrieve_event) or a
[list of events](https://docs.stripe.com/api/setup_intents/cancel#list_events)
...
API](https://docs.stripe.com/api/setup_intents/cancel#retrieve_event) for 30
days.
...
with the [create
file](https://docs.stripe.com/api/setup_intents/cancel#create_file) request (for
...
query](https://docs.stripe.com/api/setup_intents/cancel#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/setup_intents/cancel#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/setup_intents/cancel#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/setup_intents/cancel#payment_intent_object-setup_future_usage)
...
[SetupIntent](https://docs.stripe.com/api/setup_intents/cancel#setup_intent_object)
...
conjunction with
[Prices](https://docs.stripe.com/api/setup_intents/cancel#prices) to configure
...
[Products](https://docs.stripe.com/api/setup_intents/cancel#products) help you
...
[subscriptions](https://docs.stripe.com/api/setup_intents/cancel#subscriptions),
[invoices](https://docs.stripe.com/api/setup_intents/cancel#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/setup_intents/cancel#quotes), and more.
Coupons do not work with conventional one-off
[charges](https://docs.stripe.com/api/setup_intents/cancel#create_charge) or
[payment intents](https://docs.stripe.com/api/payment_intents).
...
[coupon](https://docs.stripe.com/api/setup_intents/cancel#coupons). It can be
...
[coupon](https://docs.stripe.com/api/setup_intents/cancel#coupons) or [promotion
code](https://docs.stripe.com/api/setup_intents/cancel#promotion_codes). It
...
items](https://docs.stripe.com/api/setup_intents/cancel#invoiceitems), and
...
API](https://docs.stripe.com/api/setup_intents/cancel#prices). It replaces the
...
[Payout](https://docs.stripe.com/api/setup_intents/cancel#payout_object) object,
...
[FinancialAccount’s](https://docs.stripe.com/api/setup_intents/cancel#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/setup_intents/cancel#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/setup_intents/cancel#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/setup_intents/cancel#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/setup_intents/cancel#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/setup_intents/cancel#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/setup_intents/cancel#received_debits)
