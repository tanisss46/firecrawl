...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fconfirmation_tokens)
...
event](https://docs.stripe.com/api/confirmation_tokens#retrieve_event) or a
[list of events](https://docs.stripe.com/api/confirmation_tokens#list_events)
...
API](https://docs.stripe.com/api/confirmation_tokens#retrieve_event) for 30
days.
...
with the [create
file](https://docs.stripe.com/api/confirmation_tokens#create_file) request (for
...
query](https://docs.stripe.com/api/confirmation_tokens#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/confirmation_tokens#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/confirmation_tokens#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/confirmation_tokens#payment_intent_object-setup_future_usage)
...
conjunction with
[Prices](https://docs.stripe.com/api/confirmation_tokens#prices) to configure
...
[Products](https://docs.stripe.com/api/confirmation_tokens#products) help you
...
[subscriptions](https://docs.stripe.com/api/confirmation_tokens#subscriptions),
[invoices](https://docs.stripe.com/api/confirmation_tokens#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/confirmation_tokens#quotes), and more.
Coupons do not work with conventional one-off
[charges](https://docs.stripe.com/api/confirmation_tokens#create_charge) or
[payment intents](https://docs.stripe.com/api/payment_intents).
...
[coupon](https://docs.stripe.com/api/confirmation_tokens#coupons). It can be
...
[coupon](https://docs.stripe.com/api/confirmation_tokens#coupons) or [promotion
code](https://docs.stripe.com/api/confirmation_tokens#promotion_codes). It
...
items](https://docs.stripe.com/api/confirmation_tokens#invoiceitems), and
...
API](https://docs.stripe.com/api/confirmation_tokens#prices). It replaces the
...
[Payout](https://docs.stripe.com/api/confirmation_tokens#payout_object) object,
...
[FinancialAccount’s](https://docs.stripe.com/api/confirmation_tokens#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/confirmation_tokens#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/confirmation_tokens#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/confirmation_tokens#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/confirmation_tokens#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/confirmation_tokens#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/confirmation_tokens#received_debits)
