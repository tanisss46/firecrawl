...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fsetup_attempts)
...
event](https://docs.stripe.com/api/setup_attempts#retrieve_event) or a [list of
events](https://docs.stripe.com/api/setup_attempts#list_events) from the API. We
...
API](https://docs.stripe.com/api/setup_attempts#retrieve_event) for 30 days.
...
with the [create file](https://docs.stripe.com/api/setup_attempts#create_file)
...
query](https://docs.stripe.com/api/setup_attempts#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/setup_attempts#payment_intents) to
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/setup_attempts#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/setup_attempts#payment_intent_object-setup_future_usage)
...
Possible enum values`inbound``outbound`
...
```
{ "id": "setatt_1ErTsH2eZvKYlo2CI7ukcoF7", "object": "setup_attempt",
"application": null, "created": 1562004309, "customer": null, "flow_directions":
null, "livemode": false, "on_behalf_of": null, "payment_method":
"pm_1ErTsG2eZvKYlo2CH0DNen59", "payment_method_details": { "card": {
"three_d_secure": null }, "type": "card" }, "setup_error": null, "setup_intent":
"seti_1ErTsG2eZvKYlo2CKaT8MITz", "status": "succeeded", "usage": "off_session"}
```
...
SetupAttempts that are created by the specified SetupIntent, which start after
SetupAttempts `starting_after`. Each entry in the array is a separate
SetupAttempts object. If no other SetupAttempts are available, the resulting
array is be empty. This request should never raise an error.

GET /v1/setup_attemptsServer-side languageStripe
CLIcURL.NETGoJavaNode.jsPHPPythonRuby
```
curl -G https://api.stripe.com/v1/setup_attempts \ -u
...
Response
```
{ "object": "list", "url": "/v1/setup_attempts", "has_more": false, "data": [ {
"id": "setatt_1ErTsH2eZvKYlo2CI7ukcoF7", "object": "setup_attempt",
"application": null, "created": 1562004309, "customer": null, "flow_directions":
null, "livemode": false, "on_behalf_of": null, "payment_method":
"pm_1ErTsG2eZvKYlo2CH0DNen59", "payment_method_details": { "card": {
...
conjunction with [Prices](https://docs.stripe.com/api/setup_attempts#prices) to
...
[Products](https://docs.stripe.com/api/setup_attempts#products) help you track
...
[subscriptions](https://docs.stripe.com/api/setup_attempts#subscriptions),
[invoices](https://docs.stripe.com/api/setup_attempts#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/setup_attempts#quotes), and more. Coupons
do not work with conventional one-off
[charges](https://docs.stripe.com/api/setup_attempts#create_charge) or [payment
...
[coupon](https://docs.stripe.com/api/setup_attempts#coupons). It can be used to
...
[coupon](https://docs.stripe.com/api/setup_attempts#coupons) or [promotion
code](https://docs.stripe.com/api/setup_attempts#promotion_codes). It contains
...
items](https://docs.stripe.com/api/setup_attempts#invoiceitems), and proration
...
API](https://docs.stripe.com/api/setup_attempts#prices). It replaces the Plans
...
of products. [Products](https://docs.stripe.com/api/setup_attempts#products)
...
[Payout](https://docs.stripe.com/api/setup_attempts#payout_object) object, with
...
[FinancialAccount’s](https://docs.stripe.com/api/setup_attempts#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/setup_attempts#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/setup_attempts#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/setup_attempts#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/setup_attempts#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/setup_attempts#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/setup_attempts#received_debits)
