...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fidempotent_requests)
...
event](https://docs.stripe.com/api/idempotent_requests#retrieve_event) or a
[list of events](https://docs.stripe.com/api/idempotent_requests#list_events)
...
API](https://docs.stripe.com/api/idempotent_requests#retrieve_event) for 30
days.
...
with the [create
file](https://docs.stripe.com/api/idempotent_requests#create_file) request (for
...
query](https://docs.stripe.com/api/idempotent_requests#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/idempotent_requests#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/idempotent_requests#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/idempotent_requests#payment_intent_object-setup_future_usage)
...
conjunction with
[Prices](https://docs.stripe.com/api/idempotent_requests#prices) to configure
...
[Products](https://docs.stripe.com/api/idempotent_requests#products) help you
...
[subscriptions](https://docs.stripe.com/api/idempotent_requests#subscriptions),
[invoices](https://docs.stripe.com/api/idempotent_requests#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/idempotent_requests#quotes), and more.
Coupons do not work with conventional one-off
[charges](https://docs.stripe.com/api/idempotent_requests#create_charge) or
[payment intents](https://docs.stripe.com/api/payment_intents).
...
[coupon](https://docs.stripe.com/api/idempotent_requests#coupons). It can be
...
[coupon](https://docs.stripe.com/api/idempotent_requests#coupons) or [promotion
code](https://docs.stripe.com/api/idempotent_requests#promotion_codes). It
...
items](https://docs.stripe.com/api/idempotent_requests#invoiceitems), and
...
API](https://docs.stripe.com/api/idempotent_requests#prices). It replaces the
...
[Payout](https://docs.stripe.com/api/idempotent_requests#payout_object) object,
...
[FinancialAccount’s](https://docs.stripe.com/api/idempotent_requests#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/idempotent_requests#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/idempotent_requests#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/idempotent_requests#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/idempotent_requests#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/idempotent_requests#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/idempotent_requests#received_debits)
