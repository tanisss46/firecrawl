...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Frequest_ids)
...
event](https://docs.stripe.com/api/request_ids#retrieve_event) or a [list of
events](https://docs.stripe.com/api/request_ids#list_events) from the API. We
...
API](https://docs.stripe.com/api/request_ids#retrieve_event) for 30 days.
...
with the [create file](https://docs.stripe.com/api/request_ids#create_file)
...
query](https://docs.stripe.com/api/request_ids#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/request_ids#payment_intents) to
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/request_ids#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/request_ids#payment_intent_object-setup_future_usage)
...
conjunction with [Prices](https://docs.stripe.com/api/request_ids#prices) to
...
[Products](https://docs.stripe.com/api/request_ids#products) help you track
...
[subscriptions](https://docs.stripe.com/api/request_ids#subscriptions),
[invoices](https://docs.stripe.com/api/request_ids#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/request_ids#quotes), and more. Coupons do
not work with conventional one-off
[charges](https://docs.stripe.com/api/request_ids#create_charge) or [payment
...
[coupon](https://docs.stripe.com/api/request_ids#coupons). It can be used to
...
[coupon](https://docs.stripe.com/api/request_ids#coupons) or [promotion
code](https://docs.stripe.com/api/request_ids#promotion_codes). It contains
...
items](https://docs.stripe.com/api/request_ids#invoiceitems), and proration
...
API](https://docs.stripe.com/api/request_ids#prices). It replaces the Plans API
...
of products. [Products](https://docs.stripe.com/api/request_ids#products) help
...
[Payout](https://docs.stripe.com/api/request_ids#payout_object) object, with
...
[FinancialAccount’s](https://docs.stripe.com/api/request_ids#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/request_ids#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/request_ids#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/request_ids#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/request_ids#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/request_ids#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/request_ids#received_debits)
