...
[Payout](https://docs.stripe.com/api/refunds/cancel#payout_object) object, with
...
[FinancialAccount’s](https://docs.stripe.com/api/refunds/cancel#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/refunds/cancel#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/refunds/cancel#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/refunds/cancel#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/refunds/cancel#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/refunds/cancel#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/refunds/cancel#received_debits)
