...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fpagination%2Fsearch)
...
event](https://docs.stripe.com/api/pagination/search#retrieve_event) or a [list
of events](https://docs.stripe.com/api/pagination/search#list_events) from the
...
API](https://docs.stripe.com/api/pagination/search#retrieve_event) for 30 days.
...
with the [create
file](https://docs.stripe.com/api/pagination/search#create_file) request (for
...
query](https://docs.stripe.com/api/pagination/search#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/pagination/search#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/pagination/search#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/pagination/search#payment_intent_object-setup_future_usage)
...
conjunction with [Prices](https://docs.stripe.com/api/pagination/search#prices)
...
[Products](https://docs.stripe.com/api/pagination/search#products) help you
...
[subscriptions](https://docs.stripe.com/api/pagination/search#subscriptions),
[invoices](https://docs.stripe.com/api/pagination/search#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/pagination/search#quotes), and more.
Coupons do not work with conventional one-off
[charges](https://docs.stripe.com/api/pagination/search#create_charge) or
[payment intents](https://docs.stripe.com/api/payment_intents).
...
[coupon](https://docs.stripe.com/api/pagination/search#coupons). It can be used
...
[coupon](https://docs.stripe.com/api/pagination/search#coupons) or [promotion
code](https://docs.stripe.com/api/pagination/search#promotion_codes). It
...
items](https://docs.stripe.com/api/pagination/search#invoiceitems), and
...
API](https://docs.stripe.com/api/pagination/search#prices). It replaces the
...
of products. [Products](https://docs.stripe.com/api/pagination/search#products)
...
[Payout](https://docs.stripe.com/api/pagination/search#payout_object) object,
...
[FinancialAccount’s](https://docs.stripe.com/api/pagination/search#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/pagination/search#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/pagination/search#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/pagination/search#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/pagination/search#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/pagination/search#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/pagination/search#received_debits)
