...
[Log
in](https://dashboard.stripe.com/login?redirect=https%3A%2F%2Fdocs.stripe.com%2Fapi%2Fcustomers%2Fupdate)
...
error](https://docs.stripe.com/api/customers/update#errors) if create parameters
...
error](https://docs.stripe.com/api/customers/update#errors) if update parameters
...
error](https://docs.stripe.com/api/customers/update#errors).
...
event](https://docs.stripe.com/api/customers/update#retrieve_event) or a [list
of events](https://docs.stripe.com/api/customers/update#list_events) from the
...
API](https://docs.stripe.com/api/customers/update#retrieve_event) for 30 days.
...
with the [create file](https://docs.stripe.com/api/customers/update#create_file)
...
query](https://docs.stripe.com/api/customers/update#scheduled_queries)).
...
[PaymentIntents](https://docs.stripe.com/api/customers/update#payment_intents)
...
SetupIntent with a
[Customer](https://docs.stripe.com/api/customers/update#setup_intent_object-customer),
...
[setup_future_usage](https://docs.stripe.com/api/customers/update#payment_intent_object-setup_future_usage)
...
conjunction with [Prices](https://docs.stripe.com/api/customers/update#prices)
...
[Products](https://docs.stripe.com/api/customers/update#products) help you track
...
[subscriptions](https://docs.stripe.com/api/customers/update#subscriptions),
[invoices](https://docs.stripe.com/api/customers/update#invoices), [checkout
sessions](https://docs.stripe.com/api/checkout/sessions),
[quotes](https://docs.stripe.com/api/customers/update#quotes), and more. Coupons
do not work with conventional one-off
[charges](https://docs.stripe.com/api/customers/update#create_charge) or
[payment intents](https://docs.stripe.com/api/payment_intents).
...
[coupon](https://docs.stripe.com/api/customers/update#coupons). It can be used
...
[coupon](https://docs.stripe.com/api/customers/update#coupons) or [promotion
code](https://docs.stripe.com/api/customers/update#promotion_codes). It contains
...
items](https://docs.stripe.com/api/customers/update#invoiceitems), and proration
...
API](https://docs.stripe.com/api/customers/update#prices). It replaces the Plans
...
of products. [Products](https://docs.stripe.com/api/customers/update#products)
...
[Payout](https://docs.stripe.com/api/customers/update#payout_object) object,
...
[FinancialAccount’s](https://docs.stripe.com/api/customers/update#financial_accounts)
balance.
...
[Transaction](https://docs.stripe.com/api/customers/update#transactions).
...
[FinancialAccount](https://docs.stripe.com/api/customers/update#financial_accounts)
to a PaymentMethod belonging to the same entity. To send funds to a different
party, use
[OutboundPayments](https://docs.stripe.com/api/customers/update#outbound_payments)
...
[OutboundTransfer](https://docs.stripe.com/api/customers/update#outbound_transfers).
...
[ReceivedCredits](https://docs.stripe.com/api/customers/update#received_credits)
...
You can reverse some
[ReceivedDebits](https://docs.stripe.com/api/customers/update#received_debits)
